...
Scope: `src/linter/` and lint rule tests.

**To add a rule, use the `add-lint-rule` skill.**
For real-codebase triage, use `linter-investigation`.
The rule roadmap is in `TODO.md` ("Linter" → "Rules").
