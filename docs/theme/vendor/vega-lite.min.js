!((e, t) => {
	...
	function Y(e, t) {
		...
		if (e && t && "object" == typeof e && "object" == typeof t) {
			...
			if (e instanceof Map && t instanceof Map) {
				...
				for (const n of e.entries()) if (!Y(n[1], t.get(n[0]))) return !1;
				return !0;
			}
			...
			if (e.toString !== Object.prototype.toString && e.toString !== G.toString)
	...
	const J = "row",
		...
		Pe = "url",
		_e = "description",
		Ae = { theta: 1, theta2: 1, radius: 1, radius2: 1 };
	function Te(e) {
		return Object.hasOwn(t, Ae);
	}
	const je = { longitude: 1, longitude2: 1, latitude: 1, latitude2: 1 };
	function Ee(e) {
		switch (e) {
			case ue:
				return "y";
	...
	function qe(e) {
		return e === pe || e === ge || e === he;
	}
	const Ue = { row: 1, column: 1, facet: 1 },
		We = D(Ue),
		Ie = { ...Le, ...Ue },
		Be = D(Ie),
		{ order: Ve, detail: He, tooltip: Ge, ...Ye } = Ie,
		{ row: Xe, column: Qe, facet: Je, ...Ke } = Ye;
	function Ze(e) {
		return Object.hasOwn(t, Ie);
	}
	const et = [ne, ie, de, me, ce, se];
	function tt(e) {
		return nt(e) !== e;
	}
	function nt(e) {
	...
	const ct = D(Le),
		...
		Ot = D(Ft);
	function zt(e) {
		return Object.hasOwn(t, Ft);
	}
	const Ct = { theta: 1, radius: 1 },
		Nt = D(Ct);
	function Pt(e) {
	...
	const {
		...
		It = D(Wt);
	const Bt = { ...Ft, ...Ct, ..._t, ...Wt },
		Vt = D(Bt);
	function Ht(e) {
		return Object.hasOwn(t, Bt);
	}
	function Gt(e, t) {
		return ((e) => {
			switch (e) {
	...
	function nn(e) {
		return t.isString(e) && Object.hasOwn(t, Kt);
	}
	const rn = new Set(["count", "valid", "missing", "distinct"]);
	function on(e) {
		return t.isString(e) && rn.has(e);
	}
	const an = new Set(["count", "sum", "distinct", "valid", "missing"]),
		sn = new Set(["mean", "average", "median", "q1", "q3", "min", "max"]);
	function ln(e) {
		return (
			t.isBoolean(e) && (e = $a(e, void 0)),
			"bin" +
				D(e)
					.map((t) => (dn(e[t]) ? C(`_${t}_${O(e[t])}`) : C(`_${t}_${e[t]}`)))
					.join("")
		);
	}
	function cn(e) {
		return !0 === e || (fn(e) && !e.binned);
	}
	function un(e) {
		return "binned" === e || (fn(e) && !0 === e.binned);
	}
	function fn(e) {
		return t.isObject(e);
	}
	...
	function gn(e) {
		...
		const n = D(e || {}),
			i = {};
		for (const r of n) i[r] = 0 === t ? Dn(e[r]) : gn(e[r], { level: t - 1 });
		return i;
	}
	function hn(e) {
		const {
	...
	function xn(e) {
		return !t.isArray(e) && Q(e, "field") && Q(e, "data");
	}
	const $n = D({
			aria: 1,
			description: 1,
	...
	function Sn(e) {
		const n = t.isArray(e.condition) ? e.condition.map(Fn) : Fn(e.condition);
		return { ...Dn(e), condition: n };
	}
	function Dn(e) {
		if (pn(e)) {
			const { expr: t, ...n } = e;
	...
	function On(e) {
		...
		return vn(e) ? e : void 0 !== e ? { value: e } : void 0;
	}
	function zn(e) {
		return vn(e) ? e.signal : t.stringValue(e.value);
	}
	function Cn(e) {
		return vn(e) ? e.signal : null == e ? null : t.stringValue(e);
	}
	function Nn(e, t, n) {
		for (const i of n) {
			const n = An(i, t.markDef, t.config);
			void 0 !== n && (e[i] = On(n));
		}
		return e;
	}
	...
	function En(e, n) {
		return t
			...
			.reduce(
				(e, t) => (
					e.field.push(sa(t, n)), e.order.push(t.sort ?? "ascending"), e
				),
				{ field: [], order: [] },
			);
	}
	...
	function Ln(e, t) {
		...
		if ((yn(n) || vn(n)) && (yn(i) || vn(i)))
			return { explicit: e.explicit, value: Rn(n, i) };
		if (yn(n) || vn(n)) return { explicit: e.explicit, value: n };
		if (yn(i) || vn(i)) return { explicit: e.explicit, value: i };
		if (!(yn(n) || vn(n) || yn(i) || vn(i)))
	...
	const Un = 'Autosize "fit" only works for single views and layered views.';
	function Wn(e) {
	...
	function Bn(e) {
		return e
			? `Dropping "fit-${e}" because spec has discrete ${ot(e)}.`
	...
	function ni(e, t) {
		return `Dropping ${X(e)} from channel "${t}" since it does not contain any data field, datum, value, or signal.`;
	}
	function ii(e, t, n) {
	...
	const hi = t.logger(t.Warn);
	let yi = hi;
	function vi() {
		yi.warn(...arguments);
	}
	function bi(e) {
		if (e && t.isObject(e)) for (const t of Oi) if (Q(e, t)) return !0;
		return !1;
	}
	const xi = [
			"january",
	...
	function Si(e, n) {
		...
		if (
			(n &&
				...
				(vi(
					((e) =>
						`Dropping day from datetime ${X(e)} as day cannot be combined with other units.`)(
						e,
					),
				),
				delete (e = l(e)).day),
			...
			const r = n
				? ((e) => {
						if ((H(e) && (e = +e), t.isNumber(e)))
							return e > 4 && vi(mi("quarter", e)), e - 1;
						throw new Error(mi("quarter", e));
					})(e.quarter)
				: e.quarter;
	...
	const Fi = {
		...
		Oi = D(Fi);
	function zi(e) {
		return t.isObject(e) ? e.binned : Ci(e);
	}
	function Ci(e) {
	...
	const Pi = { "year-month": "%b %Y ", "year-month-date": "%b %d, %Y " };
	function _i(e) {
		return Oi.filter((t) => Ti(e, t));
	}
	function Ai(e) {
		const t = _i(e);
		return t[t.length - 1];
	...
	function Ei(e) {
		if (!e) return;
		return `timeUnitSpecifier(${X(_i(e))}, ${X(Pi)})`;
	}
	function Mi(e) {
		if (!e) return;
		let n;
		return (
			t.isString(e)
				? (n = Ci(e) ? { unit: e.substring(6), binned: !0 } : { unit: e })
				: t.isObject(e) && (n = { ...e, ...(e.unit ? { unit: e.unit } : {}) }),
			Ni(n.unit) && ((n.utc = !0), (n.unit = n.unit.substring(3))),
			n
		);
	}
	function Ri(e) {
		...
		if (i && "day" !== i) {
			const e = {
				...
				{ step: r, part: o } = qi(i, n.step);
			return `${t(Di({ ...e, [o]: +e[o] + r }))} - ${t(Di(e))}`;
		}
	}
	const Li = {
		year: 1,
	...
	function qi(e) {
		...
		if (((e) => Object.hasOwn(t, Li))(e)) return { part: e, step: n };
		switch (e) {
			case "day":
			case "dayofyear":
	...
	function Yi(e) {
		return Gi(e) || Ui(e) || Hi(e) || Wi(e) || Bi(e) || Ii(e) || Vi(e);
	}
	function Xi(e, t) {
		return Sa(e, { timeUnit: t, wrapTime: !0 });
	}
	function Qi(e) {
		const t =
		...
		const { field: n } = e,
			...
			{ unit: r, binned: o } = i || {},
			a = sa(e, { expr: "datum" }),
			s = r ? `time(${o ? a : ji(r, n)})` : a;
		if (Ui(e)) return `${s}===${Xi(e.equal, r)}`;
		if (Wi(e)) {
			return `${s}<${Xi(e.lt, r)}`;
		}
		if (Bi(e)) {
		...
		if (Gi(e))
			return `indexof([${((e, t) => e.map((e) => Xi(e, t)))(e.oneOf, r).join(",")}], ${s}) !== -1`;
		if (((e) => !!e?.field && void 0 !== e.valid)(e)) return Ji(s, e.valid);
		if (Hi(e)) {
			const { range: n } = gn(e),
				i = vn(n) ? { signal: `${n.signal}[0]` } : n[0],
				o = vn(n) ? { signal: `${n.signal}[1]` } : n[1];
			if (null !== i && null !== o && t)
				return "inrange(" + s + ", [" + Xi(i, r) + ", " + Xi(o, r) + "])";
			const a = [];
			return (
				null !== i && a.push(`${s} >= ${Xi(i, r)}`),
				null !== o && a.push(`${s} <= ${Xi(o, r)}`),
	...
	function Ki(e) {
		return Yi(e) && e.timeUnit ? { ...e, timeUnit: Mi(e.timeUnit) } : e;
	}
	function Zi(e) {
	...
	const fr = new Set(["linear", "log", "pow", "sqrt", "symlog"]),
		dr = new Set([...fr, "time", "utc"]);
	function mr(e) {
		return fr.has(e);
	}
	const pr = new Set(["quantile", "quantize", "threshold"]),
		gr = new Set([...dr, ...pr, "sequential", "identity"]),
		hr = new Set(["ordinal", "bin-ordinal", "point", "band"]);
	function yr(e) {
		return hr.has(e);
	}
	function vr(e) {
	...
	function Nr(e, t) {
		switch (t) {
			...
			case "round":
				return br(e) || "band" === e || "point" === e;
			case "padding":
			case "rangeMin":
			case "rangeMax":
				return br(e) || ["point", "band"].includes(e);
			case "paddingOuter":
			case "align":
			...
			case "clamp":
				return br(e);
			case "nice":
				return br(e) || "quantize" === e || "threshold" === e;
			case "exponent":
				return "pow" === e;
			case "base":
				return "log" === e;
			case "constant":
				return "symlog" === e;
			case "zero":
				return vr(e) && !p(["log", "time", "utc", "threshold", "quantile"], e);
		}
	}
	function Pr(e, t) {
		switch (t) {
	...
	function lo(e) {
		...
		if (!r || !vr(r) || o) return "always-valid";
		const a = so(_n("invalid", t, n), { isPath: Gr(t.type) }),
			s = n.scale?.invalid?.[i];
	...
	function uo(e) {
		...
		const s = i?.get("type"),
			...
			c = lo({
				...
				config: a,
				scaleType: s,
				isCountAggregate: on(l?.aggregate),
			});
		if (l && "show" === c) {
			const e = a.scale.invalid?.[t] ?? "zero-or-min";
			return { test: Ji(sa(l, { expr: "datum" }), !1), ...fo(e, i, r) };
		}
	}
	function fo(e, n, i) {
		if (((r = e), t.isObject(r) && "value" in r)) {
			const { value: t } = e;
			return vn(t) ? { signal: t.signal } : { value: t };
		}
		var r;
		return co({ scale: n, scaleName: i, mode: "zeroOrMin" });
	}
	function mo(e) {
		const {
				channel: t,
	...
	function go(e) {
		...
		const l = !vn(s) && 0 < s && s < 1 ? "datum" : void 0,
			c = sa(n, { expr: l, suffix: o }),
			u = void 0 !== i ? sa(i, { expr: l }) : sa(n, { suffix: a, expr: l }),
			f = {};
		if (0 === s || 1 === s) {
			f.scale = t;
			const e = 0 === s ? c : u;
	...
	function ho(e) {
		...
		if (i) {
			if (Zo(i)) {
				const e = l?.get("type");
				if (ea(i)) {
					d ??= qo({ fieldDef: i, fieldDef2: r, markDef: o, config: a });
					const { bin: t, timeUnit: l, type: f } = i;
					if (cn(t) || (d && l && f === ir))
						return c?.impute
							? po(i, s, { binSuffix: "mid" }, { offset: u })
							: d && !yr(e)
								? go({
										scaleName: s,
										fieldOrDatumDef: i,
				...
				return po(i, s, yr(e) ? { binSuffix: "range" } : {}, {
					offset: u,
			...
			const e = ((e) => {
				...
				return !i || r
					...
					: ((e, t, n) => {
							if (!e) return;
							const i = Ei(e);
							return `${n || Ni(e) ? "utc" : "time"}Format(${t}, ${i})`;
						})(i, n, s);
			})({
				field: l,
				timeUnit: Go(n) ? Mi(n.timeUnit)?.unit : void 0,
				format: i,
				formatType: s.timeFormatType,
				rawTimeFormat: s.timeFormat,
				isUTCScale: na(n) && n.scale?.type === ar.UTC,
			});
			return e ? { signal: e } : void 0;
		}
		if (
			((i = Fo({ type: c, specifiedFormat: i, config: s, normalizeStack: a })),
			Go(n) && cn(n.bin))
		) {
			return { signal: Co(l, sa(n, { expr: o, binSuffix: "end" }), i, r, s) };
		}
		return i || "quantitative" === Yo(n)
			? { signal: `${Oo(l, i)}` }
	...
	function wo(e, t, n) {
		return Go(e)
			? n
				? `${sa(e, { expr: t, suffix: "end" })}-${sa(e, { expr: t, suffix: "start" })}`
				: sa(e, { expr: t })
			: ((e) => {
					const { datum: t } = e;
					return bi(t) ? Di(t) : `${X(t)}`;
				})(e);
	}
	function ko(e) {
		let {
		...
		if (((s ??= wo(t, r, o)), "datum.value" !== s && Go(t) && cn(t.bin))) {
			return { signal: Co(s, sa(t, { expr: r, binSuffix: "end" }), n, i, a) };
		}
		return { signal: bo(i, s, n) };
	}
	function So(e, n, i, r, o, a) {
		if (!t.isString(r) || !vo(r)) {
			if (
				void 0 === i &&
				void 0 === r &&
				o.customFormatTypes &&
				...
				if (o.normalizedNumberFormatType && ia(e) && "normalize" === e.stack)
					return;
				if (o.numberFormatType) return;
			}
			if (ia(e) && "normalize" === e.stack && o.normalizedNumberFormat)
				return Fo({ type: "quantitative", config: o, normalizeStack: !0 });
			if (ka(e)) {
				const t = Go(e) ? Mi(e.timeUnit)?.unit : void 0;
			...
			return Fo({ type: n, specifiedFormat: i, config: o });
		}
	}
	function Do(e, t, n) {
		return e && (vn(e) || "number" === e || "time" === e)
			? e
			: ka(t) && "time" !== n && "utc" !== n
				? Go(t) && Mi(t?.timeUnit)?.utc
					? "utc"
					: "time"
				: void 0;
	}
	...
	function zo(e, n, i, r) {
		return vo(i)
			? bo(i, e, n)
			: Oo(e, (t.isString(n) ? n : void 0) ?? r.numberFormat);
	}
	function Co(e, t, n, i, r) {
		if (
			...
			return Co(e, t, r.numberFormat, r.numberFormatType, r);
		const o = zo(e, n, i, r),
			a = zo(t, n, i, r);
		return `${Ji(e, !1)} ? "null" : ${o} + "${xo}" + ${a}`;
	}
	const No = "min",
		Po = {
			x: 1,
	...
	function _o(e) {
		return Object.hasOwn(t, Po);
	}
	function Ao(e) {
		return e && ("count" === e.op || Q(e, "field"));
	}
	function To(e) {
		return e && t.isArray(e);
	}
	function jo(e) {
		return Q(e, "row") || Q(e, "column");
	}
	function Eo(e) {
		return Q(e, "header");
	}
	...
	function qo(e) {
		...
		if (Zo(t) && void 0 !== t.bandPosition) return t.bandPosition;
		if (Go(t)) {
			const { timeUnit: e, bin: o } = t;
			if (e && !n) return An("timeUnitBandPosition", i, r);
			if (cn(o)) return 0.5;
		}
	}
	function Uo(e) {
		...
		const l = ot(t),
			c = _n(s ? "size" : l, r, o, { vgChannel: l });
		if (void 0 !== c) return c;
		if (Go(n)) {
			const { timeUnit: e, bin: t } = n;
			if (e && !i) return { band: An("timeUnitBandSize", r, o) };
			if (cn(t) && !yr(a)) return { band: 1 };
		}
		return Yr(r.type)
			? a
				? yr(a)
	...
	function Wo(e, t, n, i) {
		return (
			!!(cn(e.bin) || (e.timeUnit && ea(e) && "temporal" === e.type)) &&
			void 0 !== qo({ fieldDef: e, fieldDef2: t, markDef: n, config: i })
		);
	}
	function Io(e) {
	...
	function Bo(e) {
		return Q(e, "condition");
	}
	function Vo(e) {
		const n = e?.condition;
		return !!n && !t.isArray(n) && Go(n);
	}
	function Ho(e) {
		const n = e?.condition;
	...
	function Go(e) {
		return Q(e, "field") || "count" === e?.aggregate;
	}
	function Yo(e) {
		return e?.type;
	}
	...
	function Qo(e) {
		return (ea(e) && !la(e)) || Ko(e);
	}
	function Jo(e) {
		return (ea(e) && "quantitative" === e.type && !e.bin) || Ko(e);
	}
	function Ko(e) {
		return Xo(e) && t.isNumber(e.datum);
	}
	function Zo(e) {
		return Go(e) || Xo(e);
	}
	function ea(e) {
		return e && (Q(e, "field") || "count" === e.aggregate) && Q(e, "type");
	}
	function ta(e) {
		return Q(e, "value");
	}
	function na(e) {
		return Q(e, "scale") || Q(e, "sort");
	}
	function ia(e) {
	...
	function sa(e) {
		...
		let r = t.suffix,
			o = "";
		if (((e) => "count" === e.aggregate)(e)) n = I("count");
		else {
			let i;
			if (!t.nofn)
				if (((e) => Q(e, "op"))(e)) i = e.op;
				else {
					const { bin: a, aggregate: s, timeUnit: l } = e;
					cn(a)
						? ((i = ln(a)), (r = (t.binSuffix ?? "") + (t.suffix ?? "")))
						: s
							? tn(s)
		...
		switch (t.fieldTitle) {
			...
			case "functional":
				return ((e) => {
					...
					if (tn(t)) return `${r} for argmax(${t.argmax})`;
					if (en(t)) return `${r} for argmin(${t.argmin})`;
					const o = i && !zi(i) ? Mi(i) : void 0,
						a = t || o?.unit || (o?.maxbins && "timeunit") || (cn(n) && "bin");
	...
	function ha(e) {
		return Go(e) ? e : Vo(e) ? e.condition : void 0;
	}
	function ya(e) {
		return Zo(e) ? e : Ho(e) ? e.condition : void 0;
	}
	function va(e, n, i) {
		const r =
			arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
		if (t.isString(e) || t.isNumber(e) || t.isBoolean(e)) {
			return (
				vi(
					((e, t, n) =>
						`Channel ${e} is a ${t}. Converted to {value: ${X(n)}}.`)(
						n,
		...
		return Zo(e)
			? ba(e, n, i, r)
			: Ho(e)
				? { ...e, condition: ba(e.condition, n, i, r) }
				: e;
	}
	function ba(e, n, i, r) {
		if (oa(e)) {
			const { format: t, formatType: o, ...a } = e;
			if (vo(o) && !i.customFormatTypes) return vi(Kn(n)), ba(a, n, i, r);
		} else {
			const t = ia(e) ? "axis" : ra(e) ? "legend" : Eo(e) ? "header" : null;
			if (t && e[t]) {
				const { format: o, formatType: a, ...s } = e[t];
				if (vo(a) && !i.customFormatTypes)
					return vi(Kn(n)), ba({ ...e, [t]: s }, n, i, r);
			}
		}
		return Go(e)
			? xa(e, n, r)
	...
	function xa(e, n) {
		...
		if (
			(i ||
				...
				tn(r) ||
				en(r) ||
				(vi(((e) => `Invalid aggregation operator "${e}".`)(r)),
				delete l.aggregate),
			o && (l.timeUnit = Mi(o)),
			s && (l.field = `${s}`),
			cn(a) && (l.bin = $a(a, n)),
			un(a) &&
				!zt(n) &&
				vi(((e) => `Channel ${e} should not be used with "binned" bin.`)(n)),
			ea(l))
		) {
			const { type: e } = l,
				t = ((e) => {
			...
			const e = ((e, n) => {
				...
				if (Lo(e) && t.isArray(e.sort)) return "ordinal";
				const { aggregate: i, bin: r, timeUnit: o } = e;
				if (o) return "temporal";
				if (r || (i && !tn(i) && !en(i))) return "quantitative";
				if (na(e) && e.scale?.type)
					switch (sr[e.scale.type]) {
						case "numeric":
						case "discretizing":
							return "quantitative";
						case "time":
			...
			const { compatible: e, warning: t } =
				((e, t) => {
					...
					switch (t) {
						...
						case K:
						case Z:
							return la(e) ? wa : { compatible: !1, warning: ri(t) };
						case ee:
						case te:
						case re:
						case oe:
						...
						case ye:
						case Se:
							return la(e) || (na((i = e)) && xr(i.scale?.type))
								? wa
								: { compatible: !1, warning: oi(t) };
						case Fe:
		...
		if (Lo(l) && t.isString(l.sort)) {
			const { sort: e } = l;
			if (_o(e)) return { ...l, sort: { encoding: e } };
	...
	const wa = { compatible: !0 };
	function ka(e) {
		const { formatType: t } = ga(e);
		return (
			"time" === t ||
			(!t && (n = e) && ("temporal" === n.type || (Go(n) && !!n.timeUnit)))
		);
		var n;
	}
	function Sa(e, n) {
	...
	function Da(e, t) {
		...
		return t.map((t) => {
			const i = Sa(t, {
				timeUnit: Go(e) && !zi(e.timeUnit) ? e.timeUnit : void 0,
				type: n,
	...
	const Ca = ["domain", "grid", "labels", "ticks", "title"],
		Na = {
			grid: "grid",
			gridCap: "grid",
			gridColor: "grid",
		...
		_a = { ...Pa, style: 1, labelExpr: 1, encoding: 1 };
	function Aa(e) {
		return Object.hasOwn(t, _a);
	}
	const Ta = D({
		axis: 1,
		axisBand: 1,
	...
	class Ea {
		...
		hasMatchingType(e) {
			return !!ja(e) && (Qr((t = e.mark)) ? t.type : t) === this.name;
			var t;
		}
	}
	function Ma(e, n) {
		const i = e && e[n];
		return !!i && (t.isArray(i) ? g(i, (e) => !!e.field) : Go(i) || Vo(i));
	}
	function Ra(e, n) {
		const i = e && e[n];
		return (
			!!i && (t.isArray(i) ? g(i, (e) => !!e.field) : Go(i) || Xo(i) || Ho(i))
		);
	}
	function La(e, t) {
		if (zt(t)) {
			const n = e[t];
			if ((Go(n) || Xo(n)) && (er(n.type) || (Go(n) && n.timeUnit))) {
				return Ra(e, st(t));
			}
		}
		return !1;
			...
			Ba(e, (l, c) => {
				if (Go(l)) {
					...
					if (f || m || d) {
						...
						let h = sa(l, { forAs: !0 });
						const y = {
							...(g ? [] : { title: da(l, n, { allowDisabling: !0 }) }),
							...p,
							field: h,
						};
						if (f) {
							...
							if (
								(tn(f)
									? ((e = "argmax"),
										(h = sa({ op: "argmax", field: f.argmax }, { forAs: !0 })),
										(y.field = `${h}.${u}`))
									: en(f)
										? ((e = "argmin"),
											(h = sa(
						...
						} else if ((i.push(h), ea(l) && cn(d))) {
							if (
								(r.push({ bin: d, field: u, as: h }),
								i.push(sa(l, { binSuffix: "end" })),
								Fa(l, c) && i.push(sa(l, { binSuffix: "range" })),
								zt(c))
							) {
								const e = { field: `${h}_end` };
								s[`${c}2`] = e;
							}
							(y.bin = "binned"), tt(c) || (y.type = tr);
						} else if (m && !zi(m)) {
							o.push({ timeUnit: m, field: u, as: h });
							const e = ea(l) && l.type !== ir && "time";
							e &&
								(c === De || c === Ce
									? (y.formatType = e)
									: !((e) => Object.hasOwn(t, St))(c)
										? zt(c) && (y.axis = { formatType: e, ...y.axis })
	...
	function Ia(e, t) {
		const n = {};
		for (const i of D(e)) {
			const r = va(e[i], i, t, { compositeMark: !0 });
			n[i] = r;
		}
		return n;
	}
		...
		return D(n).reduce((i, r) => {
			switch (r) {
				...
				case ze: {
					const e = n[r];
					if (t.isArray(e) || Go(e))
						for (const n of t.array(e)) n.aggregate || i.push(sa(n, {}));
					return i;
				}
				case ve:
					if ("trail" === e) return i;
				...
				case ke: {
					const e = ha(n[r]);
					return e && !e.aggregate && i.push(sa(e, {})), i;
				}
			}
		}, []);
	}
			...
			tooltip: [
				...e.map((e) => {
					...
					return {
						field: t + n.field,
						type: n.type,
						title: vn(i) ? { signal: `${i}"${escape(o)}"` } : i + o,
					};
				}),
				...b(
					((e) => {
						...
						for (const i of D(e))
							if (Ma(e, i)) {
								const r = e[i],
									o = t.array(r);
								for (const e of o)
									Go(e) ? n.push(e) : Vo(e) && n.push(e.condition);
							}
						return n;
					})(i).map(aa),
					d,
	...
	function Qa(e, t, n) {
		const { encoding: i } = e,
			...
			l = i[`${r}Error2`];
		return {
			continuousAxisChannelDef: Ja(o, n),
			continuousAxisChannelDef2: Ja(a, n),
			continuousAxisChannelDefError: Ja(s, n),
			continuousAxisChannelDefError2: Ja(l, n),
			continuousAxis: r,
		};
	}
	function Ja(e, t) {
	...
	function Ka(e, t) {
		const { mark: n, encoding: i } = e,
			{ x: r, y: o } = i;
		if (Qr(n) && n.orient) return n.orient;
		if (Qo(r)) {
			if (Qo(o)) {
				const e = Go(r) && r.aggregate,
					n = Go(o) && o.aggregate;
				if (e || n !== t) {
					if (n || e !== t) {
						if (e === t && n === t)
							throw new Error("Both x and y cannot have aggregate");
						return ka(o) && !ka(r) ? "horizontal" : "vertical";
					}
					return "horizontal";
				}
				return "vertical";
	...
	function ns(e, n) {
		...
		const u = c.extent ?? i.boxplot.extent,
			...
			p = ts(u),
			{
				...
				const r = Ka(e, Za),
					{ continuousAxisChannelDef: o, continuousAxis: a } = Qa(e, r, Za),
					s = o.field,
					l = R(s),
					c = ts(n),
					u = [
					...
					f =
						"min-max" === c || "tukey" === c
							...
							: [
									...
									{
										calculate: `min(datum["upper_box_${l}"] + datum["iqr_${l}"] * ${n}, datum["max_${l}"])`,
										as: `upper_whisker_${l}`,
									},
									{
										calculate: `max(datum["lower_box_${l}"] - datum["iqr_${l}"] * ${n}, datum["min_${l}"])`,
										as: `lower_whisker_${l}`,
									},
								],
					{ [a]: d, ...m } = e.encoding,
			...
			j = P({
				...
				color: {
					condition: {
						test: `datum['lower_box_${v.field}'] >= datum['upper_box_${v.field}']`,
						...(z || { value: T }),
					},
				},
			}),
		...
		const W = `datum["lower_box_${v.field}"]`,
			...
			H = `${I} + ${u} * ${B}`,
			G = `datum["${v.field}"]`,
			Y = { joinaggregate: is(v.field), groupby: x },
			X = {
				transform: [
					{ filter: `(${V} <= ${G}) && (${G} <= ${H})` },
					{
	...
	function ss(e, t) {
		...
		if (
			...
			return { orient: Ka(e, t), inputType: "raw" };
		const i = ((e) => Zo(e.x2) || Zo(e.y2))(n),
			r = ((e) =>
				Zo(e.xError) || Zo(e.xError2) || Zo(e.yError) || Zo(e.yError2))(n),
			o = n.x,
			a = n.y;
		if (i) {
			if (r)
			...
			const e = n.x2,
				i = n.y2;
			if (Zo(e) && Zo(i)) throw new Error(`${t} cannot have both x2 and y2`);
			if (Zo(e)) {
				if (Qo(o))
		...
		}
		{
			...
			if (Zo(r)) {
				if (Qo(a)) return { orient: "vertical", inputType: "aggregated-error" };
				throw new Error(
	...
	function ls(e, t, n) {
		const { mark: i, encoding: r, params: o, projection: a, ...s } = e,
			l = Qr(i) ? i : { type: i };
		o && vi(Yn(t));
		const { orient: c, inputType: u } = ss(e, t),
			{
				...
				if ("raw" === o) {
					...
					if (
						...
						(l = [
							...
							(f = [
								{ fieldPrefix: "center_", titlePrefix: _(t) },
					...
					(e.center || e.extent) &&
						...
						"aggregated-upper-lower" === o
							? ((f = []),
								(c = [
									{ calculate: `datum["${n.field}"]`, as: `upper_${u}` },
		...
		return {
			transform: [
				...
				...D,
				...F,
				...(0 === N.length ? [] : [{ aggregate: N, groupby: P }]),
				...y,
			],
			groupby: P,
			continuousAxisChannelDef: f,
	...
	function ps(e, t, n) {
		const i = new Ea(e, t);
		ms[e] = { normalizer: i, parts: n };
	}
	ps(Za, ns, ["box", "median", "outliers", "rule", "ticks"]),
		ps(rs, as, ["ticks", "rule"]),
		ps(us, ds, ["band", "borders"]);
	const gs = [
		...
		vs = D(hs),
		bs = D(ys),
		xs = D({ header: 1, headerRow: 1, headerColumn: 1, headerFacet: 1 }),
		$s = [
			"size",
			"shape",
			"fill",
	...
	function As(e) {
		return Q(e, "view") || Q(e, "width") || Q(e, "height");
	}
	const Ts = D({ align: 1, bounds: 1, center: 1, columns: 1, spacing: 1 });
	function js(e, t) {
		return e[t] ?? e["width" === t ? "continuousWidth" : "continuousHeight"];
	}
	function Es(e, t) {
		const n = Ms(e, t);
		return _s(n) ? n.step : Rs;
	}
	function Ms(e, t) {
	...
	const Rs = 20,
		Ls = {
			...
			view: { continuousWidth: 200, continuousHeight: 200, step: Rs },
			mark: {
				color: "#4c78a8",
	...
	function Vs() {
		...
		for (const e of ["background", "lineBreak", "padding"])
			s[e] && (c[e] = Dn(s[e]));
		for (const e of to) s[e] && (c[e] = gn(s[e]));
		for (const e of Ta) s[e] && (c[e] = Is(s[e]));
		for (const e of xs) s[e] && (c[e] = gn(s[e]));
		if ((s.legend && (c.legend = gn(s.legend)), s.scale)) {
			const { invalid: e, ...t } = s.scale,
				n = gn(e, { level: 1 });
			c.scale = { ...gn(t), ...(D(n).length > 0 ? { invalid: n } : {}) };
		}
		return (
			s.style &&
				(c.style = ((e) => {
			...
			s.title && (c.title = gn(s.title)),
			s.view && (c.view = gn(s.view)),
			c
		);
	}
	const Hs = new Set(["view", ...Xr]),
		Gs = [
			"color",
			"fontSize",
			"background",
	...
	function Xs(e) {
		e = l(e);
		for (const t of Gs) delete e[t];
		if (e.axis) for (const t in e.axis) za(e.axis[t]) && delete e.axis[t];
		if (e.legend) for (const t of gs) delete e.legend[t];
		if (e.mark) {
			for (const t of Kr) delete e.mark[t];
			e.mark.tooltip && t.isObject(e.mark.tooltip) && delete e.mark.tooltip;
		}
		e.params &&
			((e.signals = (e.signals || []).concat(Os(e.params))), delete e.params);
		for (const t of Hs) {
			for (const n of Kr) delete e[t][n];
			const n = Ys[t];
			if (n) for (const i of n) delete e[t][i];
			Qs(e, t);
		}
		for (const t of D(ms)) delete e[t];
		!((e) => {
			const {
				titleMarkConfig: t,
	...
	class Ks {
		...
		mapLayerOrUnit(e, t) {
			if (Js(e)) return this.mapLayer(e, t);
			if (ja(e)) return this.mapUnit(e, t);
	...
	const Zs = { zero: 1, center: 1, normalize: 1 };
	const el = new Set([Ar, jr, Tr, qr, Rr, Br, Vr, Mr, Ur, Wr]),
		tl = new Set([jr, Tr, Ar]);
	function nl(e) {
		return Go(e) && "quantitative" === Yo(e) && !e.bin;
	}
	function il(e, t, n) {
		...
		if (Go(s) && Go(l))
			if (nl(s) && nl(l)) {
				if (s.stack) return t;
				if (l.stack) return o;
				const e = Go(s) && !!s.aggregate;
				if (e !== (Go(l) && !!l.aggregate)) return e ? t : o;
				if (a) {
	...
	function rl(e, n) {
		const i = Qr(e) ? e : { type: e },
			r = i.type;
		if (!el.has(r)) return null;
		const o = il(n, "x", i) || il(n, "theta", i);
		if (!o) return null;
		const a = n[o],
			s = Go(a) ? sa(a, {}) : void 0,
			l = ((e) => {
		...
		return (
			void 0 !== a.stack
				...
				: tl.has(r) && (g = "zero"),
			g && ((h = g), Object.hasOwn(t, Zs))
				? qa(n) && 0 === p.length
					? null
					: (a?.scale?.type &&
							a?.scale?.type !== ar.LINEAR &&
							a?.stack &&
							vi(
						...
						Zo(n[rt(o)])
							? (void 0 !== a.stack &&
									vi(`Cannot stack "${(y = o)}" if there is already "${y}2".`),
								null)
							: (Go(a) &&
									a.aggregate &&
									!an.has(a.aggregate) &&
	...
	function ol(e, t, n) {
		...
		if (
			((i.orient = ((e, t, n) => {
				...
				switch (e) {
					case jr:
						if (Go(i) && (un(i.bin) || (Go(r) && r.aggregate && !i.aggregate)))
							return "vertical";
						if (Go(r) && (un(r.bin) || (Go(i) && i.aggregate && !r.aggregate)))
							return "horizontal";
						if (a || o) {
							if (n) return n;
							if (!o)
								return ((Go(i) && i.type === tr && !cn(i.bin)) || Ko(i)) &&
									Go(r) &&
									un(r.bin)
									? "horizontal"
									: "vertical";
							if (!a)
								return ((Go(r) && r.type === tr && !cn(r.bin)) || Ko(r)) &&
									Go(i) &&
									un(i.bin)
									? "vertical"
									: "horizontal";
					...
					case qr:
						if (o && (!Go(i) || !un(i.bin)) && a && (!Go(r) || !un(r.bin)))
							return;
					case Tr:
						if (a) return Go(r) && un(r.bin) ? "horizontal" : "vertical";
						if (o) return Go(i) && un(i.bin) ? "vertical" : "horizontal";
						if (e === qr) {
			...
			void 0 !== r &&
				r !== i.orient &&
				vi(`Specified orient "${i.orient}" overridden with "${r}".`),
			"bar" === i.type && i.orient)
		) {
		...
		const o = _n("opacity", i, n),
			a = _n("fillOpacity", i, n);
		void 0 === o &&
			void 0 === a &&
			(i.opacity = ((e, t) => {
				if (p([Rr, Wr, Br, Vr], e) && !qa(t)) return 0.7;
				return;
			})(i.type, t));
		return (
			void 0 === _n("cursor", i, n) &&
				(i.cursor = ((e, t, n) => {
	...
	class ul {
		...
		hasMatchingType(e, t) {
			if (ja(e)) {
				...
				switch (r.type) {
					...
					case "rule":
					case "trail":
						return !!ll(r, t[r.type], i);
					case "area":
						return !!ll(r, t[r.type], i) || !!cl(r, t[r.type]);
				}
			}
			return !1;
		}
		run(e, t, n) {
			...
			return (
				...
				n({ ...c, layer: h }, { ...t, config: sl(i) })
			);
		}
	}
	function fl(e, t) {
		return t ? (jo(e) ? yl(e, t) : pl(e, t)) : e;
	}
	function dl(e, t) {
		return t ? yl(e, t) : e;
	}
	function ml(e, n, i) {
		...
		return (
			(o = r),
			!t.isString(o) && Q(o, "repeat")
				? r.repeat in i
					? { ...n, [e]: i[r.repeat] }
					: void vi(((e) => `Unknown repeated value "${e}".`)(r.repeat))
				: n
		);
		var o;
	}
	function pl(e, t) {
		if (void 0 !== (e = ml("field", e, t))) {
			if (null === e) return null;
			if (Lo(e) && Ao(e.sort)) {
				const n = ml("field", e.sort, t);
				e = { ...e, ...(n ? { sort: n } : {}) };
			}
			return e;
		}
	...
	function gl(e, t) {
		if (Go(e)) return pl(e, t);
		{
			const n = ml("datum", e, t);
	...
	function hl(e, t) {
		...
		}
		{
			const n = gl(e, t);
			if (n) return n;
			if (Bo(e)) return { condition: e.condition };
		}
	}
	function yl(e, n) {
		const i = {};
		for (const r in e)
			if (Q(e, r)) {
				const o = e[r];
				if (t.isArray(o)) i[r] = o.map((e) => hl(e, n)).filter((e) => e);
				else {
					const e = hl(o, n);
					void 0 !== e && (i[r] = e);
				}
	...
	class vl {
		...
		hasMatchingType(e) {
			if (ja(e)) {
				...
				if ("line" === n || (Qr(n) && "line" === n.type))
					for (const e of et) {
						const n = t[nt(e)];
						if (t[e] && ((Go(n) && !un(n.bin)) || Xo(n))) return !0;
					}
			}
			return !1;
		}
			...
			for (const a of e) {
				...
				if (Zo(e)) {
					...
					Ho(e)
						...
						: e || null === e
							? (o[a] = e)
							: (r || ta(s) || vn(s) || Zo(s) || t.isArray(s)) && (o[a] = s);
			}
		} else o = i;
		...
		return (
			t &&
				...
				vi(
					((e) => {
						const { parentProjection: t, projection: n } = e;
						return `Layer's shared projection ${X(t)} is overridden by a child projection ${X(n)}.`;
	...
	function Ll(e) {
		return Q(e, "extent") && !Q(e, "density") && !Q(e, "regression");
	}
	function ql(e, t) {
		...
		if (n) {
			return {
				...i,
				transform: n.map((e) => {
					if ($l(e)) return { filter: Il(e, t) };
					if (Al(e) && fn(e.bin)) return { ...e, bin: Wl(e.bin) };
					if (wl(e)) {
	...
	function Ul(e, n) {
		const i = l(e);
		if (
			(Go(i) && fn(i.bin) && (i.bin = Wl(i.bin)),
			na(i) && i.scale?.domain?.selection)
		) {
		...
		if (Bo(i))
			if (t.isArray(i.condition))
				i.condition = i.condition.map((e) => {
					...
					return i ? e : { ...o, test: Il(e, n) };
				});
			else {
				const { selection: e, param: t, test: r, ...o } = Ul(i.condition, n);
	...
	class Bl extends Ks {
		map(e, t) {
			...
			if (e.params && !ja(e)) {
				const t = [];
				for (const i of e.params) Fs(i) ? n.push(i) : t.push(i);
				e.params = t;
			}
	...
	for (const e of [
		...
		const t = Bl.prototype[e];
		Bl.prototype[e] = function (e, n) {
	...
	function Hl(e, t) {
		void 0 === t && (t = Vs(e.config));
		const n = (function (e) {
				const t =
					arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
				const n = { config: t };
				return Xl.map(Gl.map(Yl.map(e, n), n), n);
			})(e, t),
			{ width: i, height: r } = e,
			o = ((e, t, n) => {
				...
				o
					...
					: ("container" == i && (vi(Wn("width")), (i = void 0)),
						"container" == r && (vi(Wn("height")), (r = void 0)));
				const s = {
					type: "pad",
					...a,
					...(n ? Ql(n.autosize) : {}),
	...
	const Gl = new (class extends Ks {
			nonFacetUnitNormalizers = (() => [es, os, fs, new ul(), new vl()])();
			map(e, t) {
				if (ja(e)) {
					const n = Ma(e.encoding, J),
						i = Ma(e.encoding, K),
						r = Ma(e.encoding, Z);
			...
			mapRepeat(e, n) {
				return ((e) => !t.isArray(e.repeat) && Q(e.repeat, "layer"))(e)
			...
			mapFacet(e, t) {
				const { facet: n } = e;
				return (
					jo(n) && e.columns && ((e = f(e, ["columns"])), vi(Qn("facet"))),
					super.mapFacet(e, t)
				);
			}
			mapUnitWithParentEncodingOrProjection(e, t) {
				const { encoding: n, projection: i } = e,
					...
					s = xl({ parentProjection: o, projection: i }),
					l = bl({ parentEncoding: r, encoding: dl(n, t.repeater) });
				return this.mapUnit(
					{
						...e,
						...(s ? { projection: s } : {}),
			...
			getFacetMappingAndLayout(e, t) {
				...
				if (n || i) {
					r &&
						vi(
							`Facet encoding dropped as ${((o = [...(n ? [J] : []), ...(i ? [K] : [])])).join(" and ")} ${o.length > 1 ? "are" : "is"} also specified.`,
						);
					const t = {},
						a = {};
					for (const n of [J, K]) {
			...
			mapLayer(e, t) {
				...
				const { encoding: o, projection: a, ...s } = e,
					l = {
						...r,
						parentEncoding: bl({ parentEncoding: n, encoding: o, layer: !0 }),
						parentProjection: xl({ parentProjection: i, projection: a }),
					};
		...
		Yl = new (class extends Ks {
			...
			mapLayerOrUnit(e, t) {
				if ((e = ql(e, t)).encoding) {
					const n = {};
					for (const [i, r] of O(e.encoding)) n[i] = Ul(r, t);
					e = { ...e, encoding: n };
				}
	...
	const Jl = ["background", "padding"];
	function Kl(e, t) {
		const n = {};
		for (const t of Jl) e && void 0 !== e[t] && (n[t] = Dn(e[t]));
	...
	class Zl {
		...
		clone() {
			return new Zl(l(this.explicit), l(this.implicit));
		}
		combine() {
	...
	function ic(e, t, n, i) {
		return (
			e.explicit &&
				...
				vi(
					((e, t, n, i) =>
						`Conflicting ${t.toString()} property "${e.toString()}" (${X(n)} and ${X(i)}). Using ${X(n)}.`)(
						n,
						i,
						e.value,
						t.value,
	...
	function rc(e, t, n, i) {
		const r =
			arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : ic;
	...
	function lc(e) {
		return Q(e, "name") && !ac(e) && !sc(e) && !cc(e);
	}
	function cc(e) {
	...
	function yc(e, n) {
		for (const i of F(e.component.selection ?? {})) {
			const r = i.name;
			let o = `${r}${Mu}, ${"global" === i.resolve ? "true" : `{unit: ${Uu(e)}}`}`;
			for (const t of qu)
				t.defined(i) &&
			...
			n.push({
				...
				on: [
					{
						events: { signal: i.name + Mu },
						update: `modify(${t.stringValue(i.name + Eu)}, ${o})`,
					},
				],
			});
		}
	...
	function bc(e, t) {
		for (const n of F(e.component.selection ?? {}))
			for (const i of qu) i.defined(n) && i.marks && (t = i.marks(e, n, t));
		return t;
	}
	function xc(e) {
	...
	class $c {
		...
		addChild(e, t) {
			this._children.includes(e)
				? vi("Attempt to add the same child twice.")
				: void 0 !== t
	...
	class wc extends $c {
		...
		hash() {
			return (
				void 0 === this._hash && (this._hash = `Output ${W()}`), this._hash
			);
		}
		getSource() {
					...
					if (zi(o)) {
						if (Sm(t)) {
							const { mark: e, markDef: i, config: s } = t,
								l = qo({ fieldDef: n, markDef: i, config: s });
							(Yr(e) || l) && (a = { timeUnit: Mi(o), field: r });
						}
					} else a = { as: sa(n, { forAs: !0 }), field: r, timeUnit: o };
					if (Sm(t)) {
						const { mark: e, markDef: r, config: o } = t,
							s = qo({ fieldDef: n, markDef: r, config: o });
						Yr(e) && zt(i) && 0.5 !== s && (a.rectBandPosition = s);
					}
					a && (e[d(a)] = a);
				}
				return e;
	...
	function zc(e) {
		...
		const { unit: r, utc: o } = t,
			a = Ai(r),
			{ part: s, step: l } = qi(a, t.step);
		return `${o ? "utcOffset" : "timeOffset"}('${s}', datum['${n}'], ${i ? -l : l})`;
	}
	function Cc(e, t, n) {
		const [i, r] = e;
		if (void 0 !== t && 0.5 !== t) {
			...
			return [
				{
					type: "formula",
					expr: Nc([zc({ timeUnit: n, field: i, reverse: !0 }), e], t + 0.5),
					as: `${i}_${Fc}`,
				},
				{ type: "formula", expr: Nc([e, o], t + 0.5), as: `${i}_${Oc}` },
			];
		}
		return [];
	}
	...
	const Ac = {
			...
			parse: (e, n, i) => {
						...
						if (!a[i]) {
							const r = {
								...
								type:
									"interval" === u &&
									Ht(t) &&
									vr(e.getScaleComponent(t).get("type"))
										? "R"
										: n.bin
											? "R-RE"
											: "E",
							...
							(r.signals = { ...c(r, "data"), ...c(r, "visual") }),
								o.items.push((a[i] = r)),
								(o.hasField[i] = a[i]),
								(o.hasSelectionId = o.hasSelectionId || i === ws),
								Me(t)
									? ((r.geoChannel = t),
										(r.channel = Ee(t)),
				...
				for (const e of p ?? []) {
					...
					(t.signals = { ...c(t, "data") }),
						o.items.push(t),
						(o.hasField[e] = t),
						(o.hasSelectionId = o.hasSelectionId || e === ws);
				}
				m &&
					(n.init = m.map((e) =>
						o.items.map((n) =>
			...
			signals: (e, t, n) => {
				...
				return n.filter((e) => e.name === i).length > 0 ||
					...
					? n
					: n.concat({ name: i, value: t.project.items.map(gc) });
			},
		},
		Tc = {
			defined: (e) =>
			...
			topLevelSignals: (e, n, i) => {
				...
				if (!e.parent || Ec(e) || 0 === r.length) return i;
				const o = i.find((e) => e.name === n.name);
				let a = o.update;
				if (a.includes(Lu))
					o.update = `{${r.map((e) => `${t.stringValue(E(e.field))}: ${e.signals.data}`).join(", ")}}`;
				else {
					for (const e of r) {
	...
	function Ec(e) {
		return (
			e.parent && Om(e.parent) && (!e.parent.parent ?? Ec(e.parent.parent))
		);
	}
	const Mc = "_brush",
		Rc = "_scale_trigger",
		Lc = "geo_interval_init_tick",
		qc = "_init",
		Uc = {
			...
			parse: (e, n, i) => {
				if (e.hasProjection) {
					...
					(e.fields = [ws]),
						e.encodings || (e.encodings = i.value ? D(i.value) : [fe, ue]),
						(i.select = { type: "interval", ...e });
				}
				if (n.translate && !Tc.defined(n)) {
					const e = `!event.item || event.item.mark.name !== ${t.stringValue(n.name + Mc)}`;
			...
			signals: (e, n, i) => {
				...
				if (
									...
									((e, n, i, r) => {
										...
										if (o) {
											const t = i.signals.data,
												...
												m = r ? { init: hc(r, !0, c) } : { value: [] };
											return (
												d.push({
													events: { signal: n.name + Rc },
													update: vr(f)
														? `[${c(`${t}[0]`)}, ${c(`${t}[1]`)}]`
														: "[0, 0]",
												}),
					...
					const v = `vlSelectionTuples(${`intersect(${y}, {markname: ${t.stringValue(e.getName("marks"))}}, unit.mark)`}, ${`{unit: ${Uu(e)}}`})`,
				...
				}
				{
						...
						const n = r + Rc,
							o = a.map((n) => {
								const i = n.channel,
									...
									s = vr(e.getScaleComponent(i).get("type")) ? "+" : "";
					...
					const l = a.map((e) => e.signals.data),
						c = `unit: ${Uu(e)}, fields: ${r + Pc}, values`;
					return i.concat({
						name: o,
						...(s ? { init: `{${c}: ${hc(s)}}` } : {}),
						...(l.length
			...
			topLevelSignals: (e, t, n) => {
				if (Sm(e) && e.hasProjection && t.init) {
					n.filter((e) => e.name === Lc).length ||
						n.unshift({
							name: Lc,
							value: null,
							on: [
								{ events: "timer{1}", update: `${Lc} === null ? {} : ${Lc}` },
							],
						});
				}
				return n;
			...
			marks: (e, n, i) => {
				const r = n.name,
					...
					s = o?.signals.visual,
					l = a?.signals.visual,
					c = `data(${t.stringValue(n.name + Eu)})`;
				if (Tc.defined(n) || (!o && !a)) return i;
				const u = {
				...
				if ("global" === n.resolve)
					for (const t of D(u))
						u[t] = [
							{ test: `${c}.length && ${c}[0].unit === ${Uu(e)}`, ...u[t] },
							{ value: 0 },
						];
		...
		signals: (e, n, i) => {
			const r = n.name,
				...
				l = F(e.component.selection ?? {})
					.reduce(
						(e, t) => ("interval" === t.type ? e.concat(t.name + Mc) : e),
						[],
					)
				...
				c =
					...
					(l ? ` && ${l}` : "");
			let u = `unit: ${Uu(e)}, `;
			if (n.project.hasSelectionId) u += `${ws}: ${s}[${t.stringValue(ws)}]`;
			else {
			...
			return i.concat([
				{
					name: r + Mu,
					on: f
						? [{ events: f, update: `${c} ? {${u}} : null`, force: !0 }]
						: [],
				},
			]);
		},
	...
	function Ic(e) {
		...
		if (s) {
			l = t.array(s).map((e) => {
				...
				if (((e) => Q(e, "param"))(e)) {
					...
					return { test: Yu(n, { param: i, empty: r }), ...t };
				}
				return { test: Qu(n, e.test), ...t };
			});
		}
		void 0 !== o && l.push(o);
		const c = a(i);
		return (
			void 0 !== c && l.push(c),
			l.length > 1 || (1 === l.length && l[0].test)
				? { [r]: l }
				: 1 === l.length
					? { [r]: l[0] }
					: {}
	...
	function Vc(e, t) {
		...
		if (e) {
			if (ta(e)) return On(e.value);
			if (Zo(e)) {
				const { format: i, formatType: r } = ga(e);
				return $o({
					fieldOrDatumDef: e,
					format: i,
					formatType: r,
	...
	function Hc(e) {
		...
		const { encoding: i, markDef: r, config: o, stack: a } = e,
			s = i.tooltip;
		if (t.isArray(s)) return { tooltip: Yc({ tooltip: s }, a, o, n) };
		{
		...
		function c(i, r) {
			...
			if (zt(r)) {
				...
				if (un(u.bin) && n) {
					const e = sa(u, { expr: s }),
						i = sa(n, { expr: s }),
						{ format: r, formatType: l } = ga(u);
					(m = Co(e, i, r, l, o)), a.add(t);
				}
			}
			if (
				(zt(r) || r === le || r === ae) &&
				...
				const { format: e, formatType: t } = ga(u);
				m = $o({
					fieldOrDatumDef: u,
					format: e,
					formatType: t,
			...
			(m ??= Vc(u, o, s).signal), l.push({ channel: r, key: d, value: m });
		}
		Ba(e, (e, t) => {
			Go(e) ? c(e, t) : Vo(e) && c(e.condition, t);
		});
		const u = {};
	...
	function Yc(e, t, n) {
		const { reactiveGeom: i } =
			arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
		const r = Gc(e, t, n, { reactiveGeom: i }),
			o = O(r).map((e) => {
				const [t, n] = e;
				return `"${t}": ${n}`;
			});
	...
	function Xc(e) {
		const { markDef: t, config: n } = e,
			i = _n("aria", t, n);
		return !1 === i ? {} : { ...(i ? { aria: i } : {}), ...Qc(e), ...Jc(e) };
	}
	function Qc(e) {
		const { mark: n, markDef: i, config: r } = e;
		if (!1 === r.aria) return {};
		const o = _n("ariaRoleDescription", i, r);
		return null != o
	...
	function Jc(e) {
		...
		if (null != a) return { description: On(a) };
		if (!1 === i.aria) return {};
		const s = Gc(t, r, i);
		return S(s)
			? void 0
	...
	function Kc(e, t) {
		...
		const c = r[e];
		void 0 === s &&
			((l ??= _n(e, i, o, { vgChannel: a, ignoreVgConfig: !Bo(c) })),
			void 0 !== l && (s = On(l)));
		const u = {
				markDef: i,
				config: o,
			...
			f = uo({ ...u, scaleChannel: e, channelDef: c });
		return Ic({
			model: t,
			channelDef: c,
			vgChannel: a ?? e,
			invalidValueRef: f,
			mainRefFn: (t) =>
				ho({ ...u, channel: e, channelDef: t, stack: null, defaultRef: s }),
		});
	}
	function Zc(e) {
		const t =
		...
		const { markDef: n, encoding: i, config: r } = e,
			...
			s = p(["bar", "point", "circle", "square", "geoshape"], o)
				...
				: void 0,
			l =
				_n(!0 === a ? "color" : void 0, n, r, { vgChannel: "fill" }) ??
				r.mark[!0 === a && "color"] ??
				s,
			c =
				_n(!1 === a ? "color" : void 0, n, r, { vgChannel: "stroke" }) ??
				r.mark[!1 === a && "color"],
			u = a ? "fill" : "stroke",
			f = { ...(l ? { fill: On(l) } : {}), ...(c ? { stroke: On(c) } : {}) };
		return (
			n.color &&
				(a ? n.fill : n.stroke) &&
				vi(ti("property", { fill: "fill" in n, stroke: "stroke" in n })),
			{
				...f,
				...Kc("color", e, { vgChannel: u, defaultValue: a ? l : c }),
				...Kc("fill", e, { defaultValue: i.fill ? l : void 0 }),
				...Kc("stroke", e, { defaultValue: i.stroke ? c : void 0 }),
			}
		);
	}
	function eu(e) {
	...
	function nu(e, t, n) {
		...
		const { encoding: o, markDef: a, config: s, stack: l } = t,
			...
			g = iu({ model: t, defaultPos: i, channel: e, scaleName: f, scale: d }),
			h =
				!c && zt(e) && (o.latitude || o.longitude)
					? { field: t.getName(e) }
					: ((e) => {
							const {
								channel: t,
							...
							if (Zo(n) && r && t === r.fieldChannel) {
								...
								return po(n, i, { suffix: "end" }, { offset: o });
							}
							return mo(e);
						})({
							channel: e,
	...
	function iu(e) {
		...
		return () => {
			const e = nt(i),
				l = it(i),
				c = _n(i, a, s, { vgChannel: l });
			if (void 0 !== c) return yo(i, c);
			switch (n) {
				case "zeroOrMin":
					return ru({
						scaleName: r,
	...
	const ou = { left: "x", center: "xc", right: "x2" },
		au = { top: "y", middle: "yc", bottom: "y2" };
	function su(e, t, n) {
		const i =
			arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "middle";
		if ("radius" === e || "theta" === e) return it(e);
		const r = "x" === e ? "align" : "baseline",
			o = _n(r, t, n);
		let a;
		return (
			vn(o)
				? (vi(((e) => `The ${e} for range marks cannot be an expression`)(r)),
					(a = void 0))
				: (a = o),
			"x" === e ? ou[a || ("top" === i ? "left" : "center")] : au[a || i]
		);
	}
	function lu(e, t, n) {
		const { defaultPos: i, defaultPos2: r, range: o } = n;
		return o
			? cu(e, t, { defaultPos: i, defaultPos2: r })
			: nu(e, t, { defaultPos: i });
	}
	function cu(e, t, n) {
		...
		const { markDef: o, config: a } = t,
			...
			c = ((e, t, n) => {
				...
				const g = ((e) => {
					...
					if (Zo(n) && l && t.charAt(0) === l.fieldChannel.charAt(0))
						return po(n, a, { suffix: "start" }, { offset: c });
					return mo({
						channel: t,
						channelDef: i,
						scaleName: a,
				...
				return (
					uu(n, o) ||
					uu(n, { [n]: Tn(n, o, s.style), [c]: Tn(c, o, s.style) }) ||
					uu(n, s[r]) ||
					uu(n, s.mark) || {
						[u]: iu({
							model: e,
		...
		return {
			...nu(e, t, { defaultPos: i, vgChannel: c[l] ? su(e, o, a) : it(e) }),
			...c,
		};
	}
	function uu(e, t) {
		const n = ot(e),
			i = it(e);
		if (void 0 !== t[i]) return { [i]: yo(e, t[i]) };
		if (void 0 !== t[e]) return { [i]: yo(e, t[e]) };
		if (t[n]) {
			const i = t[n];
			if (!no(i)) return { [n]: yo(e, i) };
			vi(
	...
	function fu(e, n) {
		...
		return !Go(c) ||
			!(cn(c.bin) || un(c.bin) || (c.timeUnit && !u)) ||
			(p && !no(p)) ||
			r[g] ||
			yr(d)
			? ((Zo(c) && yr(d)) || h) && !u
				? ((e, n, i) => {
						...
						(o.size || r.size) &&
							(h
								? (y = Kc("size", i, { vgChannel: f, defaultRef: On(r.size) }))
								: vi(
						...
						y = y || { [f]: du(f, p || c, g || u, a, b, !!e, r.type) };
						const x =
								"band" === (u || g)?.get("type") && no(b) && !v
									? "top"
									: "middle",
							$ = su(n, r, a, x),
							w = "xc" === $ || "yc" === $,
							{ offset: k, offsetType: S } = tu({
								channel: n,
								markDef: r,
								encoding: o,
								model: i,
				...
				: cu(n, e, { defaultPos: "zeroOrMax", defaultPos2: "zeroOrMin" })
			: ((e) => {
					...
					const { config: o, markDef: a, encoding: s } = r,
						...
						w = ((e) => {
							...
							const i = sa(n, { expr: "datum" });
							return `abs(scale("${t}", ${sa(n, { expr: "datum", suffix: "end" })}) - scale("${t}", ${i}))`;
						...
						D = vn(d)
							...
							: no(d)
								? (1 - d.band) / 2
								: 0.5,
						F = qo({ fieldDef: t, fieldDef2: n, markDef: a, config: o });
					if (cn(t.bin) || t.timeUnit) {
						...
						return {
							...
							[y]: pu({
								fieldDef: t,
								scaleName: c,
								bandPosition: vn(D) ? { signal: `1-${D.signal}` } : 1 - D,
								offset: k,
								useRectOffsetField: e,
							}),
						};
					...
					if (un(t.bin)) {
						const e = po(t, c, {}, { offset: S });
						if (Go(n)) return { [v]: e, [y]: po(n, c, {}, { offset: k }) };
						if (fn(t.bin) && t.bin.step)
							return {
								[v]: e,
								[y]: {
									signal: `scale("${c}", ${sa(t, { expr: "datum" })} + ${t.bin.step})`,
									offset: k,
								},
							};
					}
	...
	function du(e, n, i, r, o, a, s) {
		if (no(o)) {
			if (!i) return { mult: o.band, field: { group: e } };
			{
				...
				if ("band" === e) {
					let e = `bandwidth('${n}')`;
					1 !== o.band && (e = `${o.band} * ${e}`);
					const t = An("minBandSize", { type: s }, r);
					return { signal: t ? `max(${Cn(t)}, ${e})` : e };
				}
				1 !== o.band &&
					(vi(((e) => `Cannot use the relative band size with ${e} scale.`)(e)),
					(o = void 0));
			}
		} else {
			if (vn(o)) return o;
		...
		if (i) {
			const e = i.get("range");
			if (bn(e) && t.isNumber(e.step)) return { value: e.step - 2 };
		}
		if (!a) {
			const {
					bandPaddingInner: n,
				...
				l = q(n, "tick" === s ? a : "bar" === s ? i : o);
			if (vn(l)) return { signal: `(1 - (${l.signal})) * ${e}` };
			if (t.isNumber(l)) return { signal: `${1 - l} * ${e}` };
		}
		return { value: Es(r.view, e) - 2 };
	}
	...
	const gu = new Set(["aria", "width", "height"]);
	function hu(e, t) {
		const { fill: n, stroke: i } = "include" === t.color ? Zc(e) : {};
		return {
			...vu(e.markDef, t),
			...yu("fill", n),
			...yu("stroke", i),
	...
	function vu(e, t) {
		return $n.reduce(
			(n, i) => (
				!gu.has(i) && Q(e, i) && "ignore" !== t[i] && (n[i] = On(e[i])), n
			),
			{},
		);
	}
	function bu(e) {
		...
		if (
			(e.forEachFieldDef((r, o) => {
				let a;
				if (!Ht(o) || !(a = e.getScaleType(o))) return;
				const s = on(r.aggregate),
					l = lo({
						scaleChannel: o,
						markDef: n,
						config: t,
			...
			return { defined: { signal: [...i].map((e) => Ji(e, !0)).join(" && ") } };
		}
	}
	function xu(e, t) {
		if (void 0 !== t) return { [e]: On(t) };
	}
	const $u = "voronoi",
		wu = {
			defined: (e) => "point" === e.type && e.nearest,
			parse: (e, t) => {
				if (t.events) for (const n of t.events) n.markname = e.getName($u);
			},
			marks: (e, t, n) => {
				...
				if (Gr(o))
					return (
						vi(`The "nearest" transform is not supported for ${o} marks.`), n
					);
				const a = {
					name: e.getName($u),
					type: "path",
		...
		Fu = {
			...
			signals: (e, t, n) => {
				...
				if ("interval" === t.type)
					...
					let e = n.findIndex((e) => e.name === t.name + Mu);
					i(e, "null"),
						Du.defined(t) &&
							((e = n.findIndex((e) => e.name === t.name + Su)), i(e, "false"));
				}
				return n;
			},
		},
		Ou = {
			defined: (e) => {
				const t = "global" === e.resolve && e.bind && Ss(e.bind),
					n = 1 === e.project.items.length && e.project.items[0].field !== ws;
				return (
					t &&
						!n &&
						vi(
			...
			signals: (e, t, n) => {
				...
				const c = n.find((e) => e.name === i + Su),
					u = Ds(t.bind) && t.bind.legend;
				return (
					c &&
						(t.events
	...
	const zu = "_translate_anchor",
		...
		Nu = {
			...
			signals: (e, n, i) => {
				...
				return (
					o || (c = c.map((e) => ((e.between[0].markname = r + Mc), e))),
					i.push(
						{
							name: a,
							value: {},
							on: [
								{
									...
									update:
										"{x: x(unit), y: y(unit)" +
										(void 0 !== s
											? `, extent_x: ${o ? jc(e, ee) : `slice(${s.signals.visual})`}`
											: "") +
										(void 0 !== l
											? `, extent_y: ${o ? jc(e, te) : `slice(${l.signals.visual})`}`
											: "") +
										"}",
								},
							],
					...
					void 0 !== s && Pu(e, n, s, "width", i),
					void 0 !== l && Pu(e, n, l, "height", i),
					i
				);
			},
		};
	function Pu(e, t, n, i, r) {
		const o = t.name,
			...
			p = d && d.get("reverse"),
			g = `${a}.extent_${l}`,
			h = `${c && d ? ("log" === m ? "panLog" : "symlog" === m ? "panSymlog" : "pow" === m ? "panPow" : "panLinear") : "panLinear"}(${g}, ${`${c ? (l === ee ? (p ? "" : "-") : p ? "-" : "") : ""}${s}.${l} / ${c ? `${f}` : `span(${g})`}`}${c ? ("pow" === m ? `, ${d.get("exponent") ?? 1}` : "symlog" === m ? `, ${d.get("constant") ?? 1}` : "") : ""})`;
		u.on.push({
			events: { signal: s },
			update: c ? h : `clampRange(${h}, 0, ${f})`,
		});
	}
	const _u = "_zoom_anchor",
		Au = "_zoom_delta",
		Tu = {
			...
			signals: (e, n, i) => {
				...
				return (
					...
					void 0 !== s && ju(e, n, s, "width", i),
					void 0 !== l && ju(e, n, l, "height", i),
					i
				);
			},
		};
	function ju(e, t, n, i, r) {
		const o = t.name,
			...
			d = s ? jc(e, a) : l.name,
			m = o + Au,
			p = `${s && u ? ("log" === f ? "zoomLog" : "symlog" === f ? "zoomSymlog" : "pow" === f ? "zoomPow" : "zoomLinear") : "zoomLinear"}(${d}, ${`${o}${_u}.${a}`}, ${m}${s ? ("pow" === f ? `, ${u.get("exponent") ?? 1}` : "symlog" === f ? `, ${u.get("constant") ?? 1}` : "") : ""})`;
		l.on.push({
			events: { signal: m },
	...
	const Eu = "_store",
		Mu = "_tuple",
		Ru = "_modify",
		Lu = "vlSelectionResolve",
		qu = [Wc, Uc, Ac, Du, ku, Tc, Ou, Fu, Nu, Tu, wu];
	function Uu(e) {
		let { escape: n } =
				arguments.length > 1 && void 0 !== arguments[1]
					? arguments[1]
		...
		return "Identifier" === e.type
			...
			: "Literal" === e.type
				...
				: ("MemberExpression" === e.type &&
						(t.push(...Bu(e.object)), t.push(...Bu(e.property))),
					t);
	}
	function Vu(e) {
	...
	class Gu extends $c {
		clone() {
			return new Gu(null, this.model, l(this.filter));
		}
		constructor(e, t, n) {
			super(e),
				(this.model = t),
				(this.filter = n),
				(this.expr = Qu(this.model, this.filter, this)),
				(this._dependentFields = Hu(this.expr));
		}
		dependentFields() {
		...
		if (o || s) {
					...
					? ((s = a.project.items[0].field),
						vi(
							(e.length ? "Multiple " : "No ") +
								`matching ${t.stringValue(o)} encoding found for selection ${t.stringValue(i.param)}. ` +
			...
			(s = a.project.items[0].field),
				a.project.items.length > 1 &&
					vi(
						`A "field" or "encoding" must be specified when using a selection as a scale domain. Using "field": ${t.stringValue(s)}.`,
					);
		return `${a.name}[${t.stringValue(E(s))}]`;
	}
	function Qu(e, n, i) {
		return N(n, (n) =>
			t.isString(n) ? n : ((e) => Q(e, "param"))(n) ? Yu(e, n, i) : Qi(n),
		);
	}
	function Ju(e, t, n, i) {
		(e.encode ??= {}),
			...
			}
			{
				...
				if (void 0 !== l) {
					...
					f.encode?.labels?.update &&
						vn(f.encode.labels.update.text) &&
						(e = M(l, "datum.label", f.encode.labels.update.text.signal)),
						Ju(f, "labels", "text", { signal: e });
				}
				if ((null === f.labelAlign && delete f.labelAlign, f.encode)) {
					for (const t of Ca) e.hasAxisPart(t) || delete f.encode[t];
					S(f.encode) && delete f.encode;
				}
				const n = ((e, n) => {
					if (e)
						return t.isArray(e) && !yn(e)
							? e.map((e) => pa(e, n)).join(", ")
							: e;
				})(c, i);
				return {
			...
			...e.map((e) => {
				if ("axisOrient" === e) {
					...
					for (const t of a.values())
						s[t] = {
							signal: `${i.signal} === "${e}" ? ${Cn(r[t])} : ${Cn(o[t])}`,
						};
					return s;
				}
				return t[e];
	...
	const rf = {
		...
		grid: (e) => {
			...
			return (
				n.grid ??
				((e, t) => !yr(e) && Go(t) && !cn(t?.bin) && !un(t?.bin))(i, t)
			);
		},
		gridScale: (e) => {
			const { model: t, channel: n } = e;
		...
		labelBaseline: (e) => {
			const { axis: t, labelAngle: n, orient: i, channel: r } = e;
			return t.labelBaseline || af(n, i, r);
		},
		labelFlush: (e) => {
		...
		labelOverlap: (e) => {
			...
			return (
				...
				((e, n, i, r) => {
					...
					return;
				})(i.type, r, Go(i) && !!i.timeUnit, Go(i) ? i.sort : void 0)
			);
		},
		orient: (e) => {
			const { orient: t } = e;
		...
		tickCount: (e) => {
			...
			return (
				...
				((e) => {
					...
					if (!r && !yr(n) && "log" !== n) {
						if (Go(t)) {
							if (cn(t.bin)) return { signal: `ceil(${i.signal}/10)` };
							if (
								t.timeUnit &&
								p(["month", "hours", "day", "quarter"], Mi(t.timeUnit)?.unit)
							)
								return;
						}
		...
		title: (e) => {
			...
			const o = n.typedFieldDef(i),
				a = "x" === i ? "x2" : "y2",
				s = n.fieldDef(a);
			return Mn(o ? [Ro(o)] : [], Go(s) ? [Ro(s)] : []);
		},
		values: (e) => {
			const { axis: n, fieldOrDatumDef: i } = e;
			return ((e, n) => {
				const i = e.values;
				if (t.isArray(i)) return Da(n, i);
				if (vn(i)) return i;
				return;
			})(n, i);
		},
		...
		if (void 0 !== e) {
			if ("x" === n) {
				if (vn(e)) {
					const n = of(e);
					return {
						signal: `(45 < ${n} && ${n} < 135) || (225 < ${n} && ${n} < 315) ? "middle" :(${n} <= 45 || 315 <= ${n}) === ${vn(t) ? `(${t.signal} === "top")` : "top" === t} ? "bottom" : "top"`,
					};
				}
			...
			if (vn(e)) {
				const n = of(e);
				return {
					signal: `${n} <= 45 || 315 <= ${n} || (135 <= ${n} && ${n} <= 225) ? ${i ? '"middle"' : "null"} : (45 <= ${n} && ${n} <= 135) === ${vn(t) ? `(${t.signal} === "left")` : "left" === t} ? "top" : "bottom"`,
				};
			}
	...
	function sf(e, t, n) {
		...
		if (vn(e)) {
			const n = of(e);
			return {
				signal: `(${r ? `(${n} + 90)` : n} % 180 === 0) ? ${i ? null : '"center"'} :(${r} < ${n} && ${n} < ${180 + r}) === ${vn(t) ? `(${t.signal} === "${o}")` : t === o} ? "left" : "right"`,
			};
		}
	...
	class cf extends $c {
		clone() {
			return new cf(null, l(this.transform));
		}
		constructor(e, t) {
			super(e),
				(this.transform = t),
				(this._dependentFields = Hu(this.transform.calculate));
		}
						...
						const { field: i, timeUnit: r } = t,
							...
							a =
								o
									.map(
										(e, t) =>
											`${Qi({ field: i, timeUnit: r, equal: e })} ? ${t} : `,
									)
									.join("") + o.length;
						e = new cf(e, { calculate: a, as: uf(t, n, { forAs: !0 }) });
					}
				}),
				e
			);
	...
	function uf(e, t, n) {
		return sa(e, { prefix: t, suffix: "sort_index", ...n });
	}
	function ff(e, t) {
	...
	function hf(e, t) {
		const n = e.component.layoutHeaders[t].title,
				...
				: void 0,
			{
				...
				titleAngle: a,
				titleOrient: s,
			} = mf(["titleAnchor", "titleAngle", "titleOrient"], r.header, i, t),
			l = ff(t, s),
			c = V(a);
		return {
			name: `${t}-title`,
	...
	function yf(e, t) {
		...
		const n = sf(t, "row" === e ? "left" : "top", "row" === e ? "y" : "x");
		return n ? { align: n } : {};
	}
	function vf(e, t) {
		const n = af(e, "row" === t ? "left" : "top", "row" === t ? "y" : "x", !0);
		return n ? { baseline: n } : {};
	}
	function bf(e, t) {
	...
	function xf(e, n) {
		const { sort: i } = e;
		return Ao(i)
			? { field: sa(i, { expr: "datum" }), order: i.order ?? "ascending" }
			: t.isArray(i)
				? { field: uf(e, n, { expr: "datum" }), order: "ascending" }
				: { field: sa(e, { expr: "datum" }), order: i ?? "ascending" };
	}
	function $f(e, t, n) {
		const {
				format: i,
		...
		return {
			text: {
				signal: l
					? M(M(l, "datum.label", c), "datum.value", sa(e, { expr: "parent" }))
					: c,
			},
			...("row" === t ? { orient: "left" } : {}),
			style: "guide-label",
	...
	function wf(e, t, n, i, r) {
		if (r) {
			...
			if (a && r.labels) {
				const { labelOrient: e } = mf(["labelOrient"], a.header, s, t);
				(("row" === t && !p(["top", "bottom"], e)) ||
					("column" === t && !p(["left", "right"], e))) &&
					(o = $f(a, t, s));
			}
			const l = Dm(e) && !jo(e.facet),
				c = r.axes,
				u = c?.length > 0;
			if (o || u) {
				...
				return {
					...
					role: `${t}-${n}`,
					...(i.facetFieldDef
						? { from: { data: e.getName(`${t}_domain`) }, sort: xf(a, t) }
						: {}),
	...
	const kf = { column: { start: 0, end: 1 }, row: { start: 1, end: 0 } };
	function Sf(e, t) {
		return kf[t][e];
	}
	...
	function Of(e, t) {
		...
		if ("step" === i) {
			...
			if (t) {
				...
				if (yr(i) && bn(o)) {
					...
					return [
						zf(i, o),
						{ name: r, update: Cf(i, t, `domain('${i}').length`) },
					];
				}
			}
		...
		if ("container" == i) {
			const t = r.endsWith("width"),
				...
				i = `isFinite(${n}) ? ${n} : ${js(e.config.view, t ? "width" : "height")}`;
			return [
	...
	function _f(e, t) {
		if (Dm(t)) return "theta" === e ? "independent" : "shared";
		if (Om(t)) return "shared";
		if (Fm(t))
	...
	const Ef = {
		symbols: (e, n) => {
			...
			const p = a.get("symbolOpacity") ?? u.legend.symbolOpacity,
				...
				y = void 0 === p ? (Mf(c.opacity) ?? l.opacity) : void 0;
			if (m.fill)
				if ("fill" === o || (d && o === pe)) delete m.fill;
				else if (Q(m.fill, "field"))
					g
						? delete m.fill
						: ((m.fill = On(u.legend.symbolBaseFillColor ?? "black")),
							(m.fillOpacity = On(y ?? 1)));
				else if (t.isArray(m.fill)) {
					const e = Rf(c.fill ?? c.color) ?? l.fill ?? (d && l.color);
					e && (m.fill = On(e));
				}
			if (m.stroke)
				if ("stroke" === o || (!d && o === pe)) delete m.stroke;
				else if (Q(m.stroke, "field") || h) delete m.stroke;
				else if (t.isArray(m.stroke)) {
					const e = q(Rf(c.stroke || c.color), l.stroke, d ? l.color : void 0);
					e && (m.stroke = { value: e });
				}
			if (o !== xe) {
				const e = Go(i) && qf(r, a, i);
				e
					? (m.opacity = [
							{ test: e, ...On(y ?? 1) },
							On(u.legend.unselectedOpacity),
						])
					: y && (m.opacity = On(y));
			}
	...
	function Mf(e) {
		return Lf(e, (e, t) => Math.max(e, t.value));
	}
	function Rf(e) {
		return Lf(e, (e, t) => q(e, t.value));
	}
	function Lf(e, n) {
		return ((e) => {
			const n = e?.condition;
			return !!n && (t.isArray(n) || ta(n));
		})(e)
	...
	function qf(e, n, i) {
		...
		return r
			.map(
				(e) =>
					`(!length(data(${t.stringValue(C(e) + Eu)})) || (${e}[${o}] && indexof(${e}[${o}], datum.value) >= 0))`,
			)
			.join(" || ");
	}
	const Uf = {
		...
		title: (e) => {
			...
			return da(t, n, { allowDisabling: !0 });
		},
		type: (e) => {
			...
			? ((e) => {
					...
					for (const i of [pe, ...$s]) {
						...
						r &&
							...
							((i === ye && Go(r) && r.type === or) || (n[i] = Gf(e, i)));
					}
					return n;
				})(e)
			: ((e) => {
					...
					for (const i of e.children) {
						...
						for (const r of D(i.component.legends))
							(n.legend[r] = Af(e.component.resolve, r)),
								"shared" === n.legend[r] &&
									((t[r] = Yf(t[r], i.component.legends[r])),
	...
	function Gf(e, t) {
		...
		const c = e.getScaleComponent(t).get("type"),
			u = ya(r[t]),
			f = Go(u) ? Mi(u.timeUnit)?.unit : void 0,
			d = n.orient || o.legend.orient || "right",
			m = Wf({ legend: n, channel: t, timeUnit: f, scaleType: c }),
			p = {
				legend: n,
				channel: t,
				model: e,
				...
				orient: d,
				legendType: m,
				direction: If({ legend: n, legendType: m, orient: d, legendConfig: a }),
			};
		for (const i of Tf) {
			if (
				...
				continue;
			const r = i in Uf ? Uf[i](p) : n[i];
			if (void 0 !== r) {
				const a = Hf(r, i, n, e.fieldDef(t));
		...
		for (const t of [
			...
			const n = Pf(g[t] ?? {}, e),
				i = t in Ef ? Ef[t](n, v) : n;
			void 0 === i ||
				S(i) ||
				(y[t] = {
					...(h?.length && Go(u) ? { name: `${C(u.field)}_legend_${t}` } : {}),
			...
			.map((t) =>
				((e, t) => {
					...
					if (o.encode?.symbols) {
						...
						for (const t of $s) o[t] && delete e[t];
					}
					o.title || delete o.title;
					if (void 0 !== i) {
						let e = i;
						o.encode?.labels?.update &&
							vn(o.encode.labels.update.text) &&
	...
	function Kf(e) {
		...
		if (t.data) {
			const r = { signal: `[${t.size.map((e) => e.signal).join(", ")}]` },
				o = t.data.reduce((t, n) => {
					const i = vn(n) ? n.signal : `data('${e.lookupDataSource(n)}')`;
	...
	function td(e) {
		e.component.projection = Sm(e)
			? ((e) => {
					if (e.hasProjection) {
						const t = gn(e.specifiedProjection),
							...
							r = n
								? ((e) => {
										...
										e.channelHasField(ye) &&
											e.typedFieldDef(ye).type === or &&
											t.push({ signal: e.getName(`geojson_${t.length}`) });
			...
			: ((e) => {
					...
					let n;
					for (const t of e.children) td(t);
					...
					if (n && i) {
						const t = e.projectionName(!0),
							i = new ed(t, n.specifiedProjection, n.size, l(n.data));
	...
	function nd(e, t, n, i) {
		if (Fa(t, n)) {
			const r = Sm(e) ? (e.axis(n) ?? e.legend(n) ?? {}) : {},
				o = sa(t, { expr: "datum" }),
				a = sa(t, { expr: "datum", binSuffix: "end" });
			return {
				formulaAs: sa(t, { binSuffix: "range", forAs: !0 }),
				formula: Co(o, a, r.format, r.formatType, i),
			};
		}
		return {};
	}
	...
	function od(e, n, i) {
		...
		r = ((e) => "as" in e)(e)
			? t.isString(e.as)
				? [e.as, `${e.as}_end`]
				: [e.as[0], e.as[1]]
			: [sa(e, { forAs: !0 }), sa(e, { binSuffix: "end", forAs: !0 })];
		const a = { ...$a(n, void 0) },
			s = id(a, e.field),
		...
		if (dn(a.extent)) {
			const e = a.extent;
			(o = Xu(i, e.param, e)), delete a.extent;
		}
		return {
			key: s,
			binComponent: {
	...
	class ad extends $c {
		clone() {
			return new ad(null, l(this.bins));
		}
		constructor(e, t) {
			super(e), (this.bins = t);
		}
		static makeFromEncoding(e, t) {
			const n = t.reduceFieldDef((e, n, i) => {
				if (ea(n) && cn(n.bin)) {
					const { key: r, binComponent: o } = od(n, n.bin, t);
					e[r] = { ...o, ...e[r], ...nd(t, n, i, t.config) };
				}
				return e;
			}, {});
			return S(n) ? null : new ad(e, n);
		}
		static makeFromTransform(e, t, n) {
			const { key: i, binComponent: r } = od(t, t.bin, n);
			return new ad(e, { [i]: r });
		}
		merge(e, t) {
	...
	function sd(e, n, i, r) {
		const o = Sm(r) ? r.encoding[rt(n)] : void 0;
		if (ea(i) && Sm(r) && Wo(i, o, r.markDef, r.config)) {
			e.add(sa(i, {})), e.add(sa(i, { suffix: "end" }));
			const { mark: t, markDef: o, config: a } = r,
				s = qo({ fieldDef: i, markDef: o, config: a });
			Yr(t) &&
				0.5 !== s &&
				zt(n) &&
				(e.add(sa(i, { suffix: Fc })), e.add(sa(i, { suffix: Oc }))),
				i.bin && Fa(i, n) && e.add(sa(i, { binSuffix: "range" }));
		} else if (Me(n)) {
			const t = Ee(n);
			e.add(r.getName(t));
		} else e.add(sa(i));
	...
	class ld extends $c {
		clone() {
			return new ld(null, new Set(this.dimensions), l(this.measures));
		}
		constructor(e, t, n) {
			...
			return n
				? (t.forEachFieldDef((e, n) => {
						...
						if (o)
							if ("count" === o)
								(i["*"] ??= {}),
									(i["*"].count = new Set([sa(e, { forAs: !0 })]));
							else {
								if (en(o) || tn(o)) {
									const e = en(o) ? "argmin" : "argmax",
										t = o[e];
									(i[t] ??= {}),
										(i[t][e] = new Set([
											sa({ op: e, field: t }, { forAs: !0 }),
										]));
								} else
									(i[a] ??= {}), (i[a][o] = new Set([sa(e, { forAs: !0 })]));
								Ht(n) &&
									"unaggregated" === t.scaleDomain(n) &&
									((i[a] ??= {}),
									(i[a].min = new Set([
										sa({ field: a, aggregate: "min" }, { forAs: !0 }),
									])),
									(i[a].max = new Set([
										sa({ field: a, aggregate: "max" }, { forAs: !0 }),
									])));
							}
						else sd(r, n, e, t);
					}),
					r.size + D(i).length === 0 ? null : new ld(e, r, i))
				: null;
		}
		static makeFromTransform(e, t) {
			const n = new Set(),
			...
			for (const e of t.aggregate) {
				...
				t &&
					("count" === t
						? ((i["*"] ??= {}),
							(i["*"].count = new Set([r || sa(e, { forAs: !0 })])))
						: ((i[n] ??= {}),
							(i[n][t] ??= new Set()),
							i[n][t].add(r || sa(e, { forAs: !0 }))));
			}
			for (const e of t.groupby ?? []) n.add(e);
			return n.size + D(i).length === 0 ? null : new ld(e, n, i);
		}
		merge(e) {
	...
	class cd extends $c {
			...
			for (const e of We) {
				...
				if (i) {
					...
					this[e] = {
						...
						fields: [sa(i), ...(cn(r) ? [sa(i, { binSuffix: "end" })] : [])],
						...(Ao(o)
							? { sortField: o }
							: t.isArray(o)
								? { sortIndexField: uf(i, e) }
								: {}),
					};
				}
			}
		...
		hash() {
			let e = "Facet";
			for (const t of We) this[t] && (e += ` ${t.charAt(0)}:${d(this[t])}`);
			return e;
		}
		get fields() {
			const e = [];
			for (const t of We) this[t]?.fields && e.push(...this[t].fields);
			return e;
		}
		dependentFields() {
			...
			for (const t of Ot) {
				...
				if (n && !n.merged) {
					const i = n.get("type"),
						r = n.get("range");
					if (yr(i) && bn(r)) {
						const n = tm(nm(this.childModel, t));
						n ? (e[t] = n) : vi(Vn(t));
					}
				}
			}
		...
		assembleRowColumnHeaderData(e, t, n) {
			...
			if (s) {
				const { op: e = No, field: t } = s;
				r.push(t), o.push(e), a.push(sa(s, { forAs: !0 }));
	...
	class md extends $c {
		clone() {
			return new md(null, l(this._parse));
		}
		constructor(e, t) {
		...
		static makeExplicit(e, t, n) {
			...
			const r = t.data;
			return (
				!cc(r) && r?.format?.parse && (i = r.format.parse),
				md.makeWithAncestors(e, i, {}, n)
			);
		}
		static makeWithAncestors(e, t, n, i) {
			...
			for (const e of D(t)) {
				const n = i.get(e);
				void 0 !== n && (n === t[e] ? delete t[e] : vi(Jn(e, t[e], n)));
			}
			const r = new Zl(t, n);
			i.copyAll(r);
			const o = {};
			...
			return 0 === D(o).length || i.parseNothing ? null : new md(e, o);
		}
		get parse() {
			return this._parse;
		}
				...
				.map((e) => {
					const t = ((e, t) => {
						...
						if (t.startsWith("date:"))
							return `timeParse(${n},'${ud(t.slice(5, t.length))}')`;
						if (t.startsWith("utc:"))
							return `utcParse(${n},'${ud(t.slice(4, t.length))}')`;
						return vi(`Unrecognized parse "${t}".`), null;
					})(e, this._parse[e]);
					if (!t) return null;
	...
	class pd extends $c {
		...
		assemble() {
			return { type: "identifier", as: ws };
		}
	}
	class gd extends $c {
		clone() {
			return new gd(null, this.params);
		}
		constructor(e, t) {
	...
	class yd extends $c {
		constructor(e) {
			...
			if (
				(super(null),
				(e ??= { name: "source" }),
				cc(e) || (t = e.format ? { ...f(e.format, ["parse"]) } : {}),
				sc(e))
			)
	...
	function vd(e) {
		return e instanceof yd || e instanceof gd || e instanceof hd;
	}
	class bd {
		#e;
		constructor() {
	...
	class kd extends $d {
		constructor(e) {
			super(), (this.requiresSelectionId = e && Wu(e));
		}
		run(e) {
			e instanceof pd &&
				((this.requiresSelectionId &&
					(vd(e.parent) || e.parent instanceof ld || e.parent instanceof md)) ||
	...
	class Fd extends xd {
		run(e) {
			if (!(vd(e) || e.numChildren() > 1))
				for (const t of e.children)
					if (t instanceof md)
						if (e instanceof md) this.setModified(), e.merge(t);
						else {
	...
	class Od extends xd {
		run(e) {
			const t = [...e.children],
				n = e.children.filter((e) => e instanceof md);
			if (e.numChildren() > 1 && n.length >= 1) {
				...
				if (!S(i)) {
					...
					const n = new md(e, i);
					for (const r of t) {
						if (r instanceof md) for (const e of D(i)) delete r.parse[e];
						e.removeChild(r),
							(r.parent = n),
							r instanceof md && 0 === D(r.parse).length && r.remove();
					}
				}
			}
		}
	...
	class Nd extends xd {
		run(e) {
			const t = e.children.filter((e) => e instanceof ld),
				n = {};
			for (const e of t) {
				const t = d(e.groupBy);
	...
	class Td extends $c {
		clone() {
			return new Td(null, { ...this.filter });
		}
		constructor(e, t) {
		...
		static make(e, t, n) {
			...
			const s = t.reduceFieldDef((e, n, o) => {
				const a = Ht(o) && t.getScaleComponent(o);
				if (a) {
					const t = a.get("type"),
						{ aggregate: s } = n,
						l = lo({
							...
							config: i,
							scaleType: t,
							isCountAggregate: on(s),
						});
					"show" !== l && "always-valid" !== l && (e[n.field] = n);
				}
				return e;
			}, {});
			return D(s).length ? new Td(e, s) : null;
		}
		dependentFields() {
	...
	class Ed extends $c {
		clone() {
			return new Ed(null, l(this._stack));
		}
		constructor(e, t) {
		...
		static makeFromEncoding(e, n) {
			...
			const { groupbyChannels: o, fieldChannel: a, offset: s, impute: l } = i,
				c = o.map((e) => ha(r[e])).filter((e) => !!e),
				u = ((e) =>
					e.stack.stackBy.reduce((e, t) => {
						const n = sa(t.fieldDef);
						return n && e.push(n), e;
					}, []))(n),
				f = n.encoding.order;
			let d;
			if (t.isArray(f) || Go(f)) d = En(f);
			else {
				const e = Io(f) ? f.sort : "y" === a ? "descending" : "ascending";
				d = u.reduce(
					(t, n) => (
		...
		assemble() {
			...
			if (s)
				for (const o of n) {
					...
					if (a) {
						const t = sa(o, { expr: "datum" }),
							i = sa(o, { expr: "datum", binSuffix: "end" });
						e.push({
							type: "formula",
							expr: `${jd(t)} ? ${n}*${t}+${1 - n}*${i} : ${t}`,
							as: sa(o, { binSuffix: "mid", forAs: !0 }),
						});
					}
					e.push({
						type: "impute",
	...
	class Md extends $c {
		clone() {
			return new Md(null, l(this.transform));
		}
		constructor(e, t) {
			super(e), (this.transform = t);
		}
		...
		assemble() {
			...
			if (r && null === r[0] && null === r[1] && t.every((e) => nn(e)))
				return {
					type: "joinaggregate",
					as: n,
					ops: t,
	...
	function Rd(e) {
		...
		else e.children.map(Rd);
		var t;
	}
	function Ld(e) {
		if (e instanceof wc && e.type === mc.Main && 1 === e.numChildren()) {
			const t = e.children[0];
			t instanceof cd || (t.swapWithParent(), Ld(e));
		}
	}
	const qd = "scale_",
		Ud = 5;
			...
			? ((e) => {
					...
					for (const n of D(t)) {
						...
						if (
							...
							let t = e;
							for (; !Dm(t) && t.parent; ) t = t.parent;
							if ("shared" === t.component.resolve.scale[n])
								for (const e of i.value)
									xn(e) && (e.data = qd + e.data.replace(qd, ""));
						}
					}
				})(e)
			: ((e) => {
					for (const t of e.children) Hd(t);
					const t = e.component.scales;
					for (const n of D(t)) {
						let i,
							r = null;
	...
	function Gd(e, t) {
		const n = e.getScaleComponent(t).get("type"),
			...
			r = ((e, t, n, i) => {
				if ("unaggregated" === e) {
					const { valid: e, reason: i } = Kd(t, n);
					if (!e) return void vi(i);
				} else if (void 0 === e && i.useUnaggregatedDomain) {
					const { valid: e } = Kd(t, n);
		...
		return (
			...
			"x" === t && ya(i.x2)
				? ya(i.x)
					? rc(Xd(n, r, e, "x"), Xd(n, r, e, "x2"), "domain", "scale", Zd)
					: Xd(n, r, e, "x2")
				: "y" === t && ya(i.y2)
					? ya(i.y)
						? rc(Xd(n, r, e, "y"), Xd(n, r, e, "y2"), "domain", "scale", Zd)
						: Xd(n, r, e, "y2")
					: Xd(n, r, e, t)
		);
	}
	function Yd(e, t, n) {
		...
		return "temporal" === t || i
			? ((e, t, n) =>
					e.map((e) => ({
						signal: `{data: ${Sa(e, { timeUnit: n, type: t })}}`,
					})))(e, t, i)
			: [e];
	}
	function Xd(e, n, i, r) {
		const { encoding: o, markDef: a, mark: s, config: l, stack: c } = i,
			...
			d = u.timeUnit,
			m = ((e) => {
				const { marks: t, scales: n } = pc(e);
				return t === n
					? mc.Main
					: "include-invalid-values" === n
						? mc.PreFilterInvalid
						: mc.PostFilterInvalid;
			})({ invalid: An("invalid", a, l), isPath: Gr(s) });
		if (((e) => Q(e, "unionWith"))(n)) {
			const t = Xd(e, void 0, i, r);
			return ec([...Yd(n.unionWith, f, d), ...t.value]);
		}
		if (vn(n)) return ec([n]);
		if (n && "unaggregated" !== n && !$r(n)) return ec(Yd(n, f, d));
			...
			Ht(r) && Go(u)
				? ((e, t, n) => {
						...
						const i = e.fieldDef(t),
							r = i.sort;
						if (To(r))
							return { op: "min", field: uf(i, t), order: "ascending" };
						const { stack: o } = e,
							a = o
								? new Set([
										...o.groupbyFields,
						...
						if (((e) => Q(e, "encoding"))(r)) {
							const { encoding: t, order: n } = r,
								...
								c = o && !a.has(l);
							if (en(s) || tn(s)) return Qd({ field: sa(i), order: n }, c);
							if (nn(s) || !s) return Qd({ op: s, field: l, order: n }, c);
						} else {
							if ("descending" === r)
			...
			return tc([
				{
					...
					field: sa({ field: e, aggregate: "min" }),
				},
				{
					data: i.requestDataName(m),
					field: sa({ field: e, aggregate: "max" }),
				},
			]);
		}
		if (cn(h.bin)) {
			if (yr(e))
				return tc(
					"bin-ordinal" === e
						...
						: [
								{
									data: z(g) ? i.requestDataName(m) : i.requestDataName(mc.Raw),
									field: i.vgField(r, Fa(h, r) ? { binSuffix: "range" } : {}),
									sort:
										!0 !== g && t.isObject(g)
											? g
				...
				);
			{
				...
				return tc([{ data: i.requestDataName(m), field: i.vgField(r, {}) }]);
			}
		}
		if (h.timeUnit && p(["time", "utc"], e)) {
			...
			if (Wo(h, e, a, l)) {
				const t = i.requestDataName(m),
					n = qo({ fieldDef: h, fieldDef2: e, markDef: a, config: l }),
					o = Yr(s) && 0.5 !== n && zt(r);
				return tc([
	...
	function Zd(e, t, n, i) {
		return (
			e.explicit &&
				...
				vi(
					((e, t, n, i) =>
						`Conflicting ${t.toString()} property "${e.toString()}" (${X(n)} and ${X(i)}). Using the union of the two domains.`)(
						n,
						i,
						e.value,
						t.value,
	...
	function em(e) {
		...
		const r = b(
			i.map((e) =>
				z(e) || !("op" in e) || (t.isString(e.op) && Object.hasOwn(t, Zt))
					? e
					: (vi(
							((e) =>
								`Dropping sort property ${X(e)} as unioned domains only support boolean or op "count", "min", and "max".`)(
								e,
							),
						),
						!0),
		...
		let o;
		1 === r.length ? (o = r[0]) : r.length > 1 && (vi(di), (o = !0));
		const a = b(
			e.map((e) => (xn(e) ? e.data : null)),
			(e) => e,
		);
	...
	function tm(e) {
		if (xn(e) && t.isString(e.field)) return e.field;
		if (((e) => !t.isArray(e) && Q(e, "fields") && !Q(e, "data"))(e)) {
			let n;
			for (const i of e.fields)
				if (xn(i) && t.isString(i.field))
					if (n) {
						if (n !== i.field)
							return (
								vi(
	...
	function nm(e, t) {
		const n = e.component.scales[t]
			.get("domains")
			.map((t) => (xn(t) && (t.data = e.lookupDataSource(t.data)), t));
		return em(n);
	}
	function im(e) {
		return Om(e) || Fm(e)
			? e.children.reduce((e, t) => e.concat(im(t)), rm(e))
			: rm(e);
	}
	function rm(e) {
		return D(e.component.scales).reduce((n, i) => {
			...
			const o = r.combine(),
				...
				m = ((e, n, i, r) => {
					if (zt(i)) {
						if (bn(e)) return { step: { signal: `${n}_step` } };
					} else if (t.isObject(e) && xn(e))
				...
				g = l
					? ((e, n, i, r) => {
							const o = Xu(e, n.param, n);
							return {
								signal:
									vr(i.get("type")) && t.isArray(r) && r[0] > r[1]
										? `isValid(${o}) && reverse(${o})`
										: o,
							};
						})(e, l, r, p)
	...
	class om extends Zl {
		...
		domainHasZero() {
			...
			if (p([ar.LOG, ar.TIME, ar.UTC], e)) return "definitely-not";
			const n = this.get("zero");
			if (!0 === n || (void 0 === n && p([ar.LINEAR, ar.SQRT, ar.POW], e)))
				return "definitely";
						...
						switch (r) {
							case "range": {
								...
								if (t.isArray(r)) {
									...
									return ec({
										data: n.requestDataName(mc.Main),
										field: r.field,
		...
		const { rangeMin: l, rangeMax: u } = i,
			f = ((e, n) => {
				...
				switch (e) {
					...
					case te:
						if (p(["point", "band"], u)) {
							const t = mm(e, i, r.view);
							if (_s(t)) {
								return { step: fm(t, n, e) };
							}
						}
						return um(e, n, u);
					case re:
					case oe:
						return ((e, t, n) => {
							...
							if (!r) return um(i, t, n, { center: !0 });
							const o = r.get("type"),
								a = t.scaleName(i),
								{ markDef: s, config: l } = t;
							if ("band" === o) {
								const e = mm(i, t.size, t.config.view);
								if (_s(e)) {
									const t = dm(e, n);
									if (t) return t;
								}
							...
							}
							{
								...
								if (Go(n) && n.timeUnit) {
									const e = Ri(n.timeUnit, (e) => `scale('${a}', ${e})`),
										i = t.config.scale.bandWithNestedOffsetPaddingInner,
										r = qo({ fieldDef: n, markDef: s, config: l }) - 0.5,
										o = 0 !== r ? ` + ${r}` : "";
									if (i) {
										return [
											{
												signal: `${vn(i) ? `${i.signal}/2` + o : `${i / 2 + r}`} * (${e})`,
											},
											{
												signal: `${vn(i) ? `(1 - ${i.signal}/2)` + o : `${1 - i / 2 + r}`} * (${e})`,
											},
										];
									}
									return [0, { signal: e }];
					...
					case ve: {
						const a = ((e, t) => {
								...
								throw new Error(ii("size", e));
							})(o, r),
							s = ((e, n, i, r) => {
								const o = { x: sm(i, "x"), y: sm(i, "y") };
								switch (e) {
									case "bar":
									case "tick": {
										if (void 0 !== r.scale.maxBandSize)
											return r.scale.maxBandSize;
										const e = gm(n, o, r.view);
										return t.isNumber(e)
											? e - 1
											: new Vd(() => `${e.signal} - 1`);
									}
					...
					case ae:
						return [
							...
							new Vd(
								() =>
									`min(${n.getSignalName(Dm(n.parent) ? "child_width" : "width")},${n.getSignalName(Dm(n.parent) ? "child_height" : "height")})/2`,
							),
						];
					case ke:
	...
	function cm(e) {
		return ((e) => !t.isString(e) && Q(e, "name"))(e)
	...
	function fm(e, n, i) {
		const { encoding: r } = n,
			...
			s = r[a];
		if (
			"offset" === Ps({ step: e, offsetIsDiscrete: Zo(s) && er(s.type) }) &&
			Ra(r, a)
		) {
			...
			return {
				signal: `${e.step} * ${r} / (1-${(((l = s)), vn(l) ? l.signal : t.stringValue(l))})`,
			};
		}
		return e.step;
		var l;
	...
	function dm(e, t) {
		if ("offset" === Ps({ step: e, offsetIsDiscrete: yr(t) }))
			return { step: e.step };
	}
	function mm(e, t, n) {
	...
	const pm = 0.95;
	function gm(e, t, n) {
		const i = _s(e.width) ? e.width.step : Es(n, "width"),
			r = _s(e.height) ? e.height.step : Es(n, "height");
		return t.x || t.y
			? new Vd(
					() =>
							...
							if (void 0 !== d) {
								...
								switch (t) {
									...
									case "domainMin":
										bi(l[t]) || "temporal" === n || e
											? c.set(
													t,
													{ signal: Sa(l[t], { type: n, timeUnit: e }) },
													!0,
												)
											: c.set(t, l[t], !0);
										break;
								...
								const n = Q(ym, t)
									? ym[t]({
											...
											markDef: o,
											config: i,
											hasNestedOffsetScale: La(r, s),
											hasSecondaryRangeChannel: !!r[rt(s)],
										})
									: i.scale[t];
	...
	const ym = {
		bins: (e) => {
			...
			return Go(n)
				? ((e, t) => {
						const n = t.bin;
						if (cn(n)) {
							const i = rd(e, t.field, n);
							return new Vd(() => e.getSignalName(i));
						}
						if (un(n) && fn(n) && void 0 !== n.step) return { step: n.step };
						return;
					})(t, n)
				: void 0;
		},
		interpolate: (e) => {
			...
			return ((e, t) => {
				if (p([pe, ge, he], e) && "nominal" !== t) return "hcl";
				return;
			})(t, n.type);
		},
		nice: (e) => {
			...
			return ((e, t, n, i, r, o) => {
				if (zt(e)) {
					if (br(t)) {
						...
						if (
							"bar" === t &&
							(!Go(i) || (!i.bin && !i.timeUnit)) &&
							(("vertical" === a && "x" === e) ||
								("horizontal" === a && "y" === e))
						)
							return o.continuousBandSize;
					}
					if (t === ar.POINT) return n.pointPadding;
				}
				return;
		...
		paddingInner: (e) => {
			...
			return (function (e, t, n, i, r) {
				...
				if (zt(t)) {
					...
					return o ? s : q(e, "bar" === n ? t : "tick" === n ? a : i);
				}
				if (At(t) && i === ar.BAND) return r.offsetBandPaddingInner;
				return;
		...
		paddingOuter: (e) => {
			...
			return (function (e, t, n, i, r) {
				...
				if (zt(t)) {
					...
					if (o) return t;
					if (n === ar.BAND)
						return q(e, vn(i) ? { signal: `${i.signal}/2` } : i / 2);
				} else if (At(t)) {
					if (n === ar.POINT) return 0.5;
					if (n === ar.BAND) return r.offsetBandPaddingOuter;
				}
				return;
			})(t, n, i, r, o.scale, a);
		},
		reverse: (e) => {
			...
			return ((e, t, n, i) => {
				if ("x" === n && void 0 !== i.xReverse)
					return vr(e) && "descending" === t
						? vn(i.xReverse)
							? { signal: `!${i.xReverse.signal}` }
							: !i.xReverse
						: i.xReverse;
				if (vr(e) && "descending" === t) return !0;
				return;
			})(n, Go(t) ? t.sort : void 0, i, r.scale);
		},
		zero: (e) => {
			const {
				channel: n,
			...
			return ((e, n, i, r, o, a, s) => {
				...
				if ("size" === e && "quantitative" === n.type && !xr(o)) return !0;
				if ((!Go(n) || !n.bin) && p([...Ot, ...Nt], e)) {
	...
	function bm(e, t) {
		const n = e.component.scales;
		for (const n of e.children) "range" === t ? vm(n) : hm(n, t);
		for (const i of D(n)) {
			let r;
			for (const n of e.children) {
	...
	function xm(e, t, n, i) {
		const r = ((e, t, n, i) => {
				switch (t.type) {
					case "nominal":
					case "ordinal":
						if (qe(e) || "discrete" === Jt(e))
							return (
								"shape" === e && "ordinal" === t.type && vi(ai(e, "ordinal")),
								"ordinal"
							);
						if (zt(e) || At(e)) {
							if (p(["rect", "bar", "image", "rule", "tick"], n.type))
								return "band";
							if (i) return "band";
						} else if ("arc" === n.type && e in Ct) return "band";
						return no(n[ot(e)]) || (ia(t) && t.axis?.tickBand)
							? "band"
							: "point";
					case "temporal":
						return qe(e)
							? "time"
							: "discrete" === Jt(e)
								? (vi(ai(e, "temporal")), "ordinal")
								: Go(t) && t.timeUnit && Mi(t.timeUnit).utc
									? "utc"
									: "time";
					case "quantitative":
						return qe(e)
							? Go(t) && cn(t.bin)
								...
								: "linear"
							: "discrete" === Jt(e)
								? (vi(ai(e, "quantitative")), "ordinal")
								: "linear";
					case "geojson":
						return;
				}
				throw new Error(ei(t.type));
			})(
				t,
				n,
				i,
			...
			? void 0 !== o
				? (function (e, t) {
						...
						switch (e) {
							...
							case we:
							case be:
								return br(t) || xr(t) || p(["band", "point", "ordinal"], t);
							case pe:
							case ge:
							case he:
								return "band" !== t;
					...
					? Go(n) &&
						...
						!(p([nr, rr], s)
							? void 0 === a || yr(a)
							: s === ir
								? p([ar.TIME, ar.UTC, void 0], a)
								: s !== tr || mr(a) || xr(a) || void 0 === a))
						? (vi(
								((e, t) =>
	...
	function $m(e) {
		Sm(e)
			? (e.component.scales = ((e) => {
					...
					for (const o of Vt) {
						const a = ya(t[o]);
						if (a && n === Hr && o === ye && a.type === or) continue;
						let s = a && a.scale;
						if (a && null !== s && !1 !== s) {
							s ??= {};
							const n = xm(s, o, a, i, La(t, o));
							r[o] = new om(e.scaleName(`${o}`, !0), {
								value: n,
								explicit: s.type === n,
							});
						}
			...
			: (e.component.scales = ((e) => {
					...
					for (const t of e.children) {
						...
						for (const r of D(t.component.scales))
							if (((i.scale[r] ??= _f(r, e)), "shared" === i.scale[r])) {
								const e = n[r],
									o = t.component.scales[r].getWithExplicit("type");
								e
									? lr(e.value, o.value)
										? (n[r] = rc(e, o, "type", "scale", wm))
	...
	class zm {
		constructor(e, n, i, r, o, a, c) {
			(this.type = n),
				...
				(this.view = gn(c)),
				(this.name = e.name ?? r),
				(this.title = yn(e.title)
					? { text: e.title }
					: e.title
						? gn(e.title)
						: void 0),
				(this.scaleNameMap = i ? i.scaleNameMap : new km()),
				(this.projectionNameMap = i ? i.projectionNameMap : new km()),
				(this.signalNameMap = i ? i.signalNameMap : new km()),
				(this.data = e.data),
				(this.description = e.description),
				(this.transforms = (e.transform ?? []).map((e) =>
					$l(e) ? { filter: s(e.filter, Ki) } : e,
				)),
				(this.layout =
					"layer" === n || "unit" === n
						? {}
				...
				(this.component = {
					data: {
						...
						isFaceted:
							Mo(e) || (i?.component.data.isFaceted && void 0 === e.data),
					},
					layoutSize: new Zl(),
		...
		assembleGroupEncodeEntry(e) {
			...
			return (
				...
				e ||
				(this.description && (t.description = On(this.description)),
			...
			const { spacing: e, ...t } = this.layout,
				...
				r = ((e, t) => {
					...
					for (const i of We) {
						const r = e[i];
						if (r?.facetFieldDef) {
							const { titleAnchor: e, titleOrient: o } = mf(
		...
		assembleHeaderMarks() {
			...
			let t = [];
			for (const n of We) e[n].title && t.push(hf(this, n));
			for (const e of pf) t = t.concat(bf(this, e));
			return t;
		}
		assembleAxes() {
			return ((e, t) => {
		...
		assembleTitle() {
			const { encoding: e, ...t } = this.title ?? {},
				n = {
					...hn(this.config.title).nonMarkTitleProperties,
					...t,
					...(e ? { encode: { update: e } } : {}),
				};
			if (n.text)
		...
		assembleGroup() {
			...
			const i = !this.parent || Dm(this.parent) ? im(this) : [];
						...
						if (i) {
							return {
								signal: Cf(
									e,
									n,
									sa({ aggregate: "distinct", field: i }, { expr: "datum" }),
								),
							};
						}
						return vi(Vn(t)), null;
		...
		scaleName(e, t) {
			return t
				? this.getName(e)
				: (Ze(e) && Ht(e) && this.component.scales[e]) ||
		...
		correctDataNames = (e) => (
			e.from?.data && (e.from.data = this.lookupDataSource(e.from.data)),
			e.from?.facet?.data &&
	...
	class Nm extends $c {
		clone() {
			return new Nm(null, l(this.transform));
		}
		constructor(e, t) {
	...
	class _m extends $c {
		clone() {
			return new _m(this.parent, l(this.transform));
		}
		constructor(e, t) {
			super(e), (this.transform = t), (this.transform = l(t));
	...
	class Tm extends $c {
		clone() {
			return new Tm(null, l(this.fields), this.geojson, this.signal);
		}
		static parseAll(e, t) {
			...
			for (const i of [
				...
				(r[0] || r[1]) && (e = new Tm(e, r, null, t.getName("geojson_" + n++)));
			}
			if (t.channelHasField(ye)) {
				const i = t.typedFieldDef(ye);
				i.type === or &&
					(e = new Tm(e, null, i.field, t.getName("geojson_" + n++)));
			}
			return e;
		}
		constructor(e, t, n, i) {
		...
		assemble() {
			const {
				...
				s = {
					...
					key: t,
					...(n
						? { keyvals: ((l = n), Q(l, "stop") ? this.processSequence(n) : n) }
						: {}),
					method: "value",
					...(r ? { groupby: r } : {}),
	...
	class Rm extends $c {
		clone() {
			return new Rm(null, l(this.transform), this.secondary);
		}
		constructor(e, t, n) {
		...
		static make(e, t, n, i) {
			...
			if (((e) => Q(e, "data"))(o)) {
				let e = Zm(o.data, r);
				e || ((e = new yd(o.data)), r.push(e));
				const n = t.getName(`lookup_${i}`);
				(a = new wc(e, n, mc.Lookup, t.component.data.outputNodeRefCounts)),
					(t.component.data.outputNodes[n] = a);
			} else if (((e) => Q(e, "param"))(o)) {
				const e = o.param;
				let i;
				n = { as: e, ...n };
				try {
	...
	class Lm extends $c {
		clone() {
			return new Lm(null, l(this.transform));
		}
		constructor(e, t) {
			super(e), (this.transform = t), (this.transform = l(t));
			const n = this.transform.as ?? [void 0, void 0];
	...
	class qm extends $c {
		clone() {
			return new qm(null, l(this.transform));
		}
		constructor(e, t) {
			super(e), (this.transform = t), (this.transform = l(t));
			const n = this.transform.as ?? [void 0, void 0];
	...
	class Um extends $c {
		clone() {
			return new Um(null, l(this.transform));
		}
		constructor(e, t) {
			super(e), (this.transform = t);
		}
	...
	class Wm extends $c {
		clone() {
			return new Wm(null, l(this.transform));
		}
		constructor(e, t) {
			super(e), (this.transform = t);
		}
	...
	function Im(e) {
		...
		return function n(i, r) {
			if (i instanceof yd && !i.isGenerator && !ac(i.data)) {
				e.push(r);
				r = { name: null, source: r.name, transform: [] };
			}
			if (
				(i instanceof md &&
					(i.parent instanceof yd && !r.source
	...
	function Bm(e) {
		return "top" === e || "left" === e || vn(e) ? "header" : "footer";
	}
	function Vm(e, n) {
		...
		if (e.channelHasField(n)) {
			...
			const u = df("labelOrient", s.header, r, n),
	...
	function Gm(e, t) {
		...
		if (n.component.axes[t]) {
			...
			if (((r.axis[t] = Af(r, t)), "shared" === r.axis[t])) {
				const r = "x" === t ? "column" : "row",
					o = i[r];
				for (const i of n.component.axes[t]) {
					const t = Bm(i.get("orient"));
					o[t] ??= [Hm(e, r, !1)];
					const n = Ku(i, "main", e.config, { header: !0 });
	...
	function Qm(e, t) {
		...
		{
			const e = Ms(i.view, t);
			return _s(e) ? e.step : e;
		}
	}
	function Jm(e, t, n) {
		return sa(t, { suffix: `by_${sa(e)}`, ...n });
	}
	class Km extends Cm {
		constructor(e, t, n, i) {
			super(e, "facet", t, n, i, e.resolve),
				(this.child = Dp(e.spec, this, this.getName("child"), void 0, i)),
				(this.children = [this.child]),
				(this.facet = this.initFacet(e.facet));
		}
		initFacet(e) {
			if (!jo(e)) return { facet: this.initFacetFieldDef(e, "facet") };
			const t = D(e),
				n = {};
			for (const i of t) {
				if (![J, K].includes(i)) {
		...
		initFacetFieldDef(e, t) {
			...
			return (
				n.header
					? (n.header = gn(n.header))
					: null === n.header && (n.header = null),
				n
			);
		}
		channelHasField(e) {
			return Q(this.facet, e);
		}
		fieldDef(e) {
			return this.facet[e];
		}
		parseData() {
			(this.component.data = ep(this)), this.child.parseData();
		}
		parseLayoutSize() {
			Ym(this);
		}
			...
			for (const t of We)
				for (const n of gf) {
					const i = this.component.layoutHeaders[t],
						...
						{ facetFieldDef: o } = i;
					if (o) {
						const n = df("titleOrient", o.header, this.config, t);
		...
		columnDistinctSignal() {
			if (!(this.parent && this.parent instanceof Km)) {
				return { signal: `length(data('${this.getName("column_domain")}'))` };
			}
		}
		assembleGroupStyle() {}
		assembleGroup(e) {
			return this.parent && this.parent instanceof Km
				? {
						...(this.channelHasField("column")
							? {
									encode: {
										update: {
											columns: {
												field: sa(this.facet.column, { prefix: "distinct" }),
											},
										},
									},
								}
		...
		getCardinalityAggregateForChild() {
			const e = [],
				t = [],
				n = [];
			if (this.child instanceof Km) {
				if (this.child.channelHasField("column")) {
					const i = sa(this.child.facet.column);
		...
		assembleFacet() {
			...
			for (const e of We) {
				...
				if (n) {
					...
					if ((cn(c) && l.push(sa(n, { binSuffix: "end" })), Ao(u))) {
						const { field: e, op: t = No } = u,
							l = Jm(n, u);
						i && r
		...
		facetSortOrder(e) {
			...
			if (i) {
				const { sort: e } = i;
				return [(Ao(e) ? e.order : !t.isArray(e) && e) || "ascending"];
			}
			return [];
		}
		assembleLabelTitle() {
			const { facet: e, config: t } = this;
			if (e.facet) return $f(e.facet, "facet", t);
			const n = { row: ["top", "bottom"], column: ["left", "right"] };
			for (const i of pf)
				if (e[i]) {
					const r = df("labelOrient", e[i]?.header, t, i);
					if (n[i].includes(r)) return $f(e[i], i, t);
				}
		}
		assembleMarks() {
			const { child: e } = this,
			...
			return [
				{
					...
					sort: {
						field: We.flatMap((e) => this.facetSortFields(e)),
						order: We.flatMap((e) => this.facetSortOrder(e)),
					},
					...(t.length > 0 ? { data: t } : {}),
					...(n ? { encode: { update: n } } : {}),
					...e.assembleGroup(vc(this, [])),
				},
			];
		}
		getMapping() {
	...
	function Zm(e, t) {
		for (const n of t) {
			...
			if ((!i && !a) || i === a)
				...
				} else if (lc(e) && e.name === n.dataName) return n;
		}
		return null;
	}
	function ep(e) {
		let t = ((e, t) => {
			if (e.data || !e.parent) {
				if (null === e.data) {
					const e = new yd({ values: [] });
					return t.push(e), e;
				}
				const n = Zm(e.data, t);
				if (n)
					return (
						cc(e.data) || (n.data.format = y({}, e.data.format, n.data.format)),
						!n.hasName() && e.data.name && (n.dataName = e.data.name),
						n
					);
				{
					const n = new yd(e.data);
					return t.push(n), n;
				}
			}
		...
		const { outputNodes: n, outputNodeRefCounts: i } = e.component.data,
			r = e.data,
			o =
				!(r && (cc(r) || ac(r) || sc(r))) && e.parent
					? e.parent.component.data.ancestorParse.clone()
					: new oc();
		cc(r)
			? (uc(r)
					? (t = new hd(t, r.sequence))
					: dc(r) && (t = new gd(t, r.graticule)),
				(o.parseNothing = !0))
			: null === r?.format?.parse && (o.parseNothing = !0),
			(t = md.makeExplicit(t, e, o) ?? t),
			(t = new pd(t));
		const a = e.parent && Om(e.parent);
		(Sm(e) || Dm(e)) && a && (t = ad.makeFromEncoding(t, e) ?? t),
			e.transforms.length > 0 &&
				(t = ((e, t, n) => {
					let i = 0;
					for (const r of t.transforms) {
						let o, a;
						if (_l(r)) (a = e = new cf(e, r)), (o = "derived");
						else if ($l(r)) {
							const i = fd(r);
							(a = e = md.makeWithAncestors(e, {}, i, n) ?? e),
								(e = new Gu(e, t, r.filter));
						} else if (Al(r))
							(a = e = ad.makeFromTransform(e, r, t)), (o = "number");
						else if (jl(r))
							(o = "date"),
								void 0 === n.getWithExplicit(r.field).value &&
									((e = new md(e, { [r.field]: o })), n.set(r.field, o, !1)),
								(a = e = Dc.makeFromTransform(e, r));
						else if (El(r))
							(a = e = ld.makeFromTransform(e, r)),
								(o = "number"),
								Wu(t) && (e = new pd(e));
						else if (wl(r)) (a = e = Rm.make(e, t, r, i++)), (o = "derived");
						else if (Cl(r)) (a = e = new Md(e, r)), (o = "number");
						else if (Nl(r)) (a = e = new Ad(e, r)), (o = "number");
						else if (Ml(r))
							(a = e = Ed.makeFromTransform(e, r)), (o = "derived");
						else if (Rl(r)) (a = e = new Am(e, r)), (o = "derived");
						else if (Ll(r)) (a = e = new Pm(e, r)), (o = "derived");
						else if (Pl(r)) (a = e = new _m(e, r)), (o = "derived");
						else if (kl(r)) (a = e = new Um(e, r)), (o = "derived");
						else if (zl(r)) e = new Wm(e, r);
						else if (Tl(r))
							(a = e = Em.makeFromTransform(e, r)), (o = "derived");
						else if (Sl(r)) (a = e = new Nm(e, r)), (o = "derived");
						else if (Dl(r)) (a = e = new Lm(e, r)), (o = "derived");
						else if (Fl(r)) (a = e = new qm(e, r)), (o = "derived");
						else {
							if (!Ol(r)) {
								vi(`Ignoring an invalid transform: ${X(r)}.`);
								continue;
							}
							(a = e = new Mm(e, r)), (o = "derived");
						}
						if (a && void 0 !== o)
		...
		const s = ((e) => {
			...
			l = dd(e);
		(t = md.makeWithAncestors(t, {}, { ...s, ...l }, o) ?? t),
			Sm(e) && ((t = Tm.parseAll(t, e)), (t = jm.parseAll(t, e))),
			(Sm(e) || Dm(e)) &&
				(a || (t = ad.makeFromEncoding(t, e) ?? t),
				(t = Dc.makeFromEncoding(t, e) ?? t),
				(t = cf.parseAllForSortIndex(t, e)));
		const c = (t = tp(mc.Raw, e, t));
		if (Sm(e)) {
			const n = ld.makeFromEncoding(t, e);
			n && ((t = n), Wu(e) && (t = new pd(t))),
				(t = Em.makeFromEncoding(t, e) ?? t),
				(t = Ed.makeFromEncoding(t, e) ?? t);
		}
		let u, f;
		if (Sm(e)) {
			const { markDef: n, mark: i, config: r } = e,
				o = _n("invalid", n, r),
				{ marks: a, scales: s } = (f = pc({ invalid: o, isPath: Gr(i) }));
			a !== s &&
				"include-invalid-values" === s &&
				(u = t = tp(mc.PreFilterInvalid, e, t)),
				"exclude-invalid-values" === a && (t = Td.make(t, e, f) ?? t);
		}
		const d = (t = tp(mc.Main, e, t));
		let m;
		if (Sm(e) && f) {
			const { marks: n, scales: i } = f;
			"include-invalid-values" === n &&
				"exclude-invalid-values" === i &&
				((t = Td.make(t, e, f) ?? t), (m = t = tp(mc.PostFilterInvalid, e, t)));
		}
		Sm(e) &&
			((e, t) => {
			...
			(t =
				((e, t) => {
					...
					if (n && i) {
						...
						for (const r of [n, i])
							if (Ao(r.sort)) {
								const { field: n, op: i = No } = r.sort;
								e = t = new Ad(e, {
									joinaggregate: [
										{ op: i, field: n, as: Jm(r, r.sort, { forAs: !0 }) },
									],
									groupby: [sa(r)],
								});
							}
	...
	class np extends zm {
		constructor(e, t, n, i) {
			super(e, "concat", t, n, i, e.resolve),
				...
				(this.children = this.getChildren(e).map((e, t) =>
					Dp(e, this, this.getName(`concat_${t}`), void 0, i),
				));
		}
		parseData() {
			this.component.data = ep(this);
		...
		getChildren(e) {
			return Cs(e) ? e.vconcat : Ns(e) ? e.hconcat : e.concat;
		}
		parseLayoutSize() {
			!((e) => {
				Ym(e);
	...
	class op extends Zl {
		...
		clone() {
			return new op(l(this.explicit), l(this.implicit), this.mainExtracted);
		}
		hasAxisPart(e) {
			return (
				"axis" === e ||
		...
		hasOrientSignalRef() {
			return vn(this.explicit.orient);
		}
	}
	const ap = { bottom: "top", top: "bottom", left: "right", right: "left" };
	function sp(e, t) {
	...
	function cp(e, t, n, i, r) {
		...
		switch (((n = n || {}), t)) {
			case "titleAngle":
			case "labelAngle":
				return e === (vn(n.labelAngle) ? n.labelAngle : V(n.labelAngle));
			case "values":
				return !!n.values;
			case "encode":
				return !!n.encoding || !!n.labelAngle;
			case "title":
				if (e === lf(i, r)) return !0;
		}
		return e === n[t];
	}
	const up = new Set([
	...
	function fp(e, t) {
							...
							: "point" === t
								...
								: mr(t)
									...
									: "time" === t || "utc" === t
										...
										: [],
					o = "x" === e ? "axisX" : "axisY",
					a = vn(n) ? "axisOrient" : `axis${_(n)}`,
					s = [...r, ...r.map((e) => o + e.substr(4))],
					l = ["axis", a, o];
				return {
					vlOnlyAxisConfig: ef(s, i, e, n),
					vgAxisConfig: ef(l, i, e, n),
					axisConfigStyle: tf([...l, ...s], i),
				};
			})(e, l, s, t.config),
			u = void 0 !== n ? !n : nf("disable", a.style, n?.style, c).configValue;
		if ((i.set("disable", u, void 0 !== n), u)) return i;
		n = n || {};
		const f = ((e, t, n, i, r) => {
				const o = t?.labelAngle;
				if (void 0 !== o) return vn(o) ? o : V(o);
				{
					const { configValue: o } = nf("labelAngle", i, t?.style, r);
					return void 0 !== o
						? V(o)
						: n !== ee || !p([rr, nr], e.type) || (Go(e) && e.timeUnit)
							? void 0
							: 270;
				}
			})(r, n, e, a.style, c),
			d = Do(n.formatType, r, l),
			m = So(r, r.type, n.format, n.formatType, a, !0),
			g = {
				fieldOrDatumDef: r,
				axis: n,
				channel: e,
		...
		for (const r of rp) {
			const o = r in rf ? rf[r](g) : Aa(r) ? n[r] : void 0,
				s = void 0 !== o,
				l = cp(o, r, n, t, e);
			if (s && l) i.set(r, o, l);
			else {
				const { configValue: e, configFrom: t } =
						Aa(r) && "values" !== r ? nf(r, a.style, n.style, c) : {},
					u = void 0 !== e;
				s && !u
					? i.set(r, o, l)
					: ("vgAxisConfig" !== t || (up.has(r) && u) || za(e) || vn(e)) &&
						i.set(r, e, !1);
			}
		}
		const h = n.encoding ?? {},
	...
	function dp(e, t) {
		...
		return {
			...
			...nu("x", e, { defaultPos: "mid" }),
			...nu("y", e, { defaultPos: "mid" }),
			...Kc("size", e),
			...Kc("angle", e),
			...mp(e, n, t),
		};
	...
	function mp(e, t, n) {
		return n ? { shape: { value: n } } : Kc("shape", e);
	}
	const pp = {
		vgMark: "rule",
		encodeEntry: (e) => {
			...
			return e.encoding.x ||
				...
				? {
						...
						...Kc("size", e, { vgChannel: "strokeWidth" }),
					}
				: {};
		},
	};
	...
	const yp = {
		...
		vp = {
			...
			circle: { vgMark: "symbol", encodeEntry: (e) => dp(e, "circle") },
			geoshape: {
				vgMark: "shape",
				encodeEntry: (e) => ({
					...hu(e, {
			...
			point: { vgMark: "symbol", encodeEntry: (e) => dp(e) },
			rect: {
				vgMark: "rect",
				encodeEntry: (e) => ({
					...hu(e, {
			...
			rule: pp,
			square: { vgMark: "symbol", encodeEntry: (e) => dp(e, "square") },
			text: {
				vgMark: "text",
				encodeEntry: (e) => {
					...
					return {
						...
						...nu("y", e, { defaultPos: "mid" }),
						...Bc(e),
						...Kc("size", e, { vgChannel: "fontSize" }),
						...Kc("angle", e),
						...xu("align", gp(e.markDef, n, t)),
						...xu("baseline", hp(e.markDef, n, t)),
						...nu("radius", e, { defaultPos: null }),
						...nu("theta", e, { defaultPos: null }),
					};
				},
			},
			tick: yp,
	...
	function bp(e) {
		if (p([Mr, Tr, Ir], e.mark)) {
			const t = Va(e.mark, e.encoding);
			if (t.length > 0)
				return ((e, t) => [
					{
						...
						from: {
							facet: {
								name: xp + e.requestDataName(mc.Main),
						...
						marks: wp(e, { fromPrefix: xp }),
					},
				])(e, t);
		} else if (e.mark === jr) {
			const t = kn.some((t) => _n(t, e.markDef, e.config));
			if (e.stack && !e.fieldDef("size") && t)
				return ((e) => {
					const [t] = wp(e, { fromPrefix: $p }),
					...
					"x" === e.stack.fieldChannel
						? ((o = {
								...u(t.encode.update, ["y", "yc", "y2", "height", ...kn]),
					...
					for (const n of kn) {
						const i = An(n, e.markDef, e.config);
						t.encode.update[n]
					...
					if (e.stack.groupbyChannels?.length > 0)
						for (const t of e.stack.groupbyChannels) {
							const n = e.fieldDef(t),
								i = sa(n);
							i && s.push(i),
								(n?.bin || n?.timeUnit) && s.push(sa(n, { binSuffix: "end" }));
						}
					(o = [
						"stroke",
						"strokeWidth",
						...
						{
							const t = An(i, e.markDef, e.config);
							return void 0 !== t ? { ...n, [i]: On(t) } : n;
						}
					}, o)),
						o.stroke &&
					...
					return [
						{
							...
							from: {
								facet: {
									data: e.requestDataName(mc.Main),
									name: $p + e.requestDataName(mc.Main),
									groupby: s,
									aggregate: {
										fields: [
											i({ suffix: "start" }),
	...
	const xp = "faceted_path_";
	const $p = "stack_group_";
	function wp(e) {
		const n =
			arguments.length > 1 && void 0 !== arguments[1]
				? arguments[1]
		...
		const { mark: i, markDef: r, encoding: o, config: a } = e,
			...
			u = ((e) => {
				...
				if (
					!(
						(!t.isArray(s) && ta(s) && m(s.value)) ||
						(!s && m(_n("order", o, a)))
					)
				) {
					if ((t.isArray(s) || Go(s)) && !i) return En(s, { expr: "datum" });
					if (Gr(r)) {
						const e = "horizontal" === o.orient ? "y" : "x";
						if (Go(n[e])) return { field: e };
					}
				}
			})(e),
			f = ((e) => {
			...
			d = _n("aria", r, a),
			p = vp[i].postEncodingTransform ? vp[i].postEncodingTransform(e) : null;
		return [
			{
				...
				...(f || {}),
				...(!1 === d ? { aria: d } : {}),
				from: { data: n.fromPrefix + e.requestDataName(mc.Main) },
				encode: { update: vp[i].encodeEntry(e) },
				...(p ? { transform: p } : {}),
			},
		];
	}
	class kp extends Cm {
		...
		constructor(e, n, i) {
			...
			super(e, "unit", n, i, o, void 0, As(e) ? e.view : void 0);
			const a = Qr(e.mark) ? { ...e.mark } : { type: e.mark },
				s = a.type;
			void 0 === a.filled &&
				(a.filled = ((e, t, n) => {
					const { graticule: i } = n;
					if (i) return !1;
					const r = An("filled", e, t),
						o = e.type;
					return q(r, o !== Rr && o !== Mr && o !== qr);
				})(a, o, { graticule: e.data && dc(e.data) }));
			const l = (this.encoding = ((e, n, i, r) => {
				...
				for (let a of ct) {
					...
					if (At(a)) {
						const e = lt(a),
							t = o[e];
						if (Go(t) && Zi(t.type) && Go(s) && !t.timeUnit) {
							vi(Zn(e));
							continue;
						}
					}
					if (
						...
						if (a === pe && (i ? "fill" in e : "stroke" in e))
							vi(ti("encoding", { fill: "fill" in e, stroke: "stroke" in e }));
						else if (
							a === Oe ||
							(a === Fe && !t.isArray(s) && !ta(s)) ||
							(a === Ce && t.isArray(s))
						) {
							if (s) {
								if (a === Fe) {
								...
								o[a] = t
									.array(s)
									.reduce(
										(e, t) => (Go(t) ? e.push(xa(t, a)) : vi(ni(t, a)), e),
										[],
									);
							}
						} else {
							if (a === Ce && null === s) o[a] = null;
							else if (!(Go(s) || Xo(s) || ta(s) || Bo(s) || vn(s))) {
								vi(ni(s, a));
								continue;
							}
							o[a] = va(s, a, r);
			...
			(this.markDef = ol(a, l, o)),
				(this.size = ((e) => {
					const { encoding: t, size: n } = e;
					for (const e of Ot) {
						const i = ot(e);
						_s(n[i]) && Qo(t[e]) && (delete n[i], vi(fi(i)));
					}
					return n;
				})({
					encoding: l,
				...
				(this.selection = (e.params ?? []).filter((e) => Fs(e)));
		}
		get hasProjection() {
			const { encoding: e } = this,
				t = this.mark === Hr,
				n = e && Re.some((t) => Zo(e[t]));
			return t || n;
		}
		scaleDomain(e) {
		...
		initScale(e) {
			const { domain: n, range: i } = e,
				r = gn(e);
			return (
				t.isArray(n) && (r.domain = n.map(Dn)),
				t.isArray(i) && (r.range = i.map(Dn)),
				r
			);
		}
		initAxes(e) {
			return Ot.reduce((t, n) => {
				const i = e[n];
				if (Zo(i) || (n === ee && Zo(e.x2)) || (n === te && Zo(e.y2))) {
					const e = Zo(i) ? i.axis : void 0;
		...
		parseLayoutSize() {
			!((e) => {
				...
				for (const i of Ot) {
					...
					if (t[r]) {
						const e = t[r];
						n.layoutSize.set(r, _s(e) ? "step" : e, !0);
					} else {
						const t = Qm(e, r);
			...
			this.component.selection = ((e, n) => {
				...
				for (const o of n) {
					...
					const f = (i[n] = {
						...
						d = l(o);
					for (const t of qu) t.defined(f) && t.parse && t.parse(e, f, d);
				}
				return i;
			})(this, this.selection);
		}
		parseMarkGroup() {
			this.component.mark = bp(this);
		}
		parseAxesAndHeaders() {
			var e;
			this.component.axes =
				((e = this),
				Ot.reduce(
					(t, n) => (e.component.scales[n] && (t[n] = [fp(n, e)]), t),
					{},
				));
		}
		assembleSelectionTopLevelSignals(e) {
		...
		assembleSelectionData(e) {
			return ((e, t) => {
				...
				for (const t of F(e.component.selection ?? {})) {
					const e = { name: t.name + Eu };
					if (
						(t.project.hasSelectionId &&
							(e.transform = [{ type: "collect", sort: { field: ws } }]),
						t.init)
					) {
						const n = t.project.items.map(gc);
						e.values = t.project.hasSelectionId
							? t.init.map((e) => ({ unit: i, [ws]: hc(e, !1)[0] }))
							: t.init.map((e) => ({ unit: i, fields: n, values: hc(e, !1) }));
					}
					n.filter((e) => e.name === t.name + Eu).length || n.push(e);
				}
				return n;
			})(this, e);
		}
		...
		assembleMarks() {
			...
			return (
				(this.parent && Om(this.parent)) || (e = bc(this, e)),
		...
		channelHasField(e) {
			return Ma(this.encoding, e);
		}
		fieldDef(e) {
			return ha(this.encoding[e]);
		}
		typedFieldDef(e) {
	...
	class Sp extends zm {
		constructor(e, t, n, i, r) {
			...
			this.children = e.layer.map((e, t) => {
				if (Js(e)) return new Sp(e, this, this.getName(`layer_${t}`), o, r);
				if (ja(e)) return new kp(e, this, this.getName(`layer_${t}`), o, r);
				throw new Error(qn(e));
			});
		}
		parseData() {
		...
		parseLayoutSize() {
			var e;
			Ym((e = this)), Xm(e, "width"), Xm(e, "height");
		}
		parseSelections() {
			this.component.selection = {};
			for (const e of this.children) {
			...
			!((e) => {
				...
				for (const i of e.children) {
					...
					for (const r of D(i.component.axes))
						(n.axis[r] = Af(e.component.resolve, r)),
							"shared" === n.axis[r] &&
								((t[r] = sp(t[r], i.component.axes[r])),
		...
		assembleMarks() {
			return ((e, t) => {
				for (const n of e.children) Sm(n) && (t = bc(n, t));
				return t;
			})(
				this,
	...
	function Dp(e, t, n, i, r) {
		if (Mo(e)) return new Km(e, t, n, r);
		if (Js(e)) return new Sp(e, t, n, i, r);
		if (ja(e)) return new kp(e, t, n, i, r);
		if (((e) => Cs(e) || Ns(e) || zs(e))(e)) return new np(e, t, n, r);
		throw new Error(qn(e));
	}
	const Fp = n;
	(e.accessPathDepth = L),
		...
		(e.compile = function (e) {
			const n =
				arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
			var i;
			n.logger && ((i = n.logger), (yi = i)), n.fieldTitle && fa(n.fieldTitle);
			try {
				const i = Vs(t.mergeConfig(n.config, e.config)),
					r = Hl(e, i),
					o = Dp(r, null, "", void 0, i);
				o.parse(),
					((e, t) => {
						Wd(e.sources);
						let n = 0,
							i = 0;
						for (let i = 0; i < Ud && Bd(e, t, !0); i++) n++;
						e.sources.map(Rd);
						for (let n = 0; n < Ud && Bd(e, t, !1); n++) i++;
						Wd(e.sources),
							Math.max(n, i) === Ud &&
								vi(`Maximum optimization runs(${Ud}) reached.`);
					})(o.component.data, o);
				const a = (function (e, t) {
					...
					const r = e.config ? Xs(e.config) : void 0,
						o = [].concat(
				...
				n.logger && (yi = hi), n.fieldTitle && fa(ca);
			}
		}),
		(e.contains = p),
		(e.deepEqual = Y),
