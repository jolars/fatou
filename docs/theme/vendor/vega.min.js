!((t, e) => {
	...
	function w(t, e) {
		...
		return {
			...
			error() {
				return r >= v && n(e || "error", "ERROR", arguments), this;
			},
			warn() {
				return r >= _ && n(e || "warn", "WARN", arguments), this;
			},
			info() {
				return r >= x && n(e || "log", "INFO", arguments), this;
			},
			debug() {
				return r >= b && n(e || "log", "DEBUG", arguments), this;
			},
		};
	}
	var k = Array.isArray;
	...
	const M = (t) => "__proto__" !== t;
	function E() {
		for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++)
			e[n] = arguments[n];
		return e.reduce((t, e) => {
			for (const n in e)
				if ("signals" === n) t.signals = C(t.signals, e.signals);
				else {
	...
	function D(t, e, n, r) {
		...
		let i, o;
		if (A(n) && !k(n))
			for (i in ((o = A(t[e]) ? t[e] : (t[e] = {})), n))
				r && (!0 === r || r[i]) ? D(o, i, n[i]) : M(i) && (o[i] = n[i]);
		else t[e] = n;
	}
	function C(t, e) {
		if (null == t) return e;
	...
	const $ = (t) => (e) => t * Math.exp(e),
		T = (t) => (e) => Math.log(t * e),
		B = (t) => (e) => Math.sign(e) * Math.log1p(Math.abs(e / t)),
	...
	function L(t, e, n) {
		return O(t, e, N(n), N(1 / n));
	}
	function q(t, e, n) {
		return O(t, e, B(n), z(n));
	}
	...
	function I(t, e, n) {
		...
		return P(t, e, n, T(r), $(r));
	}
	function W(t, e, n, r) {
		return P(t, e, n, N(r), N(1 / r));
	}
	function H(t, e, n, r) {
		return P(t, e, n, B(r), z(r));
	}
	function Y(t) {
					...
					: ((e = e instanceof Date ? +e : e),
						(t = t instanceof Date ? +t : t) !== t && e == e
							...
							: e != e && t == t
								? 1
								: 0),
		tt = (t, e) => (1 === t.length ? et(t[0], e[0]) : nt(t, e, t.length)),
		et = (t, e) => (n, r) => K(t(n), t(r)) * e,
		nt = (t, e, n) => (
			e.push(0),
			(r, i) => {
				let o,
	...
	function bt(t, n, r) {
		t && (t = n ? V(t).map((t) => t.replace(/\\(.)/g, "$1")) : V(t));
		const o = t && t.length,
			a = (r && r.get) || i,
			s = (t) => a(n ? [t] : u(t));
		let l;
	...
	function Pt(t) {
		return new Function(
			"d",
			"return {" +
				t.map((t, e) => JSON.stringify(t) + ": d[" + e + '] || ""').join(",") +
				"}",
		);
	}
	function jt(t) {
	...
	function Ht(t) {
		...
		function r(t, e) {
			...
			function c() {
				...
				if (t.charCodeAt(i) === Ut) {
					for (
						;
						(a++ < o && t.charCodeAt(a) !== Ut) || t.charCodeAt(++a) === Ut;
					);
					return (
						(e = a) >= o
							? (u = !0)
							: (r = t.charCodeAt(a++)) === Lt
								? (l = !0)
								: r === qt && ((l = !0), t.charCodeAt(a) === Lt && ++a),
						t.slice(i + 1, e - 1).replace(/""/g, '"')
					);
				}
				for (; a < o; ) {
					if ((r = t.charCodeAt((e = a++))) === Lt) l = !0;
					else if (r === qt) (l = !0), t.charCodeAt(a) === Lt && ++a;
			...
			for (
				t.charCodeAt(o - 1) === Lt && --o, t.charCodeAt(o - 1) === qt && --o;
				(r = c()) !== Rt;
			) {
		...
		function i(e, n) {
			return e.map((e) => n.map((t) => a(e[t])).join(t));
		}
		function o(e) {
		...
		return {
			...
			formatBody: (t, e) => (null == e && (e = jt(t)), i(t, e).join("\n")),
		...
		return (
			...
			"GeometryCollection" === e.type
				? {
						...
						features: e.geometries.map((e) => Vt(t, e)),
					}
				: Vt(t, e)
		);
	}
	...
	function De(t, e) {
		const n =
			arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : re;
	...
	var qe = {
		...
		s: (t, e) => {
			...
			var r = n[0],
				i = n[1],
				o = i - (Ne = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
				a = r.length;
			return o === a
				? r
				: o > a
		...
		return {
			...
			formatPrefix: (t, e) => {
				var n = f((((t = Re(t)).type = "f"), t)),
					r = 3 * Math.max(-8, Math.min(8, Math.floor(ze(e) / 3))),
					i = 10 ** -r,
					o = Ye[8 + r / 3];
				return (t) => n(i * t) + o;
			},
	...
	function Xe(t, e) {
		return Math.max(
			0,
			3 * Math.max(-8, Math.min(8, Math.floor(ze(e) / 3))) - ze(Math.abs(t)),
		);
	}
	function Je(t, e) {
		return (
			(t = Math.abs(t)), (e = Math.abs(e) - t), Math.max(0, ze(e) - ze(t)) + 1
		);
	}
	!((t) => {
	...
	(On.every = (t) =>
		isFinite((t = Math.floor(t))) && t > 0
			...
			: null),
		On.range;
	const [Un, Ln] = Rn(On, zn, En, mn, dn, fn),
		[qn, Pn] = Rn(Nn, Bn, vn, pn, hn, cn),
		jn = "year",
		In = "quarter",
		Wn = "month",
		Hn = "week",
	...
	function Ri(t, e) {
		return ci(1 + pn.count(Nn(t), t), e, 3);
	}
	function Ui(t, e) {
	...
	function Wi(t, e) {
		return ci(vn.count(Nn(t) - 1, t), e, 2);
	}
	function Hi(t) {
		var e = t.getDay();
	...
	function Yi(t, e) {
		return (t = Hi(t)), ci(wn.count(Nn(t), t) + (4 === Nn(t).getDay()), e, 2);
	}
	function Gi(t) {
		return t.getDay();
	}
	function Vi(t, e) {
		return ci(_n.count(Nn(t) - 1, t), e, 2);
	}
	function Xi(t, e) {
	...
	function $o(t, e, n) {
		A((n = n || {})) || s(`Invalid time multi-format specifier: ${n}`);
		const r = e(Zn),
			i = e(Jn),
			o = e(Xn),
			a = e(Yn),
	...
	function No(t) {
		return arguments.length ? (Do = zo(t)) : Do;
	}
	!((t) => {
		(ei = ti(t)),
			(ni = ei.format),
	...
	function Uo(t, e) {
		...
		return (
			...
			n ? Oo(So(t), No(e)) : Oo(So(), No())
		);
	}
	const Lo = /^(data:|([A-Za-z]+:)?\/\/)/,
		qo =
	...
	function Go(t) {
		return t
			? async function (e, n) {
					const r = ot({}, this.options.http, n),
						i = n && n.response,
						o = await t(e, r);
					return o.ok
						? J(o[i])
	...
	function ia(t, e) {
		...
		return !A(t) ||
			((r = t),
			"function" == typeof Buffer && J(Buffer.isBuffer) && Buffer.isBuffer(r))
			? n(JSON.parse(t))
			: ((t, e) => {
					!k(t) && yt(t) && (t = [...t]);
	...
	function Ma() {
		...
		return {
			...
			modify(t, e, r) {
				const o = { field: e, value: rt(r) };
				return (
					J(t) ? ((o.filter = t), i.push(o)) : ((o.tuple = t), n.push(o)), this
				);
			},
			encode(t, e) {
				return (
	...
	Ba.prototype = {
		...
		between(t, e) {
			let n = !1;
			return (
				t.targets().add(za(null, null, () => (n = !0))),
				e.targets().add(za(null, null, () => (n = !1))),
				this.filter(() => n)
			);
		},
		detach() {
	...
	function Ia(t, e, n, r) {
		...
		for (const t of n)
			if (t.stamp === e) {
				...
				t.changed(this.ADD) && (o |= this.ADD),
					t.changed(this.REM) && (o |= this.REM),
					t.changed(this.MOD) && (o |= this.MOD);
			}
		this.changes = o;
	}
	function Wa(t) {
	...
	(La.prototype = {
		...
		NO_FIELDS: 64,
		fork(t) {
			return new La(this.dataflow).init(this, t);
		},
		clone() {
			const t = this.fork(7);
			return (
		...
		addAll() {
			...
			return (
				!t.source ||
					...
					((t = new La(this.dataflow).init(this)),
					(t.add = t.source),
					(t.rem = [])),
				t
			);
		...
		init(t, e) {
			return (
				...
				!t.fields || 64 & e || (this.fields = t.fields),
				1 & e
					? ((this.addF = t.addF), (this.add = t.add))
					: ((this.addF = null), (this.add = [])),
				2 & e
					? ((this.remF = t.remF), (this.rem = t.rem))
					: ((this.remF = null), (this.rem = [])),
				4 & e
					? ((this.modF = t.modF), (this.mod = t.mod))
					: ((this.modF = null), (this.mod = [])),
				32 & e
					? ((this.srcF = null), (this.source = null))
					: ((this.srcF = t.srcF),
						(this.source = t.source),
						t.cleans && (this.cleans = t.cleans)),
				this
			);
		},
		runAfter(t) {
		...
		modifies(t) {
			const e = this.fields || (this.fields = {});
			return k(t) ? t.forEach((t) => (e[t] = !0)) : (e[t] = !0), this;
		},
		modified(t, e) {
			const n = this.fields;
			return (
				!((!e && !this.mod.length) || !n) &&
				(arguments.length ? (k(t) ? t.some((t) => n[t]) : n[t]) : !!n)
			);
		},
		filter(t, e) {
			return (
				1 & t && (this.addF = ja(this.addF, e)),
				2 & t && (this.remF = ja(this.remF, e)),
				4 & t && (this.modF = ja(this.modF, e)),
				16 & t && (this.srcF = ja(this.srcF, e)),
				this
			);
		},
		materialize(t) {
			return (
				1 & (t = t || 7) &&
					this.addF &&
					((this.add = qa(this.add, this.addF)), (this.addF = null)),
				2 & t &&
					this.remF &&
					((this.rem = qa(this.rem, this.remF)), (this.remF = null)),
				4 & t &&
					this.modF &&
					((this.mod = qa(this.mod, this.modF)), (this.modF = null)),
				16 & t &&
					this.srcF &&
					((this.source = this.source.filter(this.srcF)), (this.srcF = null)),
				this
			);
		},
		visit(t, e) {
			const r = e;
			if (16 & t) return Nt(this.source, this.srcF, r), this;
			1 & t && Nt(this.add, this.addF, r),
				2 & t && Nt(this.rem, this.remF, r),
				4 & t && Nt(this.mod, this.modF, r);
			const i = this.source;
			if (8 & t && i) {
				const t = this.add.length + this.mod.length;
				t === i.length || Nt(i, t ? Pa(this, 5) : this.srcF, r);
			}
			return this;
		},
	}),
		dt(Ia, La, {
			fork(t) {
				const e = new La(this.dataflow).init(this, t & this.NO_FIELDS);
				return (
					void 0 !== t &&
			...
			modified(t) {
				const n = this.fields;
				return n && this.changes & this.MOD
					? k(t)
						? t.some((t) => n[t])
						: n[t]
					: 0;
			...
			visit(t, e) {
				const r = this.pulses,
					i = r.length;
				let o = 0;
				if (t & this.SOURCE) for (; o < i; ++o) r[o].visit(t, e);
				else for (; o < i; ++o) r[o].stamp === this.stamp && r[o].visit(t, e);
				return this;
			},
		});
	...
	(Va.prototype = {
		...
		pulse: function (t, e, n) {
			this.touch(t, n || Ha);
			const r = new La(this, this._clock + (this._pulse ? 0 : 1)),
		...
		preload: async function (t, e, n) {
			...
			i.requests += 1;
			const o = await this.request(e, n);
			return (
				this.pulse(
					t,
					this.changeset()
		...
		request: async function (t, e) {
			let r,
				i = 0;
			try {
				r = await this.loader().load(t, {
					context: "dataflow",
					response: la(e && e.type),
				});
				try {
					r = this.parse(r, e);
				} catch (e) {
					(i = -2), this.warn("Data ingestion failed", t, e);
				}
			} catch (e) {
				(i = -1), this.warn("Loading failed", t, e);
			}
		...
		evaluate: async function (t, e, n) {
			const i = [];
			if (this._pulse) return Wa(this);
			if (
				(this._pending && (await this._pending),
				e && (await da(this, e)),
				!this._touched.length)
			)
				return this.debug("Dataflow invoked, but nothing to do."), this;
			const o = ++this._clock;
			(this._pulse = new La(this, o, t)),
				this._touched.forEach((t) => this._enqueue(t, !0)),
				(this._touched = ha(c));
			let a,
				s,
				u,
			...
			try {
				for (; this._heap.size() > 0; )
					(a = this._heap.pop()),
						a.rank === a.qrank
							? ((s = a.run(this._getPulse(a, t))),
								s.then ? (s = await s) : s.async && (i.push(s.async), (s = Ua)),
								s !== Ua &&
									a._targets &&
									a._targets.forEach((t) => this._enqueue(t)),
								++l)
							: this._enqueue(a, !0);
			} catch (t) {
				this._heap.clear(), (u = t);
			}
			if (
				((this._input = {}),
				(this._pulse = null),
				this.debug(`Pulse ${o}: ${l} operators`),
				u && ((this._postrun = []), this.error(u)),
				this._postrun.length)
			) {
				const t = this._postrun.sort((t, e) => e.priority - t.priority);
				this._postrun = [];
				for (let e = 0; e < t.length; ++e) await da(this, t[e].callback);
			}
			return (
				n && (await da(this, n)),
				i.length &&
			...
			return n && k(n)
				...
				: this._input[t.id] ||
						((t, e) => {
							...
							(t = t.fork()), e && e !== Ua && (t.source = e.source);
							return t;
	...
	function rs(t, e) {
		const n = t.length,
			...
			i = ns(t, e),
			o = (i[2] - i[0]) / 1.34;
		return 1.06 * (Math.min(r, o) || r || Math.abs(i[0]) || 1) * n ** -0.2;
	}
	function is(t) {
		...
		if (t.step) o = t.step;
			...
			for (
				a = Math.ceil(Math.log(e) / r),
					s = t.minstep || 0,
					o = Math.max(s, n ** (Math.round(Math.log(d) / r) - a));
				Math.ceil(d / o) > e;
			)
				o *= n;
	...
	function Rs(t, e, n, r) {
		...
		let h, d, p, g, m;
		for (h = 0; h < f; ++h) {
			for (p = 0, g = 0; p < u; ++p) g += i[p] ** h * o[p];
			for (l.push(g), m = new Float64Array(f), d = 0; d < f; ++d) {
				for (p = 0, g = 0; p < u; ++p) g += i[p] ** (h + d);
				m[d] = g;
			}
			c.push(m);
		}
		...
		const y = ((t) => {
			...
			v = (t) => {
				...
				for (h = 3; h < f; ++h) e += y[h] * t ** h;
				return e;
			};
		return { coef: Us(f, y, -a, s), predict: v, rSquared: $s(t, e, n, s, v) };
	}
	function Us(t, e, n, r) {
		const i = Array(t);
		let o, a, s, u;
	...
	[...Js, "__count__"].forEach((t) => {
		Xs[t] = (
			(t, e) => (n, r) =>
				ot({ name: t, aggregate_param: r, out: n || t }, Vs, e)
		)(t, Xs[t]);
	});
	...
	(ou.reset = function () {
		...
		dt(au, Ja, {
			transform(t, e) {
				...
				return (
					(this.stamp = r.stamp),
					this.value && (i || e.modified(this._inputs, !0))
						? ((this._prev = this.value),
							(this.value = i ? this.init(t) : Object.create(null)),
							e.visit(e.SOURCE, (t) => this.add(t)))
						: ((this.value = this.value || this.init(t)),
							e.visit(e.REM, (t) => this.rem(t)),
							e.visit(e.ADD, (t) => this.add(t))),
					r.modifies(this._outputs),
					(this._drop = !1 !== t.drop),
					t.cross && this._dims.length > 1 && ((this._drop = !1), this.cross()),
					e.clean() && this._drop && r.clean(!0).runAfter(() => this.clean()),
					this.changes(r)
				);
			},
			cross() {
	...
	function fu(t) {
		return this.value && !t.modified() ? this.value : Q(t.fields, t.orders);
	}
	function hu(t) {
		Ja.call(this, null, t);
	}
			...
			transform(t, e) {
				...
				if (!this.value || e.changed() || t.modified()) {
					...
					const u = t.as || ["value", "density"],
						l = Is(a, t.extent || at(r.data()), i, o).map((t) => {
							const e = {};
	...
	(Ru.Definition = {
		...
		dt(Uu, au, {
			transform(t, e) {
				...
				let i;
				return (
					this.value && (r || e.modified(this._inputs, !0))
						? ((i = this.value = r ? this.init(t) : {}),
							e.visit(e.SOURCE, (t) => this.add(t)))
						: ((i = this.value = this.value || this.init(t)),
							e.visit(e.REM, (t) => this.rem(t)),
							e.visit(e.ADD, (t) => this.add(t))),
					this.changes(),
					e.visit(e.SOURCE, (t) => {
						ot(t, i[this.cellkey(t)].tuple);
					}),
			...
			transform(t, e) {
				...
				if (!this.value || e.changed() || t.modified()) {
					...
					"pdf" !== l && "cdf" !== l && s("Invalid density method: " + l),
						"shared" === t.resolve &&
							(h || (h = at(i, t.field)), (d = p = t.steps || p)),
						o.forEach((e) => {
							const n = gs(e, u)[l],
								r = t.counts ? e.length : 1;
							Is(n, h || at(e), d, p).forEach((t) => {
								const n = {};
			...
			transform(t, e) {
				...
				if (t.async) {
					const e = n
						...
						.then((t) => ((this._pending = V(t.data)), (t) => t.touch(this)));
					return { async: e };
				}
				return n.request(t.url, t.format).then((t) => Iu(this, e, V(t.data)));
			},
		}),
		(Wu.Definition = {
			type: "Lookup",
			...
			_floor(t, e) {
				const n = "utc" === t.timezone,
					{ units: r, step: i } = t.units
						...
						: Jr({
								extent: t.extent || at(e.materialize(e.SOURCE).source, t.field),
								maxbins: t.maxbins,
							}),
					o = er(r),
					a = this.value || {},
	...
	const ll = {
		...
		first_value: (t) => ({ next: (e) => t(e.data[e.i0]) }),
		last_value: (t) => ({ next: (e) => t(e.data[e.i1 - 1]) }),
		nth_value: (t, e) => (
	...
	function pf(t) {
		...
		if ((t instanceof Lc || (t = ef(t)), !t)) return new mf();
	...
	function Ff(t) {
		...
		if (t instanceof Rf) return Uf(t);
		...
		Uc(Lc, {
			...
			rgb() {
				...
				return new sf(
					...
					zf(-0.9787684 * e + 1.9161415 * t + 0.033454 * n),
					zf(0.0719453 * e - 0.2289914 * t + 1.4052427 * n),
					this.opacity,
				);
			},
		}),
	...
	var Eh = (function t(e, n, r) {
		function i(t, i) {
			...
			if (g < 1e-12)
				(a = Math.log(h / l) / e),
					(o = (t) => [s + t * d, u + t * p, l * Math.exp(e * t * a)]);
			else {
				var m = Math.sqrt(g),
				...
				(a = (x - _) / e),
					(o = (t) => {
						var r = t * a,
							...
							o =
								(l / (n * m)) *
								(i * ((t) => ((t = Math.exp(2 * t)) - 1) / (t + 1))(e * r + _) -
									((t) => ((t = Math.exp(t)) - 1 / t) / 2)(_));
	...
	var Rh = Object.freeze({
		__proto__: null,
		interpolate: mh,
		interpolateArray: (t, e) => (uh(e) ? sh : lh)(t, e),
		interpolateBasis: Jf,
		interpolateBasisClosed: Zf,
		interpolateCubehelix: zh,
		interpolateCubehelixLong: Nh,
		interpolateDate: ch,
		interpolateDiscrete: (t) => {
			var e = t.length;
			return (n) => t[Math.max(0, Math.min(e - 1, Math.floor(n * e)))];
		},
		interpolateHcl: $h,
	...
	function Hh() {
		...
		return (
			(f.invert = (n) => l(e((o || (o = r(s, a.map(t), fh)))(n)))),
			(f.domain = function (t) {
				return arguments.length ? ((a = Array.from(t, Uh)), c()) : a.slice();
			}),
			(f.range = function (t) {
				return arguments.length ? ((s = Array.from(t)), c()) : s.slice();
			}),
			(f.rangeRound = (t) => ((s = Array.from(t)), (u = yh), c())),
			(f.clamp = function (t) {
			...
			return (
				(r = ((t) =>
					t === Math.E
						...
						: (10 === t && Math.log10) ||
							(2 === t && Math.log2) ||
							((t = Math.log(t)), (e) => Math.log(e) / t))(o)),
				(i = ((t) => (10 === t ? td : t === Math.E ? Math.exp : (e) => t ** e))(
					o,
				)),
	...
	function cd() {
		var t = ld(Hh());
		return (
			(t.copy = () => Wh(t, cd()).exponent(t.exponent())),
	...
	function dd(t, e, n, r, i, o, a, s, u, l) {
		...
		return (
			...
			(c.copy = () => Wh(c, dd(t, e, n, r, i, o, a, s, u, l))),
			c
		);
	}
	function pd() {
	...
	function md() {
		var t = Vh(pd()(qh));
		return (t.copy = () => gd(t, md())), zc.apply(t, arguments);
	}
	function yd() {
		var t = ld(pd());
		return (
			(t.copy = () => gd(t, yd()).exponent(t.exponent())),
			zc.apply(t, arguments)
		);
	}
	function vd() {
		var t,
	...
	function _d() {
		var t = ld(vd());
		return (
			(t.copy = () => gd(t, _d()).exponent(t.exponent())),
			zc.apply(t, arguments)
		);
	}
	function xd(t) {
	...
	function Kd() {
		...
		return (
			...
			(t.rangeRound = (t) => ((o = [+t[0], +t[1]]), (a = !0), c())),
			(t.bandwidth = () => i),
			(t.step = () => r),
			(t.round = function (t) {
	...
	ap("identity", function t(e) {
		...
		return (
			...
			(r.domain = r.range =
				function (t) {
					return arguments.length ? ((e = Array.from(t, Uh)), r) : e.slice();
				}),
			(r.unknown = function (t) {
				return arguments.length ? ((n = t), r) : n;
			}),
			(r.copy = () => t(e).unknown(n)),
			(e = arguments.length ? Array.from(e, Uh) : [0, 1]),
			Vh(r)
		);
	}),
		ap(
			...
			function t() {
				var e = Yh();
				return (e.copy = () => Wh(e, t())), Bc.apply(e, arguments), Vh(e);
			},
			Vd,
		),
		ap(
		...
		ap(
			...
			function t() {
				var e = od(Hh());
				return (
					(e.copy = () => Wh(e, t()).constant(e.constant())),
		...
		ap(
			...
			function () {
				return Bc.apply(
					dd(qn, Pn, Nn, Bn, vn, pn, hn, cn, ln, ni).domain([
						new Date(2e3, 0, 1),
						new Date(2e3, 0, 2),
					]),
					arguments,
		...
		ap(
			...
			function () {
				return Bc.apply(
					dd(Un, Ln, On, zn, En, gn, dn, fn, ln, ii).domain([
						Date.UTC(2e3, 0, 1),
						Date.UTC(2e3, 0, 2),
					]),
					arguments,
		...
		ap(
			...
			function t() {
				...
				return (
					(e.copy = () => gd(e, t()).base(e.base())), zc.apply(e, arguments)
				);
			},
			[Vd, Zd, Bd],
		),
		...
		ap(
			...
			function t() {
				var e = od(pd());
				return (
					(e.copy = () => gd(e, t()).constant(e.constant())),
					zc.apply(e, arguments)
				);
			},
			[Vd, Zd],
		),
		ap(
			...
			function t() {
				var e = Vh(vd()(qh));
				return (e.copy = () => gd(e, t())), zc.apply(e, arguments);
			},
			[Vd, Zd],
		),
		ap(
		...
		ap(
			...
			function t() {
				...
				return (
					...
					(a.quantiles = () => i.slice()),
					(a.copy = () => t().domain(n).range(r).unknown(e)),
		...
		ap(
			...
			function t() {
				...
				return (
					...
					(s.thresholds = () => o.slice()),
					(s.copy = () => t().domain([n, r]).range(a).unknown(e)),
		...
		ap(
			...
			function t() {
				...
				return (
					...
					(o.copy = () => t().domain(n).range(r).unknown(e)),
		...
		ap(
			...
			function t() {
				...
				return (
					...
					(r.tickFormat = (t, n) => Gh(e[0], F(e), null == t ? 10 : t, n)),
					(r.copy = () => t().domain(r.domain()).range(r.range())),
					r
				);
			},
			[Xd, Jd],
		...
		ap(Wd, Oc, Xd),
		ap(Yd, Kd, Xd),
		ap(Hd, () => tp(Kd().paddingInner(1)), Xd);
	const gp = ["clamp", "base", "constant", "exponent"];
	function mp(t, e) {
		const n = e[0],
			r = F(e) - n;
		return (e) => t(n + e * r);
	...
	function _p(t, e, n) {
		...
		return r && Number.isFinite(r)
			? ((i = (o = t.type).indexOf("-")),
				(o = i < 0 ? o : o.slice(i + 1)),
				(a = ap(o)().domain([e, n]).range([0, 1])),
				gp.forEach((e) => (t[e] ? a[e](t[e]()) : 0)),
				a)
			: rt(0.5);
	}
	function xp(t, e) {
	...
	function wp(t, e) {
		for (const n in t) Ap(n, e(t[n]));
	}
	const kp = {};
	function Ap(t, e) {
		return (
			(t = t && t.toLowerCase()),
			arguments.length > 1 ? ((kp[t] = e), this) : kp[t]
		);
	}
	wp(
		{
	...
	const Mp = "symbol",
		Ep = "discrete",
		Dp = (t) => (k(t) ? t.map((t) => String(t)) : String(t)),
		Cp = (t, e) => t[1] - e[1],
		Fp = (t, e) => e[1] - t[1];
	function Sp(t, e, n) {
		let r;
	...
	function Tp(t, e) {
		return t.bins ? $p(t, t.bins, e) : t.ticks ? t.ticks(e) : t.domain();
	}
	function Bp(t, e, n, r, i, o) {
		const a = e.type;
		let s = Dp;
		if (a === Rd || i === Rd) s = t.timeFormat(r);
		else if (a === Ud || i === Ud) s = t.utcFormat(r);
		else if (hp(a)) {
	...
	function zp(t, e, n) {
		const r = Tp(t, e),
			...
			s = (t) => {
				let e = t / i ** Math.round(Math.log(t) / o);
				return e * i < i - 0.5 && (e *= i), e <= a;
			};
		return n ? r.filter(s) : s;
	}
	const Np = { [Pd]: "quantiles", [jd]: "thresholds", [Id]: "domain" },
		Op = { [Pd]: "quantiles", [jd]: "domain" };
	function Rp(t, e) {
		return t.bins
			? ((t) => {
					const e = t.slice(0, -1);
	...
	function Lp(t, e, n, r, i, o, a) {
		const s =
			Op[e.type] && o !== Rd && o !== Ud
				...
				: Bp(t, e, n, i, o, a);
		return r === Mp && Up(e) ? qp(s) : r === Ep ? jp(s) : Ip(s);
	}
	const qp = (t) => (e, n, r) => {
			const i = Pp(r[n + 1], Pp(r.max, 1 / 0)),
				o = Wp(e, t),
				a = Wp(i, t);
		...
		jp = (t) => (e, n) => (n ? t(e) : null),
		Ip = (t) => (e) => t(e),
		Wp = (t, e) => (Number.isFinite(t) ? e(t) : null);
	function Hp(t, e, n, r) {
		const i = r || e.type;
		return (
			xt(n) &&
	...
	function Yp(t, e, n) {
		...
		const r = Math.max(3, n.maxlen || 7),
			i = Hp(t, e, n.format, n.formatType);
		if (fp(e.type)) {
			const t = Rp(e).slice(1).map(i),
				n = t.length;
		...
		{
			const t = e.domain();
			return `values from ${i(t[0])} to ${i(F(t))}`;
		}
	}
	let Gp = 0;
	const Vp = "p_";
	...
	function Qp(t, e) {
		...
		return (n = {
			...
			y2: e ? e[1] : 0,
			stops: r,
			stop: (t, e) => (r.push({ offset: t, color: e }), n),
		});
	}
	const Kp = {
		basis: { curve: (t) => new ec(t) },
		"basis-closed": { curve: (t) => new nc(t) },
		"basis-open": { curve: (t) => new rc(t) },
		...
		linear: { curve: Gl },
		"linear-closed": { curve: (t) => new xc(t) },
		monotone: { horizontal: (t) => new Ec(t), vertical: (t) => new Mc(t) },
		natural: { curve: (t) => new Cc(t) },
		step: { curve: (t) => new Sc(t, 0.5) },
		"step-after": { curve: (t) => new Sc(t, 1) },
		"step-before": { curve: (t) => new Sc(t, 0) },
	};
	function tg(t, e, n) {
		var r = lt(Kp, t) && Kp[t],
			i = null;
	...
	const eg = { m: 2, l: 2, h: 1, v: 1, z: 0, c: 6, s: 4, q: 4, t: 2, a: 7 },
		ng = /[mlhvzcsqta]([^mlhvzcsqta]+|$)/gi,
		rg = /^[+-]?(([0-9]*\.[0-9]+)|([0-9]+\.)|([0-9]+))([eE][+-]?[0-9]+)?/,
		ig = /^((\s+,?\s*)|(,\s*))/,
		og = /^[01]/;
	function ag(t) {
		const e = [];
		return (
			(t.match(ng) || []).forEach((t) => {
				let n = t[0];
				const r = n.toLowerCase(),
					...
					o = ((t, e, n) => {
						...
						for (let i = 0; e && i < n.length; )
							for (let o = 0; o < e; ++o) {
								const e = "a" !== t || (3 !== o && 4 !== o) ? rg : og,
									a = n.slice(i).match(e);
								if (null === a)
									throw Error("Invalid SVG path, incorrect parameter type");
								(i += a[0].length), r.push(+a[0]);
								const s = n.slice(i).match(ig);
								null !== s && (i += s[0].length);
							}
						return r;
					})(r, i, t.slice(1).trim()),
	...
	function mg(t, e, n) {
		...
		if ("a" === r || "A" === r)
			(gg[1] = e * t[1]),
				...
				(gg[6] = e * t[6]),
				(gg[7] = n * t[7]);
		else if ("h" === r || "H" === r) gg[1] = e * t[1];
		else if ("v" === r || "V" === r) gg[1] = n * t[1];
		else
	...
	function yg(t, e, n, r, i, o) {
		...
		for (var v = 0, _ = e.length; v < _; ++v) {
			switch (((a = e[v]), (1 === i && 1 === o) || (a = mg(a, i, o)), a[0])) {
				case "l":
	...
	function vg(t, e, n, r) {
		const i = (function (t, e, n, r, i, o, a, s, u) {
			...
			F < 0 && 1 === o ? (F += lg) : F > 0 && 0 === o && (F -= lg);
			const S = Math.ceil(Math.abs(F / (ug + 0.001))),
				$ = [];
			for (let t = 0; t < S; ++t) {
				const e = C + (t * F) / S,
					i = C + ((t + 1) * F) / S;
	...
	const _g = 0.5773502691896257,
		xg = {
			circle: {
				draw: (t, e) => {
					const n = Math.sqrt(e) / 2;
					t.moveTo(n, 0), t.arc(0, 0, n, 0, lg);
				},
			},
			cross: {
				draw: (t, e) => {
	...
	function Sg() {
		...
		function l(l, c, f) {
			...
			if ((u || (u = h = Rl()), v <= 0 && _ <= 0 && x <= 0 && b <= 0))
				...
				u.moveTo(d + v, p),
					u.lineTo(w - _, p),
					u.bezierCurveTo(w - kg * _, p, w, p + kg * _, w, p + _),
					u.lineTo(w, k - b),
					u.bezierCurveTo(w, k - kg * b, w - kg * b, k, w - b, k),
					u.lineTo(d + x, k),
					u.bezierCurveTo(d + kg * x, k, d, k - kg * x, d, k - x),
					u.lineTo(d, p + v),
					u.bezierCurveTo(d, p + kg * v, d + kg * v, p, d + v, p),
					u.closePath();
			}
		...
		return (
			(l.x = function (e) {
				return arguments.length ? ((t = Cg(e)), l) : t;
			}),
			(l.y = function (t) {
				return arguments.length ? ((e = Cg(t)), l) : e;
			}),
			(l.width = function (t) {
				return arguments.length ? ((n = Cg(t)), l) : n;
			}),
			(l.height = function (t) {
				return arguments.length ? ((r = Cg(t)), l) : r;
			}),
	...
	const Bg = (t) => t.x || 0,
		...
		qg = Sg()
			...
			.height((t) => t.height || 0)
			.cornerRadius(
				(t) => Tg(t.cornerRadiusTopLeft, t.cornerRadius) || 0,
				(t) => Tg(t.cornerRadiusTopRight, t.cornerRadius) || 0,
				(t) => Tg(t.cornerRadiusBottomRight, t.cornerRadius) || 0,
				(t) => Tg(t.cornerRadiusBottomLeft, t.cornerRadius) || 0,
			),
		Pg = ((t, e) => {
			let n = null,
				r = Ul(i);
	...
	function Gg(t, e, n) {
		var r = e.clip,
			i = t._defs,
			o = e.clip_id || (e.clip_id = "clip" + Hg++),
			a = i.clipping[o] || (i.clipping[o] = { id: o });
		return (
			J(r)
				? (a.path = r(null))
				: Ig(n)
					? (a.path = Wg(null, n, 0, 0))
	...
	function Xg(t) {
		(this.mark = t), (this.bounds = this.bounds || new Vg());
	}
	function Jg(t) {
		Xg.call(this, t), (this.items = this.items || []);
	}
	(Vg.prototype = {
		clone() {
			return new Vg(this);
	...
	function tm(t, e, n) {
		if (e.stroke && 0 !== e.opacity && 0 !== e.strokeOpacity) {
			...
			t.expand(
				r +
					(n
						? ((t, e) => (t.strokeJoin && "miter" !== t.strokeJoin ? 0 : e))(
								e,
								r,
							)
						: 0),
	...
	const em = lg - 1e-8;
	let nm, rm, im, om, am, sm, um, lm;
	const cm = (t, e) => nm.add(t, e),
		fm = (t, e) => cm((rm = t), (im = e)),
		hm = (t) => cm(t, nm.y1),
		dm = (t) => cm(nm.x1, t),
		pm = (t, e) => am * t + um * e,
		gm = (t, e) => sm * t + lm * e,
		mm = (t, e) => cm(pm(t, e), gm(t, e)),
		ym = (t, e) => fm(pm(t, e), gm(t, e));
	function vm(t, e) {
		return (
			(nm = t),
			e
	...
	const _m = {
		...
		rect(t, e, n, r) {
			om
				? (mm(t + n, e), mm(t + n, e + r), mm(t, e + r), ym(t, e))
				: (cm(t + n, e + r), fm(t, e));
		},
		quadraticCurveTo(t, e, n, r) {
			const i = pm(t, e),
				...
				a = pm(n, r),
				s = gm(n, r);
			xm(rm, i, a, hm), xm(im, o, s, dm), fm(a, s);
		},
		bezierCurveTo(t, e, n, r, i, o) {
			const a = pm(t, e),
				s = gm(t, e),
				...
				c = pm(i, o),
				f = gm(i, o);
			bm(rm, a, u, c, hm), bm(im, s, l, f, dm), fm(c, f);
		},
		arc(t, e, n, r, i, o) {
			if (
				((r += om),
				...
				cm(t - n, e - n), cm(t + n, e + n);
			else {
				const a = (r) => cm(n * Math.cos(r) + t, n * Math.sin(r) + e);
				let s, u;
				if ((a(r), a(i), i !== r))
					if (
						((r %= lg) < 0 && (r += lg),
						...
						for (i -= lg, s = r - (r % ug), u = 0; u < 4 && s > i; ++u, s -= ug)
							a(s);
					else
						for (s = r - (r % ug) + ug, u = 0; u < 4 && s < i; ++u, s += ug)
							a(s);
			}
		},
	};
	...
	function bm(t, e, n, r, i) {
		...
		Math.abs(o) > 1e-14
			...
			: (l = (0.5 * s) / a),
			0 < l && l < 1 && i(wm(l, t, e, n, r)),
			0 < c && c < 1 && i(wm(c, t, e, n, r));
	}
	...
	var km = (km = $c(1, 1)) ? km.getContext("2d") : null;
	const Am = new Vg();
	function Mm(t) {
		return (e, n) => {
			if (!km) return !0;
			t(km, e), Am.clear().union(e.bounds).intersect(n).round();
			const { x1: r, y1: i, x2: o, y2: a } = Am;
			for (let t = i; t <= a; ++t)
				for (let e = r; e <= o; ++e) if (km.isPointInPath(e, t)) return !0;
			return !1;
		};
	}
	function Em(t, e) {
	...
	function Dm(t, e) {
		const n = t.x || 0,
			...
			i = t.width || 0,
			o = t.height || 0;
		return e.intersects(Am.set(n, r, n + i, r + o));
	}
	function Cm(t, e) {
		const n = t.x || 0,
			r = t.y || 0;
		return Fm(e, n, r, null != t.x2 ? t.x2 : n, null != t.y2 ? t.y2 : r);
	}
			...
			? ((t, e, n) => {
					...
					if ("radial" === e.gradient)
						o = t.createRadialGradient(
							n.x1 + $m(e.x1, 0.5) * r,
							n.y1 + $m(e.y1, 0.5) * i,
							Math.max(r, i) * $m(e.r1, 0),
							n.x1 + $m(e.x2, 0.5) * r,
							n.y1 + $m(e.y2, 0.5) * i,
							Math.max(r, i) * $m(e.r2, 0.5),
						);
					else {
						const a = $m(e.x1, 0),
							s = $m(e.y1, 0),
						...
						if (a !== u && s !== l && r !== i) {
							...
							return (
								o.scale(r, i),
								(o.fillStyle = Tm(o.createLinearGradient(a, s, u, l), e.stops)),
								o.fillRect(0, 0, r, i),
	...
	function zm(t, e, n) {
		return (
			...
			((t.globalAlpha = n), (t.fillStyle = Bm(t, e, e.fill)), !0)
		);
	}
	var Nm = [];
	function Om(t, e, n) {
	...
	function Um(t) {
		...
		return (t.zdirty = !1), (t.zitems = o.sort(Rm));
	}
	function Lm(t, e) {
		var n,
			r,
	...
	function Pm(t) {
		return (e, n, r) => {
			Lm(n, (n) => {
				(r && !r.intersects(n.bounds)) || Im(t, e, n, n);
			});
		};
	}
	function jm(t) {
	...
	function Jm(t, e, n) {
		...
		return {
			...
			attr: (t, n) => {
				t(
					"transform",
					((t) => Gm(t.x || 0, t.y || 0) + (t.angle ? " " + Vm(t.angle) : ""))(
						n,
					),
				),
					t("d", e(null, n));
			...
			bound: (t, n) => (
				e(vm(t, n.angle), n), tm(t, n).translate(n.x || 0, n.y || 0)
			),
			draw: Pm(r),
			pick: Ym(r),
			isect: n || Mm(r),
	...
	var Zm = Jm("arc", (t, e) => Og.context(t)(e));
	function Qm(t, e, n) {
		function r(t, n) {
			t.beginPath(), e(t, n);
		}
		...
		return {
			...
			bound: (t, n) => {
				var r = n.items;
				return 0 === r.length ? t : (e(vm(t), r), tm(t, r[0]));
			},
			draw: jm(r),
			pick: (t, e, n, r, o, a) => {
				var s = e.items,
	...
	var Km = Qm(
		...
		(t, e) => {
			...
			return ("horizontal" === n.orient ? Ug : Rg)
				.curve(tg(r, n.orient, n.tension))
				.context(t)(e);
		},
		(t, e) => {
			for (
	...
	function ty(t, e) {
		t.beginPath(),
			Ig(e) ? Wg(t, e, 0, 0) : t.rect(0, 0, e.width || 0, e.height || 0),
			t.clip();
	}
	function ey(t) {
		const e = $m(t.strokeWidth, 1);
	...
	function ry(t, e, n, r) {
		const i = ey(e);
		t.beginPath(), Wg(t, e, (n || 0) + i, (r || 0) + i);
	}
	const iy = Hm(ry),
		oy = Hm(ry, !1),
		ay = Hm(ry, !0);
	var sy = {
				...
				Lm(e, (e) => {
					...
					(e.stroke || e.fill) &&
						...
						a &&
							e.stroke &&
							s &&
							(ry(t, e, i, o), Sm(t, e), Om(t, e, s) && t.stroke());
				});
			},
			pick: function (t, e, n, r, i, o) {
				...
				return qm(e, (u) => {
					...
					const m = u.strokeForeground,
						y = !1 !== e.interactive;
					return y && m && u.stroke && oy(t, u, a, s)
						? (t.restore(), u)
						: ((l = qm(u, (t) =>
								((t, e, n) =>
									(!1 !== t.interactive || "group" === t.marktype) &&
									t.bounds &&
									t.bounds.contains(e, n))(t, c, f)
									? this.pick(t, n, r, c, f)
									: null,
							)),
							!l &&
			...
			isect: Dm,
			content: (t, e, n) => {
				t("clip-path", e.clip ? Gg(n, e, e) : null);
			},
			background: (t, e) => {
				t("class", "background"), t("aria-hidden", !0), ny(t, e);
			},
			foreground: (t, e) => {
				t("class", "foreground"),
					t("aria-hidden", !0),
					e.strokeForeground ? ny(t, e) : t("d", "");
			},
		},
		uy = {
	...
	var py = {
			...
			attr: (t, e, n) => {
				const r = ly(e, n),
					i = cy(e, r),
					o = fy(e, r),
					a = (e.x || 0) - hy(e.align, i),
					s = (e.y || 0) - dy(e.baseline, o);
				t(
					"href",
			...
			bound: (t, e) => {
				const n = e.image,
					r = cy(e, n),
					i = fy(e, n),
					o = (e.x || 0) - hy(e.align, r),
					a = (e.y || 0) - dy(e.baseline, i);
			...
			draw: function (t, e, n) {
				Lm(e, (e) => {
					...
					let a,
						...
						u,
						l,
						c = (e.x || 0) - hy(e.align, i),
						f = (e.y || 0) - dy(e.baseline, o);
					!1 !== e.aspect &&
						((s = r.width / r.height),
						(u = e.width / e.height),
						s == s &&
		...
		gy = Qm(
			...
			(t, e) => {
				const n = e[0],
					r = n.interpolate || "linear";
				return Lg.curve(tg(r, n.orient, n.tension)).context(t)(e);
			},
			(t, e) => {
				for (
					var n, r, i = (t[0].strokeWidth || 1) ** 2, o = t.length;
					--o >= 0;
				)
					if (
						!1 !== t[o].defined &&
	...
	function my(t, e) {
		...
		var r = e.x || 0,
			...
			s = (e.angle || 0) * sg,
			u = e.pathCache;
		(u && u.path === n) || ((e.pathCache = u = ag(n)).path = n),
	...
	var yy = {
		...
		bound: (t, e) => (my(vm(t, e.angle), e) ? t.set(0, 0, 0, 0) : tm(t, e, !0)),
		draw: Pm(my),
		pick: Ym(my),
		isect: Mm(my),
	};
			...
			draw: (t, e, n) => {
				Lm(e, (e) => {
					if (!n || n.intersects(e.bounds)) {
						...
						r && xy(t, e, r) && (Sm(t, e), t.stroke());
					}
				});
			},
			pick: Wm(
				(t, e, n, r) =>
					!!t.isPointInStroke && xy(t, e, 1) && t.isPointInStroke(n, r),
			),
			isect: Cm,
		},
		wy = Jm("shape", (t, e) => (e.mark.shape || e.shape).context(t)(e)),
		ky = Jm("symbol", (t, e) => Pg.context(t)(e), Em);
	const Ay = kt();
	var My = {
		height: $y,
		measureWidth: Fy,
	...
	function Dy(t, e) {
		return Cy(Ny(t, e), $y(t));
	}
	function Cy(t, e) {
		return ~~(0.8 * t.length * e);
	}
	function Fy(t, e) {
		return $y(t) <= 0 || !(e = Ny(t, e)) ? 0 : Sy(e, Ry(t));
	}
	function Sy(t, e) {
		const n = `(${e}) ${t}`;
		let r = Ay.get(n);
		return (
			void 0 === r &&
				((km.font = e), (r = km.measureText(t).width), Ay.set(n, r)),
			r
		);
	}
	function $y(t) {
	...
	function Ty(t) {
		return null != t.lineHeight ? t.lineHeight : $y(t) + 2;
	}
	function By(t) {
		return (
			(e =
				t.lineBreak && t.text && !k(t.text)
					? t.text.split(t.lineBreak)
					: t.text),
			k(e) ? (e.length > 1 ? e : e[0]) : e
		);
		var e;
	}
	function zy(t) {
		const e = By(t);
		return (k(e) ? e.length - 1 : 0) * Ty(t);
	}
	function Ny(t, e) {
	...
	Ey(!0);
	const Ly = { left: "start", center: "middle", right: "end" },
		qy = new Vg();
	function Py(t) {
		var e,
			n = t.x || 0,
	...
	function jy(t, e, n) {
		...
		if (
			(k(f)
				? ((i += Ty(e) * (f.length - 1)),
					(r = f.reduce((t, n) => Math.max(t, My.width(e, n)), 0)))
				: (r = My.width(e, f)),
			"center" === o ? (l -= r / 2) : "right" === o && (l -= r),
			t.set((l += s), (c += u), l + r, c + i),
			e.angle && !n)
		)
			t.rotate(e.angle * sg, s, u);
		else if (2 === n) return t.rotatedPoints(e.angle * sg, s, u);
		return t;
	}
	var Iy = {
			type: "text",
			...
			attr: (t, e) => {
				var n,
					...
					s = o.y1,
					u = e.angle || 0;
				t("text-anchor", Ly[e.align] || "start"),
					u
						? ((n = Gm(a, s) + " " + Vm(u)), (r || i) && (n += " " + Gm(r, i)))
						: (n = Gm(a + r, s + i)),
					t("transform", n);
			},
			bound: jy,
				...
				Lm(e, (e) => {
					...
					if (
						...
						if (
							...
							for (s = Ty(e), a = 0; a < u.length; ++a)
								(l = Ny(e, u[a])),
									e.fill && zm(t, e, c) && t.fillText(l, i, o),
									e.stroke && Om(t, e, c) && t.strokeText(l, i, o),
									(o += s);
						else
							(l = Ny(e, u)),
								e.fill && zm(t, e, c) && t.fillText(l, i, o),
			...
			isect: (t, e) => {
				const n = jy(qy, t, 2);
				return (
					Fm(e, n[0], n[1], n[2], n[3]) ||
					Fm(e, n[0], n[1], n[4], n[5]) ||
					Fm(e, n[4], n[5], n[6], n[7]) ||
					Fm(e, n[2], n[3], n[6], n[7])
				);
			},
		},
		Wy = Qm(
	...
	function Yy(t, e, n) {
		var r = Hy[t.mark.marktype],
			i = e || r.bound;
		return r.nested && (t = t.mark), i(t.bounds || (t.bounds = new Vg()), t, n);
	}
	var Gy = { mark: null };
	function Vy(t, e, n) {
		var r,
		...
		if (s.nested)
			return (
				c ? (o = l[0]) : ((Gy.mark = t), (o = Gy)),
				(a = Yy(o, u, n)),
				(e = (e && e.union(a)) || a)
			);
		if (((e = e || (t.bounds && t.bounds.clear()) || new Vg()), c))
			for (r = 0, i = l.length; r < i; ++r) e.union(Yy(l[r], u, n));
		return (t.bounds = e);
	}
	const Xy = [
		"marktype",
	...
	function Jy(t, e) {
		return JSON.stringify(t, Xy, e);
	}
	function Zy(t) {
		return Qy("string" == typeof t ? JSON.parse(t) : t);
	}
	function Qy(t) {
		var e,
			n,
	...
	class Ky {
		constructor(t) {
			arguments.length
				? (this.root = Zy(t))
				: ((this.root = tv({ marktype: "group", name: "root", role: "frame" })),
					(this.root.items = [new Jg(this.root)]));
		}
		toJSON(t) {
			return Jy(this.root, t || 0);
		}
		mark(t, e, n) {
			const r = tv(t, (e = e || this.root.items[0]));
			...
			if (e && null != e.tooltip) {
				e = ((t, e, n, r) => {
					var i,
						o,
						a = t && t.mark;
					if (a && (i = Hy[a.marktype]).tip) {
						for ((o = av(e, n))[0] -= r[0], o[1] -= r[1]; (t = t.mark.group); )
							(o[0] -= t.x || 0), (o[1] -= t.y || 0);
						t = i.tip(a.items, o);
					}
					return t;
	...
	class lv {
		constructor(t) {
			(this._el = null), (this._bgcolor = null), (this._loader = new Zg(t));
		}
		...
		_load(t, e) {
			var r = this._loader[t](e);
			if (!this._ready) {
				const t = this._call;
				this._ready = this._loader.ready().then((e) => {
					e && t(), (this._ready = null);
				});
			}
			return r;
		}
	...
	class Sv extends sv {
		constructor(t, e) {
			super(t, e),
				...
				(this._events = {}),
				(this.events = Ev),
				(this.pointermove = zv([pv, vv], [mv, xv], [gv, _v])),
				(this.dragover = zv([hv], [cv], [fv])),
				(this.pointerout = Nv([gv, _v])),
				(this.dragleave = Nv([fv]));
		}
		initialize(t, e, n) {
			return (
				(this._canvas = t && nv(t, "canvas")),
				[bv, yv, dv, pv, gv, fv].forEach((t) => Tv(this, t)),
		...
		mousedown(t) {
			(this._down = this._active), this.fire(yv, t);
		}
		click(t) {
			this._down === this._active && (this.fire(bv, t), (this._down = null));
		}
		touchstart(t) {
		...
		touchend(t) {
			this.fire(Mv, t, !0), (this._touch = null);
		}
		fire(t, e, n) {
			...
			if (
				...
				t === Fv && r && r.href
					...
					: (t !== Dv && t !== Cv) || this.handleTooltip(e, r, t !== Cv),
				i)
			)
		...
		on(t, e) {
			...
			return (
				this._handlerIndex(r[n], t, e) < 0 &&
					(Tv(this, t), (r[n] || (r[n] = [])).push({ type: t, handler: e })),
				this
			);
		}
		off(t, e) {
		...
		pickEvent(t) {
			const e = av(t, this._canvas),
				n = this._origin;
			return this.pick(this._scene, e[0], e[1], e[0] - n[0], e[1] - n[1]);
		}
		pick(t, e, n, r, i) {
			const o = this.context();
			return Hy[t.marktype].pick.call(this, o, t, e, n, r, i);
		}
	}
	const $v = (t) => (t === kv || t === Av || t === Mv ? [kv, Av, Mv] : [t]);
	function Tv(t, e) {
		$v(e).forEach((e) =>
			((t, e) => {
				const n = t.canvas();
	...
	function zv(t, e, n) {
		return function (r) {
			const i = this._active,
				o = this.pickEvent(r);
			o === i ||
				((i && i.exit) || Bv(this, n, r), (this._active = o), Bv(this, e, r)),
				Bv(this, t, r);
		};
	}
	function Nv(t) {
		return function (e) {
			Bv(this, t, e), (this._active = null);
		};
	}
	...
	class Rv extends lv {
		...
		initialize(t, e, n, r, i, o) {
			return (
				...
				t &&
					this._canvas &&
					(iv(t, 0).appendChild(this._canvas),
		...
		draw(t, e, n, r) {
			if ("group" !== e.marktype && null != r && !r.includes(e.marktype))
				return;
			const i = Hy[e.marktype];
			e.clip &&
				((t, e) => {
					var n = e.clip;
					t.save(), J(n) ? (t.beginPath(), n(t), t.clip()) : ty(t, e.group);
				})(t, e),
	...
	const Uv = (t, e, n) => new Vg().set(0, 0, e, n).translate(-t[0], -t[1]);
	class Lv extends sv {
		constructor(t, e) {
			super(t, e);

			(this._hrefHandler = qv(this, (t, e) => {
				e && e.href && this.handleHref(t, e, e.href);
			})),
				(this._tooltipHandler = qv(this, (t, e) => {
					this.handleTooltip(t, e, t.type !== Cv);
				}));
		}
		initialize(t, e, n) {
			let r = this._svg;
			return (
				r &&
					(r.removeEventListener(Fv, this._hrefHandler),
					r.removeEventListener(Dv, this._tooltipHandler),
					r.removeEventListener(Cv, this._tooltipHandler)),
				(this._svg = r = t && nv(t, "svg")),
				r &&
					(r.addEventListener(Fv, this._hrefHandler),
					r.addEventListener(Dv, this._tooltipHandler),
		...
		on(t, e) {
			...
			if (this._handlerIndex(r[n], t, e) < 0) {
				const i = { type: t, handler: e, listener: qv(this, e) };
				(r[n] || (r[n] = [])).push(i),
	...
	const qv = (t, e) => (n) => {
		...
		jv = "aria-label",
		Iv = "role",
		Wv = "aria-roledescription",
		Hv = "graphics-object",
		Yv = "graphics-symbol",
		Gv = (t, e, n) => ({ [Iv]: t, [Wv]: e, [jv]: n || void 0 }),
		Vv = Bt([
			"axis-domain",
			"axis-grid",
			"axis-label",
				...
				caption: (t) => {
					...
					return (
						...
						(l.length ? l[0].toUpperCase() + l.slice(1) : l) +
							(n ? ` titled '${n}'` : "") +
							` for ${((t) => ((t = t.map((t) => t + ("fill" === t || "stroke" === t ? " color" : ""))), t.length < 2 ? t[0] : t.slice(0, -1).join(", ") + " and " + F(t)))(o)}` +
							` with ${Yp(u, s, t)}`
					);
					var l;
				},
			},
			"title-text": { desc: "title", caption: (t) => `Title text '${Kv(t)}'` },
			"title-subtitle": {
				desc: "subtitle",
				caption: (t) => `Subtitle text '${Kv(t)}'`,
			},
		},
		Jv = { ariaRole: Iv, ariaRoleDescription: Wv, description: jv };
	function Zv(t, e) {
		const n = !1 === e.aria;
		if ((t(Pv, n || void 0), n || null == e.description))
			for (const e in Jv) t(Jv[e], void 0);
		else {
			const n = e.mark.marktype;
			t(jv, e.description),
				t(Iv, e.ariaRole || ("group" === n ? Hv : Yv)),
				t(Wv, e.ariaRoleDescription || `${n} mark`);
		}
	}
	function Qv(t) {
		return !1 === t.aria
				...
				: Xv[t.role]
					? ((t, e) => {
							try {
								const n = t.items[0],
									r = e.caption || (() => "");
								return Gv(e.role || Yv, e.desc, n.description || r(n));
							} catch (t) {
								return null;
							}
						})(t, Xv[t.role])
					: ((t) => {
							...
							return Gv(n ? Hv : Yv, `${e} mark container`, t.description);
						})(t);
	}
	function Kv(t) {
		return V(t.text).join(" ");
	}
	function t_(t) {
		try {
			return V(F(t.items).items[0].text).join(" ");
		} catch (t) {
			return null;
		}
	}
	...
	function n_() {
		...
		const r = [],
			...
			o = (t, n) => {
				...
				return (
					null != n &&
						(e += ` ${t}="${(((r = n)), e_(r).replace(/"/g, "&quot;").replace(/\t/g, "&#x9;").replace(/\n/g, "&#xA;").replace(/\r/g, "&#xD;"))}"`),
					a
				);
			},
			a = {
	...
	function i_(t, e) {
		...
		if (e.hasChildNodes()) {
			...
			for (const e of n) 3 === e.nodeType ? t.text(e.nodeValue) : i_(t, e);
		}
		return t.close();
	}
	const o_ = {
		...
		a_ = { blend: "mix-blend-mode" },
		s_ = { fill: "none", "stroke-miterlimit": 10 },
		u_ = "http://www.w3.org/2000/xmlns/",
		l_ = uy.xmlns;
	class c_ extends lv {
		constructor(t) {
			super(t),
		...
		initialize(t, e, n, r, i) {
			return (
				...
				this._clearDefs(),
				t &&
					((this._svg = rv(t, 0, "svg", l_)),
					this._svg.setAttributeNS(u_, "xmlns", l_),
					this._svg.setAttributeNS(u_, "xmlns:xlink", uy["xmlns:xlink"]),
					this._svg.setAttribute("version", uy.version),
					this._svg.setAttribute("class", "marks"),
					iv(t, 1),
					(this._root = rv(this._svg, 0, "g", l_)),
					x_(this._root, s_),
					iv(this._svg, 1)),
		...
		svg() {
			...
			e &&
				...
				(n = rv(t, 0, "rect", l_)),
				x_(n, { width: this._width, height: this._height, fill: e }));
			const r = r_(t);
			return (
				e &&
					(t.removeChild(n),
		...
		_dirtyCheck() {
			...
			for (a = 0, s = t.length; a < s; ++a)
				(n = t[a]),
					(r = n.mark),
					r.marktype !== i && ((i = r.marktype), (o = Hy[i])),
					r.zdirty &&
						r.dirty !== e &&
						((this._dirtyAll = !1),
						f_(n, e),
		...
		mark(t, e, n, r) {
			...
			const i = this._svg,
				...
				u = "g" === a.tag,
				l = p_(e, t, n, "g", i);
			if ("group" !== o && null != r && !r.includes(o)) return iv(l, 0), e._svg;
			l.setAttribute("class", ov(e));
			const c = Qv(e);
			for (const t in c) b_(l, t, c[t]);
			u || b_(l, "pointer-events", s),
				b_(l, "clip-path", e.clip ? Gg(this, e, e.group) : null);
			let f = null,
				h = 0;
			const d = (t) => {
			...
			return a.nested ? e.items.length && d(e.items[0]) : Lm(e, d), iv(l, h), l;
		}
		_update(t, e, n) {
			(g_ = e), (m_ = e.__values__), Zv(v_, n), t.attr(v_, n, this);
			const r = y_[t.type];
			r && r.call(this, t, e, n), g_ && this.style(g_, n);
		}
		style(t, e) {
			if (null != e) {
				for (const n in o_) {
					let r = "font" === n ? Oy(e) : e[n];
					if (r === m_[n]) continue;
					const i = o_[n];
					null == r
						? t.removeAttribute(i)
						: (Xp(r) && (r = Jp(r, this._defs.gradient, w_())),
							t.setAttribute(i, r + "")),
						(m_[n] = r);
				}
				for (const n in a_) __(t, a_[n], e[n]);
			}
		}
		defs() {
			const t = this._svg,
			...
			for (const i in e.gradient)
				n || (e.el = n = rv(t, 1, "defs", l_)), (r = h_(n, e.gradient[i], r));
			for (const i in e.clipping)
				n || (e.el = n = rv(t, 1, "defs", l_)), (r = d_(n, e.clipping[i], r));
			n && (0 === r ? (t.removeChild(n), (e.el = null)) : iv(n, r));
		}
		_clearDefs() {
			const t = this._defs;
	...
	function h_(t, e, n) {
		...
		if ("radial" === e.gradient) {
			...
			x_(r, {
				...
				(r = rv(r, 0, "rect", l_)),
				x_(r, { width: 1, height: 1, fill: `url(${w_()}#${e.id})` }),
				x_((t = rv(t, n++, "radialGradient", l_)), {
					id: e.id,
					fx: e.x1,
					fy: e.y1,
					fr: e.r1,
	...
	function d_(t, e, n) {
		let r;
		return (
			(t = rv(t, n, "clipPath", l_)).setAttribute("id", e.id),
			e.path
				? ((r = rv(t, 0, "path", l_)), r.setAttribute("d", e.path))
				: ((r = rv(t, 0, "rect", l_)),
					x_(r, { x: 0, y: 0, width: e.width, height: e.height })),
			iv(t, 1),
			n + 1
		);
	}
	...
	const y_ = {
		group(t, e, n) {
			const r = (g_ = e.childNodes[2]);
			(m_ = r.__values__),
				t.foreground(v_, n, this),
				(m_ = e.__values__),
				(g_ = e.childNodes[1]),
				t.content(v_, n, this);
			const i = (g_ = e.childNodes[0]);
			t.background(v_, n, this);
			const o = !1 === n.mark.interactive ? "none" : null;
			if (
				(o !== m_.events &&
					(b_(r, "pointer-events", o),
					b_(i, "pointer-events", o),
					(m_.events = o)),
				...
				b_(r, "display", null),
					...
					t && (n.fill = t),
					(g_ = null);
			} else b_(r, "display", "none");
		},
		image(t, e, n) {
			!1 === n.smooth
				? (__(e, "image-rendering", "optimizeSpeed"),
					__(e, "image-rendering", "pixelated"))
				: __(e, "image-rendering", null);
		},
		text(t, e, n) {
			const r = By(n);
			let i, o, a, s;
			k(r)
				? ((o = r.map((t) => Ny(n, t))),
					...
					i !== m_.text &&
						...
						(m_.text = i)))
				: ((o = Ny(n, r)),
					o !== m_.text && ((e.textContent = o), (m_.text = o))),
				b_(e, "font-family", Oy(n)),
				b_(e, "font-size", $y(n) + "px"),
				b_(e, "font-style", n.fontStyle),
				b_(e, "font-variant", n.fontVariant),
				b_(e, "font-weight", n.fontWeight);
		},
	};
	function v_(t, e, n) {
		e !== m_[t] &&
	...
	class k_ extends lv {
			...
			return (
				n &&
					...
					e
						...
						.close(),
				e.open("g", s_, { transform: "translate(" + this._origin + ")" }),
				this.mark(e, t),
				e.close(),
				this.defs(e),
				(this._text = e.close() + ""),
		...
		mark(t, e) {
			const n = Hy[e.marktype],
				r = n.tag,
				i = [Zv, n.attr];
			t.open(
				"g",
				{ class: ov(e), "clip-path": e.clip ? Gg(this, e, e.group) : null },
				Qv(e),
			...
			return (
				n.nested ? e.items && e.items.length && o(e.items[0]) : Lm(e, o),
				t.close()
			);
		}
		href(t) {
					...
					((t, e, n, r, i) => {
						...
						for (const n in o_) {
							...
							("transparent" !== r || ("fill" !== o && "stroke" !== o)) &&
								null != r &&
								(Xp(r) && (r = Jp(r, i.gradient, "")), (t[o] = r));
						}
						for (const t in a_) {
							const n = e[t];
							null != n && ((o = o || []), o.push(`${a_[t]}: ${n};`));
						}
						o && (t.style = o.join(" "));
					})(i, e, t, r, this._defs),
				i
	...
	const A_ = { svgMarkTypes: ["text"], svgOnTop: !0, debug: !1 };
	class M_ extends lv {
		constructor(t) {
			super(t),
				(this._svgRenderer = new c_(t)),
				(this._canvasRenderer = new Rv(t));
		}
		initialize(t, e, n, r, i) {
			this._root_el = rv(t, 0, "div");
			const o = rv(this._root_el, 0, "div"),
				a = rv(this._root_el, 1, "div");
			return (
				...
				A_.debug ||
					...
					(a.style.height = "100%"),
					(a.style.width = "100%")),
				(this._svgEl = A_.svgOnTop ? a : o),
				(this._canvasEl = A_.svgOnTop ? o : a),
		...
		dirty(t) {
			return (
				A_.svgMarkTypes.includes(t.mark.marktype)
		...
		_render(t, e) {
			...
			).filter((t) => !A_.svgMarkTypes.includes(t));
			this._svgRenderer.render(t, A_.svgMarkTypes),
	...
	class E_ extends Sv {
		...
		initialize(t, e, n) {
			const r = rv(rv(t, 0, "div"), A_.svgOnTop ? 0 : 1, "div");
	...
	const D_ = "canvas",
		C_ = "hybrid",
		F_ = "none",
		S_ = { Canvas: D_, PNG: "png", SVG: "svg", Hybrid: C_, None: F_ },
		$_ = {};
	function T_(t, e) {
		return (
			(t = String(t || "").toLowerCase()),
			arguments.length > 1 ? (($_[t] = e), this) : $_[t]
		);
	}
	function B_(t, e, n) {
		const r = [],
	...
	function z_(t, e, n, r) {
		if (
			...
			const i = t.items,
				...
				a = i.length;
			let s = 0;
			if ("group" === o) for (; s < a; ++s) N_(i[s], e, n, r);
			else
				for (const t = Hy[o].isect; s < a; ++s) {
					const n = i[s];
					O_(n, e, t) && r.push(n);
				}
		}
	...
	function N_(t, e, n, r) {
		n && n(t.mark) && O_(t, e, Hy.group.isect) && r.push(t);
		const i = t.items,
			o = i && i.length;
		if (o) {
			const a = t.x || 0,
	...
	($_[D_] = $_.png = { renderer: Rv, headless: Rv, handler: Sv }),
		($_.svg = { renderer: c_, headless: k_, handler: Lv }),
		($_[C_] = { renderer: M_, headless: M_, handler: E_ }),
		($_[F_] = {});
	const R_ = new Vg();
	function U_(t) {
		const e = t.clip;
		if (J(e)) e(vm(R_.clear()));
		else {
			if (!e) return;
			R_.set(0, 0, t.group.width, t.group.height);
		}
		t.bounds.intersect(R_);
	}
	const L_ = 1e-9;
	function q_(t, e, n) {
		return (
	...
	dt(Mx, Ja, {
		transform(t, e) {
			...
			if (o.nested)
			...
			else if (i === ex || t.modified())
				switch (
					(e.visit(e.MOD, (t) => n.dirty(t)),
					u.clear(),
					r.items.forEach((t) => u.union(Ex(t, a))),
					r.role)
				) {
					case nx:
					case ax:
				...
				(s = e.changed(e.REM)),
					...
					e.visit(e.MOD, (t) => {
						(s = s || u.alignsWith(t.bounds)), n.dirty(t), u.union(Ex(t, a));
					}),
					s && (u.clear(), r.items.forEach((t) => u.union(t.bounds)));
			return U_(r), e.modifies("bounds");
		},
	});
	const Dx = ":vega_identifier:";
	function Cx(t) {
		Ja.call(this, 0, t);
	}
	function Fx(t) {
	...
	(Cx.Definition = {
		...
		dt(Cx, Ja, {
			transform(t, e) {
				const n = (i = e.dataflow)._signals[Dx] || (i._signals[Dx] = i.add(0)),
					r = t.as;
				var i;
				let o = n.value;
				return (
	...
	const $x = {
			...
			greedy: (t, e) => {
				let n;
				return t.filter((t, r) =>
					r && Tx(n.bounds, t.bounds, e) ? (t.opacity = 0) : ((n = t), 1),
				);
			},
		},
		Tx = (t, e, n) =>
		...
		Bx = (t, e) => {
			for (var n, r = 1, i = t.length, o = t[0].bounds; r < i; o = n, ++r)
				if (Tx(o, (n = t[r].bounds), e)) return !0;
		},
		zx = (t) => {
			const e = t.bounds;
			return e.width() > 1 && e.height() > 1;
		},
		Nx = (t) => (t.forEach((t) => (t.opacity = 1)), t),
		Ox = (t, e) => t.reflow(e.modified()).modifies("opacity");
	function Rx(t) {
		Ja.call(this, null, t);
	}
	dt(Sx, Ja, {
		transform(t, e) {
			const n = $x[t.method] || $x.parity,
				r = t.separation || 0;
			let i,
				o,
				a = e.materialize(e.SOURCE).source;
			if (!a || !a.length) return;
			if (!t.method) return t.modified("method") && (Nx(a), (e = Ox(e, t))), e;
			...
			if (
				...
				do {
					i = n(i, r);
				} while (i.length >= 3 && Bx(i, r));
				i.length < 3 &&
					!F(a).opacity &&
					(i.length > 1 && (F(i).opacity = 0), (F(a).opacity = 1));
			}
			t.boundScale &&
				t.boundTolerance >= 0 &&
				((o = ((t, e, n) => {
		...
		switch (
			...
			case H_:
				(x = d || 0),
					...
					v.add(0, 0).add(f, o),
					m && jx(t, m, o, y, 0, 0, 1, v);
				break;
			default:
				(x = a.x), (b = a.y);
		}
		return (
			tm(v.translate(x, b), a),
			Lx(a, "x", x + u) | Lx(a, "y", b + u) &&
				((a.bounds = Ux), t.dirty(a), (a.bounds = v), t.dirty(a)),
			a.mark.bounds.clear().union(v)
		);
	}
	function jx(t, e, n, r, i, o, a, s) {
		const u = e.bounds;
		if (e.auto) {
			const s = a * (n + i + r);
			let l = 0,
	...
	const Ix = (t, e) => Math.floor(Math.min(t, e)),
		Wx = (t, e) => Math.ceil(Math.max(t, e));
	function Hx(t) {
		return new Vg().set(0, 0, t.width || 0, t.height || 0);
	}
	function Yx(t) {
	...
	function Xx(t, e, n) {
		...
		if (y && Gx(n.center, kx) && w > 1)
			for (i = 0; i < k; ++i)
				(f = (s = y === xx ? E : M[i % b]) - T[i].x2 - e[i].x - S[i]) > 0 &&
					(S[i] += f / 2);
		if (v && Gx(n.center, Ax) && 1 !== b)
			for (i = 0; i < k; ++i)
				(h = (s = v === xx ? F : C[~~(i / b)]) - T[i].y2 - e[i].y - $[i]) > 0 &&
					($[i] += h / 2);
		for (i = 0; i < k; ++i) m.union(T[i].translate(S[i], $[i]));
		switch (
			((f = Gx(n.anchor, K_)), (h = Gx(n.anchor, tx)), Gx(n.anchor, kx))
		) {
			case Q_:
				f -= m.width();
				break;
	...
	function Jx(t, e, n) {
		var r,
			...
			c = ((t) => {
				...
				for (; o < i; ++o)
					if (((n = (e = r[o]).items), e.marktype === ex))
						switch (e.role) {
							case nx:
							case ax:
							case rx:
		...
		y.empty() && y.set(0, 0, 0, 0),
			...
			c.rowtitle &&
				((s = Gx(n.titleAnchor, Ax)),
				(l = Gx(d, "rowTitle")),
				(l = s === Q_ ? o + l : r - l),
				(u = Gx(n.titleBand, Ax, 0.5)),
				tb(t, c.rowtitle, l, 0, y, u)),
			c.coltitle &&
				((s = Gx(n.titleAnchor, kx)),
				(l = Gx(d, "columnTitle")),
				(l = s === Q_ ? a + l : i - l),
				(u = Gx(n.titleBand, kx, 0.5)),
				tb(t, c.coltitle, l, 1, y, u));
	}
	function Zx(t, e) {
		return "x1" === e
			? t.x || 0
	...
	function Kx(t, e, n, r, i, o, a, s, u, l, c, f, h, d) {
		var p,
			g,
			m,
			y,
	...
	function eb(t, e, n, r, i, o, a) {
		...
		switch (e) {
			...
			case Y_:
				...
				break;
			case G_:
				f.anchor = { x: o - u, y: u, column: Q_ };
				break;
			case V_:
				f.anchor = { x: u, y: a - u, row: Q_ };
				break;
			case X_:
				f.anchor = { x: o - u, y: a - u, column: Q_, row: Q_ };
		}
		return f;
	}
	function nb(t, e) {
		...
		return (
			...
			((t, e, n) => {
				...
				if (e.datum.title) {
					...
					switch (((i || o) && ib(t, n, i, o), a.orient)) {
						case I_:
							c += rb(e, n, a, s, 1, 1);
							break;
						case W_:
							(l += rb(e, n, a, Q_, 0, 0) + u), (c += rb(e, n, a, s, 1, 1));
							break;
						case H_:
							(l += rb(e, n, a, s, 0, 0)), (c += rb(e, n, a, Q_, -1, 0, 1) + u);
							break;
						default:
							l += rb(e, n, a, s, 0, 0);
					}
			...
			a !== _x && ((i.x = u = 0), (i.y = l = 0)),
			(i.width = n),
			(i.height = r),
			tm(s.set(u, l, u + n, l + r), i),
			i.mark.bounds.clear().union(s),
			i
		);
	}
	function rb(t, e, n, r, i, o, a) {
		const s = "symbol" !== t.datum.type,
			...
			f = u && o ? 0 : l,
			h = i <= 0 ? 0 : zy(n);
		return Math.round(r === J_ ? c : r === Q_ ? f - h : 0.5 * (l - h));
	}
	function ib(t, e, n, r) {
		(e.x += n),
			(e.y += r),
					...
					t.layout && Jx(n, e, t.layout),
						((t, e, n) => {
							...
							if (p.length) {
								const e = {};
								p.forEach((t) => {
									(o = t.orient || W_) !== _x && (e[o] || (e[o] = [])).push(t);
								});
								for (const r in e) {
									const i = e[r];
									Xx(t, i, eb(i, r, n.legends, h, d, l, c));
								}
								p.forEach((e) => {
									const r = e.bounds;
									if (
									...
									: o === gx
										...
										: o === mx
											...
											: o === yx
												...
												: o === vx && ((a = u + l + h), (s = c + f + d));
								t._resizeView(a, s, u, c, [l, f], i.resize);
							})(t, e, f, n);
						})(n, e, t);
				}),
				((t) => t && "legend-entry" !== t.mark.role)(t.mark.group)
					? e.reflow()
					: e
			);
		},
	...
	dt(sb, Ja, {
		transform(t, e) {
			...
			var n = e.dataflow.locale(),
				...
				s =
					t.format || Bp(n, o, a, t.formatSpecifier, t.formatType, !!t.values),
				u = t.values ? $p(o, t.values, a) : Tp(o, a);
			return (
				i && (r.rem = i),
				(i = u.map((t, e) =>
		...
		dt(fb, Ja, {
			transform(t, e) {
				...
				var n,
					...
					f = t.scale,
					h = +t.limit,
					d = Sp(f, null == t.count ? 5 : t.count, t.minstep),
					p = !!t.values || c === Mp,
					g = t.format || Lp(s, f, d, c, t.formatSpecifier, t.formatType, p),
					m = t.values || Rp(f, d);
				return (
					l && (u.rem = l),
					c === Mp
	...
	const yb = (t, e, n, r) => "M" + t + "," + e + "L" + n + "," + r,
		...
		xb = ft({
			line: yb,
			"line-radial": (t, e, n, r) =>
				yb(e * Math.cos(t), e * Math.sin(t), r * Math.cos(n), r * Math.sin(n)),
			arc: vb,
			"arc-radial": (t, e, n, r) =>
	...
	function Db(t, e, n) {
		return J(t) && (e || n) ? mp(t, Cb(e || [0, 1], n)) : t;
	}
	function Cb(t, e) {
	...
	dt(Mb, Ja, {
		transform(t, e) {
			...
			for (i in ((r && i === r.type) || (this.value = r = ap(i)()), t))
				if (!Ab[i]) {
					if ("padding" === i && kb(r.type)) continue;
					J(r[i]) ? r[i](t[i]) : n.warn("Unsupported scale property: " + i);
				}
			return (
				((t, e, n) => {
					var r = t.type,
					...
					if (null != e.rangeStep)
						...
						((o = ((t, e, n) => {
							var r,
								i = e.schemeExtent;
							k(e.scheme)
								? (r = yp(e.scheme, e.interpolate, e.interpolateGamma))
								: (r = Ap(e.scheme.toLowerCase())) ||
					...
					if (o && dp(r))
						return t.interpolator(
							yp(Cb(o, e.reverse), e.interpolate, e.interpolateGamma),
						);
					o && e.interpolate && t.interpolate
						? t.interpolate(xp(e.interpolate, e.interpolateGamma))
						: J(t.round)
							? t.round(i)
							: J(t.rangeRound) && t.interpolate(i ? yh : mh);
					o && t.range(Cb(o, e.reverse));
				})(
					r,
					t,
					((t, e, n) => {
						...
						((t, e, n) => {
							const r = ((t, e, n) =>
								e ? (t.domain(Eb(t.type, e, n)), e.length) : -1)(
								t,
								e.domainRaw,
								n,
							);
							...
							t.domain(Eb(s, a, n)),
								s === Wd && t.unknown(e.domainImplicit ? Nc : void 0);
							e.nice &&
								t.nice &&
								t.nice((!0 !== e.nice && Sp(t, e.nice)) || null);
							return a.length;
						})(r, t, n),
					),
				),
	...
	(zb.Definition = {
		...
		params: [
			...
			{ name: "groupby", type: "field", array: !0 },
			{ name: "sort", type: "compare" },
			{ name: "offset", type: "enum", default: Sb, values: [Sb, $b, Tb] },
			{ name: "as", type: "string", array: !0, length: 2, default: Bb },
		],
	}),
		dt(zb, Ja, {
			transform(t, e) {
				var n,
					...
					l = ka(t.sort),
					c = t.field || d,
					f = t.offset === $b ? Nb : t.offset === Tb ? Ob : Rb;
				for (
					n = ((t, e, n, r) => {
						var i,
							o,
	...
	var Ub = Object.freeze({
		...
		ew = Math.pow,
		nw = Math.sin,
		rw = Math.sign || ((t) => (t > 0 ? 1 : t < 0 ? -1 : 0)),
		iw = Math.sqrt,
		ow = Math.tan;
	function aw(t) {
		return t > 1 ? 0 : t < -1 ? Pb : Math.acos(t);
	}
	function sw(t) {
	...
	function uw() {}
	function lw(t, e) {
		t && Object.hasOwn(fw, t.type) && fw[t.type](t, e);
	}
	var cw = {
			Feature: (t, e) => {
				lw(t.geometry, e);
			},
			FeatureCollection: (t, e) => {
		...
		fw = {
			...
			GeometryCollection: (t, e) => {
				for (var n = t.geometries, r = -1, i = n.length; ++r < i; ) lw(n[r], e);
			},
		};
	function hw(t, e, n) {
		var r,
	...
	function dw(t, e) {
		var n = -1,
			r = t.length;
		for (e.polygonStart(); ++n < r; ) hw(t[n], e, 1);
		e.polygonEnd();
	}
	function pw(t, e) {
		t && Object.hasOwn(cw, t.type) ? cw[t.type](t, e) : lw(t, e);
	}
	var gw,
		mw,
		yw,
		...
		Bw = {
			...
			lineEnd: uw,
			polygonStart: () => {
				($w = new se()), (Bw.lineStart = zw), (Bw.lineEnd = Nw);
			},
			polygonEnd: function () {
				var t = +$w;
				Tw.add(t < 0 ? Wb + t : t),
					(this.lineStart = this.lineEnd = this.point = uw);
			},
			sphere: () => {
				Tw.add(Wb);
			},
	...
	function Rw(t, e) {
		var n = (t *= Yb) - yw,
			...
			u = vw * o + s * Jb(i),
			l = s * r * nw(i);
		$w.add(Xb(l, u)), (yw = t), (vw = o), (_w = a);
	}
	function Uw(t) {
		return [Xb(t[1], t[0]), sw(t[2])];
	}
	function Lw(t) {
		var e = t[0],
			n = t[1],
			r = Jb(n);
		return [r * Jb(e), r * nw(e), nw(n)];
	}
	function qw(t, e) {
	...
	function Ww(t) {
		var e = iw(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);
		(t[0] /= e), (t[1] /= e), (t[2] /= e);
	}
	var Hw,
		Yw,
	...
	function lk(t, e) {
		...
		if (Dw) {
			...
			l ^ (s * Aw < u && u < s * t)
				? (o = i[1] * Hb) > kw && (kw = o)
				: l ^ (s * Aw < (u = ((u + 360) % 360) - 180) && u < s * t)
					? (o = -i[1] * Hb) < bw && (bw = o)
					: (e < bw && (bw = e), e > kw && (kw = e)),
				l
					? t < Aw
						? gk(xw, t) > gk(xw, ww) && (ww = t)
						: gk(t, ww) > gk(xw, ww) && (xw = t)
					: ww >= xw
						? (t < xw && (xw = t), t > ww && (ww = t))
						: t > Aw
							? gk(xw, t) > gk(xw, ww) && (ww = t)
							: gk(t, ww) > gk(xw, ww) && (xw = t);
		} else Fw.push((Sw = [(xw = t), (ww = t)]));
		e < bw && (bw = e), e > kw && (kw = e), (Dw = n), (Aw = t);
	}
	function ck() {
		sk.point = lk;
	}
	function fk() {
		(Sw[0] = xw), (Sw[1] = ww), (sk.point = uk), (Dw = null);
	}
	function hk(t, e) {
		if (Dw) {
			var n = t - Aw;
			Cw.add(Gb(n) > 180 ? n + (n > 0 ? 360 : -360) : n);
		} else (Mw = t), (Ew = e);
		Bw.point(t, e), lk(t, e);
	}
	function dk() {
	...
	var vk = {
		...
		lineEnd: Ak,
		polygonStart: () => {
			(vk.lineStart = Mk), (vk.lineEnd = Ek);
		},
		polygonEnd: () => {
			(vk.lineStart = bk), (vk.lineEnd = Ak);
		},
	};
	function _k(t, e) {
		t *= Yb;
		var n = Jb((e *= Yb));
		xk(n * Jb(t), n * nw(t), nw(e));
	}
	function xk(t, e, n) {
		++Hw, (Gw += (t - Gw) / Hw), (Vw += (e - Vw) / Hw), (Xw += (n - Xw) / Hw);
	}
	function bk() {
		vk.point = wk;
	}
	...
	function Ek() {
		Ck(nk, rk), (vk.point = _k);
	}
	function Dk(t, e) {
		(nk = t), (rk = e), (t *= Yb), (e *= Yb), (vk.point = Ck);
		var n = Jb(e);
		(ik = n * Jb(t)), (ok = n * nw(t)), (ak = nw(e)), xk(ik, ok, ak);
	}
	function Ck(t, e) {
		t *= Yb;
		var n = Jb((e *= Yb)),
	...
	function Fk(t, e) {
		...
		return (
			t.invert &&
				e.invert &&
				(n.invert = (n, r) => (n = e.invert(n, r)) && t.invert(n[0], n[1])),
			n
		);
	}
	function Sk(t, e) {
		return Gb(t) > Pb && (t -= Math.round(t / Wb) * Wb), [t, e];
	}
	function $k(t, e, n) {
		return (t %= Wb)
			? e || n
	...
	function Tk(t) {
		return (e, n) => (
			Gb((e += t)) > Pb && (e -= Math.round(e / Wb) * Wb), [e, n]
		);
	}
	function Bk(t) {
		var e = Tk(t);
		return (e.invert = Tk(-t)), e;
	}
	function zk(t, e) {
		var n = Jb(t),
			r = nw(t),
		...
		function a(t, e) {
			var a = Jb(e),
				...
				l = nw(e),
				c = l * n + s * r;
			return [Xb(u * i - c * o, s * n - l * r), sw(c * i + u * o)];
		}
		return (
			(a.invert = (t, e) => {
				var a = Jb(e),
					...
					l = nw(e),
					c = l * i - u * o;
				return [Xb(u * i + l * o, s * n + c * r), sw(c * n - s * r)];
			}),
			a
		);
	}
	...
	function Rk(t, e) {
		return Gb(t[0] - e[0]) < Lb && Gb(t[1] - e[1]) < Lb;
	}
	function Uk(t, e, n, r) {
		(this.x = t),
			(this.z = e),
	...
	function Lk(t, e, n, r, i) {
		...
		if (
			...
			for (u.sort(e), qk(s), qk(u), o = 0, a = u.length; o < a; ++o)
				u[o].e = n = !n;
			for (var l, c, f = s[0]; ; ) {
	...
	function Pk(t) {
		return Gb(t[0]) <= Pb ? t[0] : rw(t[0]) * (((Gb(t[0]) + Pb) % Wb) - Pb);
	}
	function jk(t, e, n, r) {
		return (i) => {
			var o,
								...
								if ((h = (f = t[l]).length))
									for (
										...
										if (
											...
											var S = Pw(o, F);
											Ww(S);
											var $ = (D ^ (A >= 0) ? -1 : 1) * sw(S[2]);
											(r > $ || (r === $ && (F[0] || F[1]))) &&
												(s += D ^ (A >= 0) ? 1 : -1);
										}
									}
							return (a < -Lb || (a < Lb && u < -qb)) ^ (1 & s);
						})(o, r);
						a.length
							? (f || (i.polygonStart(), (f = !0)), Lk(a, Wk, t, n, i))
							: t &&
	...
	function Wk(t, e) {
		return (
			((t = t.x)[0] < 0 ? t[1] - jb - Lb : jb - t[1]) -
			((e = e.x)[0] < 0 ? e[1] - jb - Lb : jb - e[1])
		);
	}
	Sk.invert = Sk;
	var Hk = jk(
		...
		function a(t, n, r) {
			...
			if (!(m < 0)) {
				...
				if (
					...
					M || A < Lb
						? M
							? (w + k > 0) ^ (v[1] < (Gb(v[0] - x) < Lb ? w : k))
							: w <= v[1] && v[1] <= k
						: (A > Pb) ^ (x <= v[0] && v[0] <= b))
				) {
					var E = Iw(d, (-p + y) / g);
					return jw(E, h), [v, Uw(E)];
				}
			}
		}
		function s(e, n) {
				...
				return {
					...
					point: (f, h) => {
						var d,
							p = [f, h],
							g = o(f, h),
							m = r ? (g ? 0 : s(f, h)) : g ? s(f + (f < 0 ? Pb : -Pb), h) : 0;
						if (
							(!e && (l = u = g) && t.lineStart(),
							g !== u && (!(d = a(e, p)) || Rk(e, d) || Rk(p, d)) && (p[2] = 1),
							g !== u)
						)
							(c = 0),
								g
				...
				!((t, e, n, r, i, o) => {
					if (n) {
						...
						for (var l, c = i; r > 0 ? c > o : c < o; c -= u)
							(l = Uw([a, -s * Jb(c), -s * nw(c)])), t.point(l[0], l[1]);
					}
				})(o, t, n, i, e, r);
			},
			r ? [0, -t] : [-Pb, t - Pb],
		...
		return (a) => {
			...
			function k(o, a) {
				...
				if ((l && c.push([o, a]), y))
					...
					var u = [
							(p = Math.max(Vk, Math.min(Gk, p))),
							(g = Math.max(Vk, Math.min(Gk, g))),
						],
						x = [
							(o = Math.max(Vk, Math.min(Gk, o))),
							(a = Math.max(Vk, Math.min(Gk, a))),
						];
					!((t, e, n, r, i, o) => {
						var a,
							s = t[0],
	...
	function Jk(t, e, n) {
		var r = Se(t, e - Lb, n).concat(e);
		return (t) => r.map((e) => [t, e]);
	}
	function Zk(t, e, n) {
		var r = Se(t, e - Lb, n).concat(e);
	...
	var Qk,
		...
		oA = {
			...
			lineEnd: uw,
			polygonStart: () => {
				(oA.lineStart = aA), (oA.lineEnd = lA);
			},
			polygonEnd: () => {
				(oA.lineStart = oA.lineEnd = oA.point = uw),
					rA.add(Gb(iA)),
					(iA = new se());
			},
			result: () => {
	...
	function sA(t, e) {
		(oA.point = uA), (Qk = tA = t), (Kk = eA = e);
	}
	function uA(t, e) {
		iA.add(eA * t - tA * e), (tA = t), (eA = e);
	}
	function lA() {
		uA(Qk, Kk);
	}
	...
	var gA,
		...
		CA = {
			...
			lineEnd: BA,
			polygonStart: () => {
				(CA.lineStart = zA), (CA.lineEnd = NA);
			},
			polygonEnd: () => {
				(CA.point = FA), (CA.lineStart = SA), (CA.lineEnd = BA);
			},
			result: () => {
				var t = DA
					? [MA / DA, EA / DA]
					: AA
						...
						: bA
							? [_A / bA, xA / bA]
							: [NaN, NaN];
				return (_A = xA = bA = wA = kA = AA = MA = EA = DA = 0), t;
			},
		};
	function FA(t, e) {
		(_A += t), (xA += e), ++bA;
	...
	function OA(t, e) {
		(CA.point = RA), FA((gA = yA = t), (mA = vA = e));
	}
	function RA(t, e) {
		var n = t - yA,
			r = e - vA,
			...
			switch (this._point) {
				...
				default:
					this._context.moveTo(t + this._radius, e),
						this._context.arc(t, e, this._radius, 0, Wb);
			}
		},
		result: uw,
	};
	...
	function YA(t, e) {
		(HA.point = GA), (qA = jA = t), (PA = IA = e);
	}
	function GA(t, e) {
		(jA -= t), (IA -= e), WA.add(iw(jA * jA + IA * IA)), (jA = t), (IA = e);
	}
	let VA, XA, JA, ZA;
	class QA {
		constructor(t) {
		...
		point(t, e) {
			switch (this._point) {
				...
				default:
					if (
						(this._append`M${t},${e}`,
						this._radius !== JA || this._append !== XA)
					) {
	...
	function tM(t, e) {
		...
		return (
			(a.area = (t) => (pw(t, n(oA)), oA.result())),
			(a.measure = (t) => (pw(t, n(HA)), HA.result())),
			(a.bounds = (t) => (pw(t, n(pA)), pA.result())),
			(a.centroid = (t) => (pw(t, n(CA)), CA.result())),
			(a.projection = function (e) {
				return arguments.length
					? ((n = null == e ? ((t = null), nA) : (t = e).stream), a)
					: t;
			}),
			(a.context = function (t) {
				return arguments.length
					? ((r = null == t ? ((e = null), new QA(i)) : new UA((e = t))),
		...
		return +e
			? ((t, e) => {
					function n(r, i, o, a, s, u, l, c, f, h, d, p, g, m) {
						...
						if (_ > 4 * e && g--) {
							var x = a + h,
								...
								A = sw((w /= k)),
								M =
									Gb(Gb(w) - 1) < Lb || Gb(o - f) < Lb ? (o + f) / 2 : Xb(b, x),
								E = t(M, A),
								D = E[0],
								C = E[1],
								F = D - r,
					...
					return (e) => {
						...
						function w() {
							n(c, f, l, h, d, p, i, o, r, a, s, u, uM, e),
								(g.lineEnd = _),
								_();
						}
						return g;
	...
	function hM(t, e, n, r, i, o) {
		if (!o)
			return ((t, e, n, r, i) => {
				...
				return (o.invert = (o, a) => [((o - e) / t) * r, ((n - a) / t) * i]), o;
			})(t, e, n, r, i);
		var a = Jb(o),
			s = nw(o),
			u = a * t,
		...
		return (
			(p.invert = (t, e) => [r * (c * t - f * e + h), i * (d - f * t - c * e)]),
			p
		);
	}
	function dM(t) {
	...
	function pM(t) {
		var e,
			...
			E = 0.5;
		function D(t) {
			return u(t[0] * Yb, t[1] * Yb);
		}
		function C(t) {
			return (t = u.invert(t[0], t[1])) && [t[0] * Hb, t[1] * Hb];
		}
		function F() {
			var t = hM(f, 0, 0, x, b, _).apply(null, e(p, g)),
				r = hM(f, h - t[0], d - t[1], x, b, _);
			return (
				(n = $k(m, y, v)), (s = Fk(e, r)), (u = Fk(n, s)), (a = cM(s, E)), S()
			);
		}
		function S() {
			return (l = c = null), D;
		...
		return (
			...
			(D.rotate = function (t) {
				return arguments.length
					? ((m = (t[0] % 360) * Yb),
						(y = (t[1] % 360) * Yb),
						(v = t.length > 2 ? (t[2] % 360) * Yb : 0),
						F())
					: [m * Hb, y * Hb, v * Hb];
			}),
			(D.angle = function (t) {
				return arguments.length ? ((_ = (t % 360) * Yb), F()) : _ * Hb;
			}),
			...
			(D.precision = function (t) {
				return arguments.length ? ((a = cM(s, (E = t * t))), S()) : iw(E);
			}),
			(D.fitExtent = (t, e) => iM(D, t, e)),
			(D.fitSize = (t, e) => oM(D, t, e)),
			(D.fitWidth = (t, e) => aM(D, t, e)),
			(D.fitHeight = (t, e) => sM(D, t, e)),
			function () {
	...
	function mM(t, e) {
		...
		if (Gb(r) < Lb)
			return ((t) => {
				...
				return (n.invert = (t, n) => [t / e, sw(n * e)]), n;
			})(t);
		var i = 1 + n * (2 * r - n),
			o = iw(i) / r;
		function a(t, e) {
			var n = iw(i - 2 * r * nw(e)) / r;
			return [n * nw((t *= r)), o - n * Jb(t)];
		}
		return (
			(a.invert = (t, e) => {
				var n = o - e,
					a = Xb(t, Gb(n)) * rw(n);
				return (
					n * r < 0 && (a -= Pb * rw(t) * rw(n)),
					[a / r, sw((i - (t * t + n * n) * r * r) / (2 * r))]
				);
			}),
			a
		);
	...
	function yM() {
		return gM(mM).scale(155.424).center([0, 33.6442]);
	}
	function vM() {
		return yM()
			.parallels([29.5, 45.5])
	...
	function _M(t) {
		return (e, n) => {
			var r = Jb(e),
				i = Jb(n),
				o = t(r * i);
			return o === 1 / 0 ? [2, 0] : [o * i * nw(e), o * nw(n)];
		};
	}
	function xM(t) {
		return (e, n) => {
			var r = iw(e * e + n * n),
				...
				o = nw(i),
				a = Jb(i);
			return [Xb(e * o, r * a), sw(r && (n * o) / r)];
		};
	}
	var bM = _M((t) => iw(2 / (1 + t)));
	bM.invert = xM((t) => 2 * sw(t / 2));
	var wM = _M((t) => (t = aw(t)) && t / nw(t));
	function kM(t, e) {
		return [t, tw(ow((jb + e) / 2))];
	}
	function AM(t) {
		var e,
			n,
		...
		function c() {
			var o = Pb * a(),
				s = i(
					((t) => {
						function e(e) {
							return ((e = t(e[0] * Yb, e[1] * Yb))[0] *= Hb), (e[1] *= Hb), e;
						}
						return (
							(t = $k(t[0] * Yb, t[1] * Yb, t.length > 2 ? t[2] * Yb : 0)),
							(e.invert = (e) => (
								((e = t.invert(e[0] * Yb, e[1] * Yb))[0] *= Hb), (e[1] *= Hb), e
							)),
							e
						);
					})(i.rotate()).invert([0, 0]),
	...
	function EM(t, e) {
		var n = Jb(t),
			r = t === e ? nw(t) : tw(n / Jb(e)) / tw(MM(e) / MM(t)),
			i = (n * ew(MM(t), r)) / r;
		if (!r) return kM;
		function o(t, e) {
			i > 0 ? e < -jb + Lb && (e = -jb + Lb) : e > jb - Lb && (e = jb - Lb);
			var n = i / ew(MM(e), r);
			return [n * nw(r * t), i - n * Jb(r * t)];
		}
		return (
			(o.invert = (t, e) => {
				var n = i - e,
	...
	function CM(t, e) {
		var n = Jb(t),
			r = t === e ? nw(t) : (n - Jb(e)) / (e - t),
			i = n / r + t;
		if (Gb(r) < Lb) return DM;
		function o(t, e) {
			var n = i - e,
				o = r * t;
			return [n * nw(o), i - n * Jb(o)];
		}
		return (
			(o.invert = (t, e) => {
				var n = i - e,
					o = Xb(t, Gb(n)) * rw(n);
				return (
					n * r < 0 && (o -= Pb * rw(t) * rw(n)),
					[o / r, i - rw(r) * iw(t * t + n * n)]
				);
			}),
			o
		);
	...
	function zM(t, e) {
		var n = sw(BM * nw(e)),
			...
			i = r * r * r;
		return [
			(t * Jb(n)) / (BM * (FM + 3 * SM * r + i * (7 * $M + 9 * TM * r))),
			n * (FM + SM * r + i * ($M + TM * r)),
		];
	}
	function NM(t, e) {
	...
	(zM.invert = (t, e) => {
		for (
			...
			((o =
				(i =
					(r -= n =
						(r * (FM + SM * i + o * ($M + TM * i)) - e) /
						(FM + 3 * SM * i + o * (7 * $M + 9 * TM * i))) * r) *
				i *
				i),
			!(Gb(n) < qb));
			++a
		...
		return [
			(BM * t * (FM + 3 * SM * i + o * (7 * $M + 9 * TM * i))) / Jb(r),
			sw(nw(r) / BM),
		];
	}),
		(NM.invert = xM(Vb)),
		...
		(RM.invert = xM(sw)),
		(UM.invert = xM((t) => 2 * Vb(t))),
		(LM.invert = (t, e) => [-e, 2 * Vb(Qb(t)) - jb]);
	var qM = Math.abs,
		PM = Math.cos,
		jM = Math.sin,
		IM = 1e-6,
		WM = Math.PI,
		HM = WM / 2,
		YM = ((t) => (t > 0 ? Math.sqrt(t) : 0))(2);
	function GM(t) {
		return t > 1 ? HM : t < -1 ? -HM : Math.asin(t);
	}
	function VM(t, e) {
		var n,
			r = t * jM(e),
	...
	var XM = ((t, e, n) => {
		function r(r, i) {
			return [t * r * PM((i = VM(n, i))), e * jM(i)];
		}
		return (
			(r.invert = (r, i) => (
				(i = GM(i / e)), [r / (t * PM(i)), GM((2 * i + jM(2 * i)) / n)]
			)),
			r
		);
	})(YM / HM, YM, WM);
	...
	const tE = {
		...
		albersusa: () => {
			var t,
				...
				o,
				a = vM(),
				s = yM().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
				u = yM().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
				l = {
					point: (t, e) => {
						o = [t, e];
					},
				...
				(c.translate = function (t) {
					...
					return (
						...
						(r = s
							...
							.clipExtent([
								[o - 0.425 * e + Lb, c + 0.12 * e + Lb],
								[o - 0.214 * e - Lb, c + 0.234 * e - Lb],
							])
							.stream(l)),
						(i = u
							.translate([o - 0.205 * e, c + 0.212 * e])
							.clipExtent([
								[o - 0.214 * e + Lb, c + 0.166 * e + Lb],
								[o - 0.115 * e - Lb, c + 0.234 * e - Lb],
							])
							.stream(l)),
						f()
					);
				}),
				(c.fitExtent = (t, e) => iM(c, t, e)),
				(c.fitSize = (t, e) => oM(c, t, e)),
				(c.fitWidth = (t, e) => aM(c, t, e)),
				(c.fitHeight = (t, e) => sM(c, t, e)),
				c.scale(1070)
			);
		},
		azimuthalequalarea: () => dM(bM).scale(124.75).clipAngle(179.999),
		azimuthalequidistant: () => dM(wM).scale(79.4188).clipAngle(179.999),
		conicconformal: () => gM(EM).scale(109.5).parallels([30, 30]),
		conicequalarea: yM,
		conicequidistant: () => gM(CM).scale(131.154).center([0, 13.9389]),
		equalEarth: () => dM(zM).scale(177.158),
		equirectangular: () => dM(DM).scale(152.63),
		gnomonic: () => dM(NM).scale(144.049).clipAngle(60),
		identity: () => {
			var t,
				e,
				n,
			...
			return (
				...
				(_.fitExtent = (t, e) => iM(_, t, e)),
				(_.fitSize = (t, e) => oM(_, t, e)),
				(_.fitWidth = (t, e) => aM(_, t, e)),
				(_.fitHeight = (t, e) => sM(_, t, e)),
				_
			);
		},
		mercator: () => AM(kM).scale(961 / Wb),
		mollweide: () => dM(XM).scale(169.529),
		naturalEarth1: () => dM(OM).scale(175.295),
		orthographic: () =>
			dM(RM)
				.scale(249.5)
				.clipAngle(90 + Lb),
		stereographic: () => dM(UM).scale(250).clipAngle(142),
		transversemercator: () => {
			var t = AM(LM),
				e = t.center,
				n = t.rotate;
	...
	function rE() {
			...
			return (
				((n, r, i) => {
					var a,
						...
						h = [],
						d = [];
					(a = s = -1), (l = n[0] >= r), nE[l << 1].forEach(p);
					for (; ++a < t - 1; )
						(u = l), (l = n[a + 1] >= r), nE[u | (l << 1)].forEach(p);
					nE[l << 0].forEach(p);
					for (; ++s < e - 1; ) {
						for (
							a = -1,
							...
							(u = l),
								...
								(f = c),
								(c = n[s * t + a + 1] >= r),
								nE[u | (l << 1) | (c << 2) | (f << 3)].forEach(p);
						nE[l | (c << 3)].forEach(p);
					}
					(a = -1), (c = n[s * t] >= r), nE[c << 2].forEach(p);
					for (; ++a < t - 1; )
						(f = c),
							(c = n[s * t + a + 1] >= r),
							nE[(c << 2) | (f << 3)].forEach(p);
					function p(t) {
						var e,
							n,
							r = [t[0][0] + a, t[0][1] + s],
				...
				s.forEach((t) => {
					for (var e, n = 0, r = a.length; n < r; ++n)
						if (-1 !== iE((e = a[n])[0], t)) return void e.push(t);
				}),
		...
		return (
			...
			(r.smooth = function (t) {
				return arguments.length ? ((n = t ? a : eE), r) : n === a;
			}),
			r
		);
	}
	...
	function lE(t, e, n, r, i) {
		...
		return (t) => (t.coordinates.forEach(u), t);
	}
	function cE(t, e, n) {
	...
	function hE() {
			...
			s.forEach((r) => {
				...
				l > 0 && c > 0
					? (dE(d, p, g, m, l),
						...
						pE(d, p, m, g, c))
					: l > 0
						? (dE(d, p, g, m, l), dE(d, p, m, g, l), dE(d, p, g, m, l), (y = m))
						: c > 0 &&
							(pE(d, p, g, m, c),
							pE(d, p, m, g, c),
							pE(d, p, g, m, c),
							(y = m));
			const v = u ? 2 ** (-2 * a) : 1 / $e(y);
		...
		return (
			(u.x = function (e) {
				return arguments.length ? ((t = fE(e)), u) : t;
			}),
			(u.y = function (t) {
				return arguments.length ? ((e = fE(t)), u) : e;
			}),
			(u.weight = function (t) {
				return arguments.length ? ((n = fE(t)), u) : n;
			}),
			(u.size = function (t) {
		...
		dt(uE, Ja, {
			transform(t, e) {
				...
				var n = e.fork(e.NO_SOURCE | e.NO_FIELDS),
					...
					i = t.field || f,
					o = rE().smooth(!1 !== t.smooth),
					a =
						t.thresholds ||
						((t, e, n) => {
							const r = sE(n.levels || 10, n.nice, !1 !== n.zero);
				...
				return (
					r.forEach((e) => {
						const n = i(e),
							r = o.size([n.width, n.height])(n.values, k(a) ? a : a(n.values));
						!((t, e, n, r) => {
	...
	const mE = ["x", "y", "weight", "size", "cellSize", "bandwidth"];
	function yE(t, e) {
		return mE.forEach((n) => (null != e[n] ? t[n](e[n]) : 0)), t;
	}
	function vE(t) {
		Ja.call(this, null, t);
	}
		...
		dt(vE, Ja, {
			transform(t, e) {
				...
				var n,
					...
					o = rE().smooth(!1 !== t.smooth),
					a = t.values,
					s = t.thresholds || sE(t.count || 10, t.nice, !!a),
					u = t.size;
				return (
					a ||
						((a = e.materialize(e.SOURCE).source),
	...
	function ME(t) {
		Ja.call(this, [], t),
			(this.generator = (() => {
				...
				function v() {
					return Se(Zb(r / p) * p, n, p)
						.map(c)
						.concat(Se(Zb(s / g) * g, a, g).map(f))
						.concat(
							Se(Zb(e / h) * h, t, h)
								.filter((t) => Gb(t % p) > Lb)
								.map(u),
				...
				return (
					(y.lines = () =>
						v().map((t) => ({ type: "LineString", coordinates: t }))),
					(y.outline = () => ({
						type: "Polygon",
						coordinates: [
							c(r).concat(
		...
		dt(wE, Ja, {
			transform(t, e) {
				var n = e.fork(e.ALL),
					...
					a = n.SOURCE;
				!r || t.modified()
					? ((this.value = r = KM(t.projection)), n.materialize().reflow())
				...
				return (
					(r && !t.modified()) ||
						((this.value = r =
							...
							})(KM(t.projection), t.field || l("datum"), t.pointRadius)),
		...
		dt(ME, Ja, {
			transform(t, e) {
				var n,
					r = this.value,
					i = this.generator;
				if (!r.length || t.modified()) for (const e in t) J(i[e]) && i[e](t[e]);
				return (
					(n = i()),
				...
				return (
					n.forEach((t) => {
						...
						r || (n.$max = we(e.values || [])),
							...
							})(e, n, a.dep ? a : rt(a(n)), o.dep ? o : rt(o(n))));
					}),
			...
			transform(t, e) {
				...
				return (
					!n || t.modified("type")
						? ((this.value = n =
								((t) => {
									const e = QM((t || "mercator").toLowerCase());
	...
	function NE(t, e, n) {
		var r = new OE(null == e ? BE : e, null == n ? zE : n, NaN, NaN, NaN, NaN);
	...
	var UE = (NE.prototype = OE.prototype);
	function LE(t) {
		return () => t;
	}
	function qE(t) {
	...
	(UE.copy = function () {
		var t,
			e,
			n = new OE(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
			r = this._root;
		if (!r) return n;
		...
		(UE.visit = function (t) {
			var e,
				...
				u = this._root;
			for (
				u && s.push(new TE(u, this._x0, this._y0, this._x1, this._y1));
				(e = s.pop());
			)
				if (
					...
					var l = (r + o) / 2,
						c = (i + a) / 2;
					(n = u[3]) && s.push(new TE(n, l, c, o, a)),
						(n = u[2]) && s.push(new TE(n, r, c, l, a)),
						(n = u[1]) && s.push(new TE(n, l, i, o, c)),
						(n = u[0]) && s.push(new TE(n, r, i, l, c));
				}
			return this;
		}),
		(UE.visitAfter = function (t) {
			...
			for (
				this._root &&
				n.push(new TE(this._root, this._x0, this._y0, this._x1, this._y1));
				(e = n.pop());
			) {
				var i = e.node;
				if (i.length) {
					var o,
						...
						c = (a + u) / 2,
						f = (s + l) / 2;
					(o = i[0]) && n.push(new TE(o, a, s, c, f)),
						(o = i[1]) && n.push(new TE(o, c, s, u, f)),
						(o = i[2]) && n.push(new TE(o, a, f, c, l)),
						(o = i[3]) && n.push(new TE(o, c, f, u, l));
				}
				r.push(e);
			}
	...
	GE.prototype = YE.prototype = {
		...
		on: function (t, e) {
			...
			if (!(arguments.length < 2)) {
				...
				for (; ++a < s; )
					if ((n = (t = o[a]).type)) i[n] = XE(i[n], t.name, e);
					else if (null == e) for (n in i) i[n] = XE(i[n], t.name, null);
				return this;
			}
			for (; ++a < s; )
				if ((n = (t = o[a]).type) && (n = VE(i[n], t.name))) return n;
		},
		copy: function () {
			var t = {},
				e = this._;
	...
	var JE,
		...
		rD = 0,
		iD = 0,
		oD = "object" == typeof performance && performance.now ? performance : Date,
		aD =
	...
	function fD() {
		(rD = (nD = oD.now()) + iD), (QE = KE = 0);
		try {
			!(() => {
				sD(), ++QE;
				for (var t, e = JE; e; )
					(t = rD - e._time) >= 0 && e._call.call(void 0, t), (e = e._next);
				--QE;
			})();
		} finally {
			(QE = 0),
	...
	function dD(t) {
		QE ||
			...
			t - rD > 24
				? (t < 1 / 0 && (KE = setTimeout(fD, t - oD.now() - iD)),
					tD && (tD = clearInterval(tD)))
				: (tD || ((nD = oD.now()), (tD = setInterval(hD, eD))),
					(QE = 1),
					aD(fD)));
	}
	lD.prototype = cD.prototype = {
		...
		restart: function (t, e, n) {
			...
			(n = (null == n ? sD() : +n) + (null == e ? 0 : +e)),
				this._next ||
					ZE === this ||
					(ZE ? (ZE._next = this) : (JE = this), (ZE = this)),
				(this._call = t),
				(this._time = n),
				dD();
		},
		stop: function () {
			this._call && ((this._call = null), (this._time = 1 / 0), dD());
		},
	};
	const pD = 1664525,
		gD = 1013904223,
	...
	const wD = {
			...
			collide: (t) => {
				...
				function a() {
					for (var t, a, u, l, c, f, h, d = e.length, p = 0; p < o; ++p)
						for (a = NE(e, PE, jE).visitAfter(s), t = 0; t < d; ++t)
							(u = e[t]),
								(f = n[u.index]),
								(h = f * f),
								(l = u.x + u.vx),
				...
				return (
					"function" != typeof t && (t = LE(null == t ? 1 : +t)),
					(a.initialize = (t, n) => {
						(e = t), (r = n), u();
					}),
					...
					(a.radius = function (e) {
						return arguments.length
							? ((t = "function" == typeof e ? e : LE(+e)), u(), a)
							: t;
					}),
					a
				);
			...
			nbody: () => {
				...
				return (
					...
					(l.strength = function (t) {
						return arguments.length
							? ((o = "function" == typeof t ? t : LE(+t)), c(), l)
							: o;
					}),
			...
			link: (t) => {
				...
				function f(r) {
					for (var i = 0, s = t.length; i < c; ++i)
						for (var u, l, f, h, d, p, g, m = 0; m < s; ++m)
							(l = (u = t[m]).source),
								(h = (f = u.target).x + f.vx - l.x - l.vx || qE(a)),
								(d = f.y + f.vy - l.y - l.vy || qE(a)),
								(h *= p =
				...
				function h() {
					if (r) {
						...
						for (a = 0, i = new Array(l); a < c; ++a)
							((u = t[a]).index = a),
								"object" != typeof u.source && (u.source = WE(f, u.source)),
								"object" != typeof u.target && (u.target = WE(f, u.target)),
				...
				return (
					...
					(f.strength = function (t) {
						return arguments.length
							? ((u = "function" == typeof t ? t : LE(+t)), d(), f)
							: u;
					}),
					(f.distance = function (t) {
						return arguments.length
							? ((l = "function" == typeof t ? t : LE(+t)), p(), f)
							: l;
					}),
					f
				);
			...
			x: (t) => {
				...
				return (
					"function" != typeof t && (t = LE(null == t ? 0 : +t)),
					(o.initialize = (t) => {
						(e = t), a();
					}),
					(o.strength = function (t) {
						return arguments.length
							? ((i = "function" == typeof t ? t : LE(+t)), a(), o)
							: i;
					}),
					(o.x = function (e) {
						return arguments.length
							? ((t = "function" == typeof e ? e : LE(+e)), a(), o)
							: t;
					}),
					o
				);
		...
		kD = "forces",
		AD = ["alpha", "alphaMin", "alphaTarget", "velocityDecay", "forces"],
		MD = ["static", "iterations"],
		ED = ["x", "y", "vx", "vy"];
	function DD(t) {
		Ja.call(this, null, t);
	}
	function CD(t, e, n, r) {
		var i,
			...
			s,
			u = V(e.forces);
		for (i = 0, o = AD.length; i < o; ++i)
			(a = AD[i]) !== kD && e.modified(a) && t[a](e[a]);
				...
				(a =
					n || e.modified(kD, i)
						...
						: r && FD(u[i], r)
							? t.force(s)
							: null) && t.force(s, a);
		for (o = t.numForces || 0; i < o; ++i) t.force(kD + i, null);
		return (t.numForces = u.length), t;
	}
	function FD(t, e) {
		var n, i;
		for (n in t) if (J((i = t[n])) && e.modified(r(i))) return 1;
		return 0;
	}
	function SD(t) {
		var e, n;
		for (n in (lt(wD, t.force) || s("Unrecognized force: " + t.force),
		(e = wD[t.force]()),
		t))
			J(e[n]) && $D(e[n], t[n], t);
		return e;
	...
	(DD.Definition = {
		...
		params: [
			...
			{ name: "as", type: "string", array: !0, modify: !1, default: ED },
		],
	}),
		dt(DD, Ja, {
			transform(t, e) {
				...
				if (
					(i
						...
						: ((this.value = i =
							...
							t.static || ((o = !0), i.tick()),
							e.modifies("index")),
					a || o || t.modified(MD) || (e.changed() && t.restart))
				)
					if (
						(i
							.alpha(Math.max(i.alpha(), t.alpha || 1))
							.alphaDecay(1 - i.alphaMin() ** (1 / s)),
						t.static)
					)
			...
			finish(t, e) {
				...
				for (let t, e = this._argops, s = 0, u = e.length; s < u; ++s)
					if (((t = e[s]), t.name === kD && "link" === t.op._argval.force))
						for (var r, i = t.op._argops, o = 0, a = i.length; o < a; ++o)
							if ("links" === i[o].name && (r = i[o].op.source)) {
								n.pulse(r, n.changeset().reflow());
								break;
							}
				return e.reflow(t.modified()).modifies(ED);
			},
		});
	var TD = Object.freeze({ __proto__: null, force: DD });
	function BD(t, e) {
	...
	function RD(t, e) {
		t instanceof Map
			? ((t = [void 0, t]), void 0 === e && (e = LD))
			: void 0 === e && (e = UD);
		for (var n, r, i, o, a, s = new jD(t), u = [s]; (n = u.pop()); )
			if ((i = e(n.data)) && (a = (i = Array.from(i)).length))
				for (n.children = i, o = a - 1; o >= 0; --o)
					u.push((r = i[o] = new jD(i[o]))),
						(r.parent = n),
						(r.depth = n.depth + 1);
		return s.eachBefore(PD);
	}
	function UD(t) {
		return t.children;
	}
	...
	jD.prototype = RD.prototype = {
		...
		links: function () {
			...
			return (
				this.each((n) => {
					n !== this && e.push({ source: n.parent, target: n });
				}),
				e
			);
		},
		copy: function () {
			return RD(this).eachBefore(qD);
		},
	...
	function JD(t, e) {
		...
		for (n = 0; n < t.length; ++n)
			if (ZD(e, t[n]) && KD(eC(t[n], e), t)) return [t[n], e];
	...
	function KD(t, e) {
		for (var n = 0; n < e.length; ++n) if (!QD(t, e[n])) return !1;
		return !0;
	}
	function tC(t) {
		switch (t.length) {
	...
	function sC(t, e) {
		if (
			!(o = (t = ((t) =>
				"object" == typeof t && "length" in t ? t : Array.from(t))(t)).length)
		)
			return 0;
		...
		t: for (u = 3; u < o; ++u) {
			...
			for (
				i.previous = n, i.next = r, n.next = r.previous = r = i, a = oC(n);
				(i = i.next) !== r;
			)
				(s = oC(i)) < a && ((n = i), (a = s));
			r = n.next;
		...
		for (
			i = ((t, e) => {
				for (
					...
					(n = t[i]), r && QD(r, n) ? ++i : ((r = tC((a = JD(a, n)))), (i = 0));
				return r;
			})(n, e),
				u = 0;
			u < o;
	...
	function cC(t, e, n) {
		return (r) => {
			if ((i = r.children)) {
				...
				if (((a = sC(i, n)), u)) for (o = 0; o < s; ++o) i[o].r -= u;
				r.r = a + u;
			}
		};
	}
	...
	function _C() {
		...
		function r(r) {
			...
			if (null != t) {
				const e = h.map((e, n) =>
						((t) => {
							t = `${t}`;
							const e = t.length;
							bC(t, e - 1) && !bC(t, e - 2) && (t = t.slice(0, -1));
							return "/" === t[0] ? t : `/${t}`;
						})(t(e, n, r)),
					),
					n = e.map(xC),
					i = new Set(e).add("");
				for (const t of n)
					i.has(t) || (i.add(t), e.push(t), n.push(xC(t)), h.push(mC));
				(d = (t, n) => e[n]), (p = (t, e) => n[e]);
			}
			...
			if (null != t) {
				for (; s.data === mC && 1 === s.children.length; )
					(s = s.children[0]), --i;
				for (let t = h.length - 1; t >= 0 && (l = h[t]).data === mC; --t)
					l.data = null;
			}
			if (
				((s.parent = pC),
		...
		return (
			(r.id = function (t) {
				return arguments.length ? ((e = ID(t)), r) : e;
			}),
			(r.parentId = function (t) {
				return arguments.length ? ((n = ID(t)), r) : n;
			}),
			(r.path = function (e) {
				return arguments.length ? ((t = ID(e)), r) : t;
			}),
			r
		);
	}
	...
	DC.prototype = Object.create(jD.prototype);
	var FC = (1 + Math.sqrt(5)) / 2;
	function SC(t, e, n, r, i, o) {
		for (
			...
			y.push((a = { value: c, dice: u < l, children: v.slice(_, x) })),
				a.dice
					? dC(a, n, r, i, w ? (r += (l * c) / w) : o)
					: CC(a, n, r, w ? (n += (u * c) / w) : i, o),
				(w -= c),
				(_ = x);
		}
		return y;
	...
	var $C = (function t(e) {
		...
		return (n.ratio = (e) => t((e = +e) > 1 ? e : 1)), n;
	})(FC);
	var TC = (function t(e) {
		function n(t, n, r, i, o) {
			if ((a = t._squarify) && a.ratio === e)
				for (var a, s, u, l, c, f = -1, h = a.length, d = t.value; ++f < h; ) {
					for (
						...
						s.value += u[l].value;
					s.dice
						? dC(s, n, r, i, d ? (r += ((o - r) * s.value) / d) : o)
						: CC(s, n, r, d ? (n += ((i - n) * s.value) / d) : i, o),
						(d -= s.value);
				}
			else (t._squarify = a = SC(e, t, n, r, i, o)), (a.ratio = e);
		}
		return (n.ratio = (e) => t((e = +e) > 1 ? e : 1)), n;
	})(FC);
	function BC(t, e, n) {
	...
	(qC.Definition = {
		...
		params: [
			...
			{ name: "as", type: "string", array: !0, length: LC.length, default: LC },
		],
	}),
		dt(qC, RC, {
			layout: () => {
				...
				function i(i) {
					...
					return (
						...
						t
							? i
									.eachBefore(lC(t))
									.eachAfter(cC(r, 0.5, o))
									.eachBefore(fC(1))
							: i
									.eachBefore(lC(uC))
									.eachAfter(cC(HD, 1, o))
									.eachAfter(cC(r, i.r / Math.min(e, n), o))
									.eachBefore(fC(Math.min(e, n) / (2 * i.r))),
						i
					);
				}
				return (
					(i.radius = function (e) {
						return arguments.length ? ((t = ID(e)), i) : t;
					}),
					(i.size = function (t) {
	...
	const PC = ["x0", "y0", "x1", "y1", "depth", "children"];
	function jC(t) {
		RC.call(this, t);
	}
	function IC(t) {
	...
	(jC.Definition = {
		...
		params: [
			...
			{ name: "size", type: "number", array: !0, length: 2 },
			{ name: "as", type: "string", array: !0, length: PC.length, default: PC },
		],
	}),
		dt(jC, RC, {
			layout: () => {
		...
		dt(IC, Ja, {
			transform(t, e) {
				...
				return (
					...
					o &&
						(n = i.source.length
							? BC(_C().id(t.key).parentId(t.parentKey)(i.source), t.key, p)
							: BC(_C()([{}]), t.key, t.key)),
	...
	const WC = {
			tidy: () => {
				...
				function i(i) {
					var u = ((t) => {
						for (var e, n, r, i, o, a = new DC(t, 0), s = [a]; (e = s.pop()); )
							if ((r = e._.children))
								for (
									...
									s.push((n = e.children[i] = new DC(r[i], i))), (n.parent = e);
						return ((a.parent = new DC(null, 0)).children = [a]), a;
					})(i);
							...
							for (
								...
								(u = kC(u)),
									...
									(i = s.z + f - o.z - l + t(s._, o._)) > 0 &&
										(MC(EC(s, e, r), e, i), (l += i), (c += i)),
									(f += s.m),
									(l += o.m),
									(h += u.m),
									(c += a.m);
							s && !AC(a) && ((a.t = s), (a.m += f - c)),
								o && !kC(u) && ((u.t = o), (u.m += l - h), (r = e));
						}
						return r;
					})(e, i, e.parent.A || r[0]);
				}
			...
			cluster: () => {
				...
				function i(i) {
					...
					i.eachAfter((e) => {
						var n = e.children;
						n
							? ((e.x = ((t) => t.reduce(zD, 0) / t.length)(n)),
								(e.y = ((t) => 1 + t.reduce(ND, 0))(n)))
	...
	(YC.Definition = {
		...
		params: [
			...
			{ name: "as", type: "string", array: !0, length: HC.length, default: HC },
		],
	}),
		dt(YC, RC, {
			layout(t) {
				const e = t || "tidy";
				if (lt(WC, e)) return WC[e]();
	...
	const VC = {
			...
			slice: CC,
			slicedice: (t, e, n, r, i) => {
				(1 & t.depth ? CC : dC)(t, e, n, r, i);
			},
			squarify: $C,
			resquarify: TC,
		},
		XC = ["x0", "y0", "x1", "y1", "depth", "children"];
	function JC(t) {
		RC.call(this, t);
	}
	(JC.Definition = {
		...
		params: [
			...
			{ name: "round", type: "boolean", default: !1 },
			{ name: "size", type: "number", array: !0, length: 2 },
			{ name: "as", type: "string", array: !0, length: XC.length, default: XC },
		],
	}),
		dt(JC, RC, {
			layout() {
				const t = (() => {
					...
					return (
						...
						(c.tile = function (e) {
							return arguments.length ? ((t = WD(e)), c) : t;
						}),
						...
						(c.paddingTop = function (t) {
							return arguments.length
								? ((a = "function" == typeof t ? t : YD(+t)), c)
								: a;
						}),
						(c.paddingRight = function (t) {
							return arguments.length
								? ((s = "function" == typeof t ? t : YD(+t)), c)
								: s;
						}),
						(c.paddingBottom = function (t) {
							return arguments.length
								? ((u = "function" == typeof t ? t : YD(+t)), c)
								: u;
						}),
						(c.paddingLeft = function (t) {
							return arguments.length
								? ((l = "function" == typeof t ? t : YD(+t)), c)
								: l;
						}),
						c
					);
	...
	function tF(t, e, n) {
		...
		"group" === r
			? e.forEach((e) => {
					e.items.forEach((e) => tF(t, e.items, n));
				})
			: Hy[r].draw(t, { items: n ? e.map(eF) : e });
	}
	function eF(t) {
		const e = ba(t, {});
	...
	const nF = 5,
		rF = 31,
		iF = 32,
		oF = new Uint32Array(iF + 1),
		aF = new Uint32Array(iF + 1);
	(aF[0] = 0), (oF[0] = ~aF[0]);
	for (let t = 1; t <= iF; ++t)
		(aF[t] = (aF[t - 1] << 1) | 1), (oF[t] = ~aF[t]);
	function sF(t, e, n) {
		...
		return (
			...
			(a.bitmap = () =>
				((t, e) => {
					const n = new Uint32Array(~~((t * e + iF) / iF));
					function r(t, e) {
						n[t] |= e;
					}
					function i(t, e) {
						...
						getRange: (e, r, i, o) => {
							...
							for (; c >= r; --c)
								if (
									...
									if (n[u] & oF[a & rF] & aF[1 + (s & rF)]) return !0;
								} else {
									if (n[u] & oF[a & rF]) return !0;
						...
						setRange: (e, n, i, o) => {
							...
							for (; n <= o; ++n)
								if (
									...
									r(u, oF[a & rF] & aF[1 + (s & rF)]);
								else
									for (
										r(u, oF[a & rF]), r(l, aF[1 + (s & rF)]), c = u + 1;
										c < l;
										++c
									)
										r(c, 4294967295);
						...
						clearRange: (e, n, r, o) => {
							...
							for (; n <= o; ++n)
								if (
									...
									i(u, aF[a & rF] | oF[1 + (s & rF)]);
								else
									for (
										i(u, aF[a & rF]), i(l, oF[1 + (s & rF)]), c = u + 1;
										c < l;
										++c
									)
										i(c, 0);
	...
	const cF = [-1, -1, 1, 1],
		fF = [-1, 1, -1, 1];
	const hF = ["right", "center", "left"],
		dF = ["bottom", "middle", "top"];
	function pF(t, e, n, r, i, o, a, s, u, l, c, f) {
			...
			naive: (t, e, n, r) => {
				...
				return (t) => {
					const e = t.datum.datum.items[r].items,
						n = e.length,
						a = t.datum.fontSize,
						s = My.width(t.datum, t.datum.text);
					let u,
						l,
						c,
						f,
			...
			"reduced-search": (t, e, n, r) => {
				...
				function u(e, n, r, u, l) {
					...
					if (
						!uF(c, f, u, l, i, o) &&
						!lF(t, c, f, l, u, d, a, s) &&
						!lF(t, c, f, l, u, l, a, null)
					) {
						for (; p - d >= 1; )
							(h = (d + p) / 2), lF(t, c, f, l, u, h, a, s) ? (p = h) : (d = h);
				...
				return (e) => {
					const s = e.datum.datum.items[r].items,
						l = s.length,
						c = e.datum.fontSize,
						f = My.width(e.datum, e.datum.text);
					let h,
						d,
						p,
						g,
			...
			floodfill: (t, e, n, r) => {
				...
				return (e) => {
					const l = e.datum.datum.items[r].items,
						c = l.length,
						f = e.datum.fontSize,
						h = My.width(e.datum, e.datum.text),
						d = [];
					let p,
						g,
						m,
						...
						for (
							...
							if (
								...
								if (
									...
									!uF(v, _, h, f, i, o) &&
										!lF(t, v, _, f, h, w, a, s) &&
										!lF(t, v, _, f, h, f, a, null))
								) {
									for (; k - w >= 1; )
										(A = (w + k) / 2),
											lF(t, v, _, f, h, A, a, s) ? (k = A) : (w = A);
	...
	function yF(t, e, n, r, i, o, a, s, u, l, c) {
		...
		let b = -1,
			w = -1;
		const k = t.map((t) => {
			const e = v ? My.width(t, t.text) : void 0;
			return (
				(b = Math.max(b, e)),
			...
			M =
				o.length || r
					? ((t, e, n, r, i) => {
							...
							n.forEach((t) => tF(u, t, !1)), tF(l, e, !1), s && tF(c, e, !0);
							const f = KC(u, o, a),
								h = KC(l, o, a),
								d = s && KC(c, o, a),
								p = t.bitmap(),
					...
					return (e) => {
						...
						for (let i = 0; i < u; ++i) {
							if (
								...
								if (!pF(w, w, A, M, a, s, 0, 0, 0, 0, 0, d)) continue;
								E = My.width(e.datum, e.datum.text);
							}
							if (
								((x = m + (g * E * f) / 2),
								(m = x - E / 2),
	...
	const vF = ["x", "y", "opacity", "align", "baseline"],
		_F = [
			"top-left",
			"left",
			"bottom-left",
	...
	(xF.Definition = {
		...
		params: [
			{ name: "size", type: "number", array: !0, length: 2, required: !0 },
			{ name: "sort", type: "compare" },
			{ name: "anchor", type: "string", array: !0, default: _F },
			...
			{ name: "as", type: "string", array: !0, length: vF.length, default: vF },
		],
	}),
		dt(xF, Ja, {
			transform(t, e) {
	...
	var bF = Object.freeze({ __proto__: null, label: xF });
	function wF(t, e) {
		var n,
			r,
			i,
	...
	(kF.Definition = {
		...
		dt(kF, Ja, {
			transform(t, e) {
				const r = e.fork(e.NO_SOURCE | e.NO_FIELDS);
				if (!this.value || e.changed() || t.modified()) {
					const i = wF(e.materialize(e.SOURCE).source, t.groupby),
						o = (t.groupby || []).map(n),
						a = o.length,
						s = t.as || [n(t.x), n(t.y)],
						u = [];
					i.forEach((e) => {
						Ls(e, t.x, t.y, t.bandwidth || 0.3).forEach((t) => {
							const n = {};
			...
			transform(t, e) {
				...
				if (!this.value || e.changed() || t.modified()) {
					const i = wF(e.materialize(e.SOURCE).source, t.groupby),
						...
						h = [];
					let d = t.extent;
					lt(AF, a) || s("Invalid regression method: " + a),
						null != d &&
							"log" === a &&
							d[0] <= 0 &&
							(e.dataflow.warn(
	...
	var EF = Object.freeze({ __proto__: null, loess: kF, regression: MF });
	const DF = 134217729,
		CF = 33306690738754706e-32;
		...
		return Math.abs(u) >= 33306690738754716e-32 * l
			...
			: -((t, e, n, r, i, o, a) => {
					...
					(x = s * c),
						...
						(RF[2] = v - (A - f) + (y - f)),
						(RF[3] = A);
					const B = FF(T, NF, 4, RF, OF);
					return OF[B - 1];
				})(t, e, n, r, i, o, l);
	}
	const LF = 2 ** -52,
		qF = new Uint32Array(512);
	class PF {
		static from(t) {
			const e =
					arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : GF,
				n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : VF;
			const r = t.length,
		...
		update() {
			...
			for (let e = 0; e < o; e++) {
				if (e === h || e === d) continue;
				const n = WF(m, y, v, _, t[2 * e], t[2 * e + 1]);
				n < x && ((p = e), (x = n));
			}
			let b = t[2 * p],
				w = t[2 * p + 1];
			if (x === 1 / 0) {
				...
				HF(this._ids, this._dists, 0, o - 1);
			...
			for (let e = 0; e < o; e++)
				this._dists[e] = jF(t[2 * e], t[2 * e + 1], k.x, k.y);
			HF(this._ids, this._dists, 0, o - 1), (this._hullStart = h);
			let A = 3;
			(n[h] = e[p] = d),
				(n[d] = e[h] = p),
				(n[p] = e[d] = h),
			...
			for (let o, a, s = 0; s < this._ids.length; s++) {
				const u = this._ids[s],
					l = t[2 * u],
					c = t[2 * u + 1];
				if (s > 0 && Math.abs(l - o) <= LF && Math.abs(c - a) <= LF) continue;
	...
	function HF(t, e, n, r) {
		if (r - n <= 20)
			...
			let i = n + 1,
				o = r;
			YF(t, (n + r) >> 1, i),
				e[t[n]] > e[t[r]] && YF(t, n, r),
				e[t[i]] > e[t[r]] && YF(t, i, r),
				e[t[n]] > e[t[i]] && YF(t, n, i);
			const a = t[i],
				s = e[a];
			for (;;) {
				do {
			...
			(t[n + 1] = t[o]),
				(t[o] = a),
				r - i + 1 >= o - n
					? (HF(t, e, i, r), HF(t, e, n, o - 1))
					: (HF(t, e, n, o - 1), HF(t, e, i, r));
		}
	}
	function YF(t, e, n) {
		const r = t[e];
	...
	class JF {
		...
		arc(t, e, n) {
			...
			null === this._x1
				? (this._ += `M${r},${i}`)
				: (Math.abs(this._x1 - r) > XF || Math.abs(this._y1 - i) > XF) &&
					(this._ += "L" + r + "," + i),
				n &&
	...
	const QF = class {
		...
		render(t) {
			const e = null == t ? (t = new JF()) : void 0,
				{
		...
		renderCell(t, e) {
			const n = null == e ? (e = new JF()) : void 0,
				r = this._clip(t);
	...
	class iS {
		static from(t) {
			const e =
					arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : eS,
				n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : nS,
		...
		_init() {
			...
			if (
				...
				for (let t = 0, n = e.length / 2; t < n; ++t) {
					const n = rS(e[2 * t], e[2 * t + 1], i);
					(e[2 * t] = n[0]), (e[2 * t + 1] = n[1]);
				}
				this._delaunator = new PF(e);
		...
		*neighbors(t) {
		...
		_step(t, e, n) {
			...
			let l = t,
				c = tS(e - u[2 * t], 2) + tS(n - u[2 * t + 1], 2);
			const f = r[t];
			let h = f;
			do {
				const r = s[h];
				const f = tS(e - u[2 * r], 2) + tS(n - u[2 * r + 1], 2);
				if (
					(f < c && ((c = f), (l = r)),
					(h = h % 3 == 2 ? h - 2 : h + 1),
					s[h] !== t)
				...
				if (((h = a[h]), -1 === h)) {
					if (
						((h = i[(o[t] + 1) % i.length]),
						h !== r && tS(e - u[2 * h], 2) + tS(n - u[2 * h + 1], 2) < c)
					)
						return h;
					break;
				}
		...
		renderPoints(t, e) {
			void 0 !== e ||
				...
				((e = t), (t = null)),
				(e = null == e ? 2 : +e);
			const n = null == t ? (t = new JF()) : void 0,
				{ points: r } = this;
			for (let n = 0, i = r.length; n < i; n += 2) {
				const i = r[n],
					o = r[n + 1];
				t.moveTo(i + e, o), t.arc(i, o, e, 0, KF);
			}
			return n && n.value();
		}
		renderHull(t) {
		...
		transform(t, e) {
			...
			i = i
				...
				: (i = t.extent)
					...
					: aS;
			const o = (this.value = iS.from(r, t.x, t.y).voronoi(i));
	...
	var uS = Object.freeze({ __proto__: null, voronoi: oS }),
		lS = Math.PI / 180,
		cS = 64,
		fS = 2048;
	function hS() {
		...
		return (
			...
			(f.font = function (t) {
				return arguments.length ? ((e = vS(t)), f) : e;
			}),
			(f.fontStyle = function (t) {
				return arguments.length ? ((r = vS(t)), f) : r;
			}),
			(f.fontWeight = function (t) {
				return arguments.length ? ((i = vS(t)), f) : i;
			}),
			(f.rotate = function (t) {
				return arguments.length ? ((o = vS(t)), f) : o;
			}),
			(f.text = function (e) {
				return arguments.length ? ((t = vS(e)), f) : t;
			}),
			(f.spiral = function (t) {
				return arguments.length ? ((u = _S[t] || t), f) : u;
			}),
			(f.fontSize = function (t) {
				return arguments.length ? ((n = vS(t)), f) : n;
			}),
			(f.padding = function (t) {
				return arguments.length ? ((a = vS(t)), f) : a;
			}),
			(f.random = function (t) {
				return arguments.length ? ((c = t), f) : c;
			}),
		...
		if (!e.sprite) {
			...
			for (--r; ++r < p; ) {
				if (
					...
					var g = Math.sin(e.rotate * lS),
						m = Math.cos(e.rotate * lS),
						y = a * m,
						v = a * g,
						_ = u * m,
						x = u * g;
				...
				if (
					(u > d && (d = u),
					f + a >= cS << 5 && ((f = 0), (h += d), (d = 0)),
					h + u >= fS)
				)
					break;
				i.translate((f + (a >> 1)) / o, (h + (u >> 1)) / o),
					e.rotate && i.rotate(e.rotate * lS),
			...
			for (
				var b = i.getImageData(0, 0, (cS << 5) / o, fS / o).data, w = [];
				--r >= 0;
			)
				if ((e = n[r]).hasText) {
	...
	const xS = ["x", "y", "font", "fontSize", "fontStyle", "fontWeight", "angle"],
		bS = ["text", "font", "rotate", "fontSize", "fontStyle", "fontWeight"];
	function wS(t) {
		Ja.call(this, hS(), t);
	}
	(wS.Definition = {
		...
		params: [
			...
			{ name: "as", type: "string", array: !0, length: 7, default: xS },
		],
	}),
		dt(wS, Ja, {
			transform(e, n) {
				...
				if (
					!(
						...
						bS.some((t) => {
							const r = e[t];
							return J(r) && n.modified(r.fields);
						})
					)
				)
					return;
				...
				let u,
					l = e.fontSize || 14;
				if ((J(l) ? (u = e.fontSizeRange) : (l = rt(l)), u)) {
					const t = l,
						e = ap("sqrt")().domain(at(i, t)).range(u);
					l = (n) => e(t(n));
				}
				i.forEach((t) => {
	...
	var kS = Object.freeze({ __proto__: null, wordcloud: wS });
	const AS = (t) => new Uint8Array(t),
		MS = (t) => new Uint16Array(t),
		ES = (t) => new Uint32Array(t);
	function DS(t, e, n) {
		const r = (e < 257 ? AS : e < 65537 ? MS : ES)(t);
		return n && r.set(n), r;
	}
	function CS(t, e, n) {
		const r = 1 << e;
		return {
			...
			size: t.size,
			onAdd(t, e) {
				const i = this.bisect(this.range, t.value),
					o = t.index,
					a = i[0],
					s = i[1],
					u = o.length;
		...
		Ja.call(
			...
			(() => {
				...
				return {
					...
					seen: () =>
						(n = ((t, e, n) =>
							t.length >= e ? t : ((n = n || new t.constructor(e)).set(t), n))(
							n,
							e.length,
						)),
					add(t) {
					...
					resize(e, n) {
						(e > r.length || n > t) &&
							((t = Math.max(n, t)), (r = DS(e, t, r)), (i = DS(e, t)));
					},
				};
			})(),
			t,
		...
		dt(SS, Ja, {
			...
			init(t, e) {
				...
				let s,
					...
					l = 0;
				for (; l < a; ++l)
					(s = n[l].fname), (u = i[s] || (i[s] = FS())), o.push(CS(u, l, r[l]));
				...
				for (b = 0; b < d; ++b)
					(k = r[b]),
						(!a[b] || t.modified("fields", b) || e.modified(k.fields)) &&
							((y = k.fname),
							(g = p[y]) ||
								((o[y] = m = FS()), (p[y] = g = m.insert(k, e.source, 0))),
							(a[b] = CS(m, b, i[b]).onAdd(g, u)));
	...
	((WS = {})[XS] = "Boolean"),
		...
		(WS[e$] = "Punctuator"),
		(WS[n$] = "String"),
		(WS[9] = "RegularExpression");
	var r$ = "ArrayExpression",
		i$ = "BinaryExpression",
		o$ = "CallExpression",
		...
		b$ = "Invalid regular expression: missing /",
		w$ = "Octal literals are not allowed in strict mode.",
		k$ = "Duplicate data property in object literal not allowed in strict mode",
		A$ = "ILLEGAL",
		M$ = "Disabled.",
		E$ =
	...
	function z$(t) {
		return (
			...
			(t >= 97 && t <= 122) ||
			92 === t ||
			(t >= 128 && E$.test(String.fromCharCode(t)))
		);
	}
	function N$(t) {
		return (
	...
	function q$() {
		...
		for (
			t = HS.charCodeAt(YS++),
				...
				92 === t &&
					(117 !== HS.charCodeAt(YS) && tT({}, p$, A$),
					++YS,
					((t = U$("u")) && "\\" !== t && z$(t.charCodeAt(0))) ||
						tT({}, p$, A$),
					(e = t));
			YS < GS && N$((t = HS.charCodeAt(YS)));
		)
			++YS,
				(e += String.fromCharCode(t)),
				92 === t &&
			...
			(e =
				92 === HS.charCodeAt(YS)
					...
					: (() => {
							var t, e;
							for (t = YS++; YS < GS; ) {
								if (92 === (e = HS.charCodeAt(YS))) return (YS = t), q$();
								if (!N$(e)) break;
								++YS;
							}
							return HS.slice(t, YS);
						})()),
			{
				type:
					1 === e.length
	...
	function j$() {
		...
		switch (o) {
			...
			case 126:
				return (
					++YS, { type: e$, value: String.fromCharCode(o), start: i, end: YS }
				);
			default:
				if (61 === (t = HS.charCodeAt(YS + 1)))
					switch (o) {
						case 43:
						case 45:
						case 47:
						...
						case 61:
							return (
								(YS += 2),
								61 === HS.charCodeAt(YS) && ++YS,
								{ type: e$, value: HS.slice(i, YS), start: i, end: YS }
							);
					}
		}
		return ">>>=" === (r = HS.substr(YS, 4))
			? { type: e$, value: r, start: i, end: (YS += 4) }
			: ">>>" === (n = r.substr(0, 3)) || "<<=" === n || ">>=" === n
				? { type: e$, value: n, start: i, end: (YS += 3) }
				: (a === (e = n.substr(0, 2))[1] && "+-<>&|".includes(a)) || "=>" === e
					? { type: e$, value: e, start: i, end: (YS += 2) }
					: ("//" === e && tT({}, p$, A$),
						"<>=!+-*%&|^/".includes(a)
							? (++YS, { type: e$, value: a, start: i, end: YS })
							: void tT({}, p$, A$));
	}
	function I$() {
		var t, e, n;
		if (
			...
			if (((t = HS[YS++]), (n = HS[YS]), "0" === t)) {
				if ("x" === n || "X" === n)
					return (
						++YS,
						((t) => {
							let e = "";
							for (; YS < GS && S$(HS[YS]); ) e += HS[YS++];
							return (
								0 === e.length && tT({}, p$, A$),
								z$(HS.charCodeAt(YS)) && tT({}, p$, A$),
								{ type: t$, value: parseInt("0x" + e, 16), start: t, end: YS }
							);
						})(e)
					);
				if ($$(n))
					return ((t) => {
						let e = "0" + HS[YS++];
						for (; YS < GS && $$(HS[YS]); ) e += HS[YS++];
						return (
							(z$(HS.charCodeAt(YS)) || F$(HS.charCodeAt(YS))) &&
								tT({}, p$, A$),
							{ type: t$, value: parseInt(e, 8), octal: !0, start: t, end: YS }
						);
					})(e);
				n && F$(n.charCodeAt(0)) && tT({}, p$, A$);
			}
			for (; F$(HS.charCodeAt(YS)); ) t += HS[YS++];
			n = HS[YS];
		}
		if ("." === n) {
			for (t += HS[YS++]; F$(HS.charCodeAt(YS)); ) t += HS[YS++];
			n = HS[YS];
		}
		if ("e" === n || "E" === n)
			if (
		...
		return (
			z$(HS.charCodeAt(YS)) && tT({}, p$, A$),
			{ type: t$, value: parseFloat(t), start: e, end: YS }
		);
	}
	function W$() {
		var t, e, n, r;
		return (
			...
			(e = (() => {
				...
				for (
					...
					if (((e += t = HS[YS++]), "\\" === t))
						B$((t = HS[YS++]).charCodeAt(0)) && tT({}, b$), (e += t);
					else if (B$(t.charCodeAt(0))) tT({}, b$);
					else if (n) "]" === t && (n = !1);
					else {
						if ("/" === t) {
							r = !0;
				...
				return (
					r || tT({}, b$), { value: e.substr(1, e.length - 2), literal: e }
				);
			})()),
			(n = (() => {
				var t, e, n;
				for (e = "", n = ""; YS < GS && N$((t = HS[YS]).charCodeAt(0)); )
					++YS, "\\" === t && YS < GS ? tT({}, p$, A$) : ((n += t), (e += t));
				return (
					n.search(/[^gimuy]/g) >= 0 && tT({}, x$, n), { value: n, literal: e }
				);
			})()),
			(r = ((t, e) => {
				let n = t;
	...
	function H$() {
		if ((R$(), YS >= GS)) return { type: JS, start: YS, end: YS };
		const t = HS.charCodeAt(YS);
		return z$(t)
			? P$()
			: 40 === t || 41 === t || 59 === t
					...
					? (() => {
							...
							for (
								...
								if ("\\" === n)
									...
									if (B$(n.charCodeAt(0))) break;
									i += n;
								}
							}
							return (
								"" !== t && tT({}, p$, A$),
								{ type: n$, value: i, octal: o, start: e, end: YS }
							);
						})()
					: 46 === t
						? F$(HS.charCodeAt(YS + 1))
							? I$()
							: j$()
						: F$(t)
							? I$()
	...
	function Y$() {
		const t = VS;
		return (YS = t.end), (VS = H$()), (YS = t.end), t;
	}
	function G$() {
		const t = YS;
		(VS = H$()), (YS = t);
	...
	function tT(t, e) {
		var n,
			...
			i = e.replace(
				/%(\d)/g,
				(t, e) => (
					C$(e < r.length, "Message reference must be in range"), r[e]
				),
			);
		throw (((n = new Error(i)).index = YS), (n.description = i), n);
	}
	function eT(t) {
		t.type === JS && tT(t, _$),
			t.type === t$ && tT(t, g$),
	...
	function nT(t) {
		const e = Y$();
		(e.type === e$ && e.value === t) || eT(e);
	}
	function rT(t) {
		return VS.type === e$ && VS.value === t;
	}
	function iT(t) {
		return VS.type === QS && VS.value === t;
	}
	function oT() {
		const t = [];
		for (YS = VS.start, nT("["); !rT("]"); )
			rT(",") ? (Y$(), t.push(null)) : (t.push(yT()), rT("]") || nT(","));
		return (
			Y$(),
			((t) => {
				const e = new IS(r$);
	...
	function uT() {
		var t,
			...
			i = String;
		for (YS = VS.start, nT("{"); !rT("}"); )
			(e = "$" + ((t = sT()).key.type === s$ ? t.key.name : i(t.key.value))),
				Object.hasOwn(r, e) ? tT({}, k$) : (r[e] = !0),
				n.push(t),
				rT("}") || nT(",");
		return (
			nT("}"),
	...
	function cT() {
		...
		if (rT("[")) return oT();
		if (rT("{")) return uT();
		if (((t = VS.type), (YS = VS.start), t === ZS || lT[VS.value]))
			n = J$(Y$().value);
		else if (t === n$ || t === t$) VS.octal && tT(VS, w$), (n = Z$(Y$()));
		else {
			if (t === QS) throw new Error(M$);
			t === XS
				? (((e = Y$()).value = "true" === e.value), (n = Z$(e)))
				: t === KS
					? (((e = Y$()).value = null), (n = Z$(e)))
					: rT("/") || rT("/=")
						? ((n = Z$(W$())), G$())
						: eT(Y$());
		}
	...
	function hT() {
		...
		const t = Y$();
		return (
			((t) => t.type === ZS || t.type === QS || t.type === XS || t.type === KS)(
				t,
			) || eT(t),
			J$(t.value)
		);
	...
	function pT() {
		...
		if (VS.type === e$ && (rT("++") || rT("--"))) throw new Error(M$);
		return t;
	}
	function gT() {
		var t, e;
		if (VS.type !== e$ && VS.type !== QS) e = pT();
		else {
			if (rT("++") || rT("--")) throw new Error(M$);
			if (rT("+") || rT("-") || rT("~") || rT("!"))
				(t = Y$()),
					(e = gT()),
					(e = ((t, e) => {
				...
				if (iT("delete") || iT("void") || iT("typeof")) throw new Error(M$);
				e = pT();
			}
		}
		return e;
	...
	function mT(t) {
		let e = 0;
		if (t.type !== e$ && t.type !== QS) return 0;
		switch (t.value) {
			case "||":
				e = 1;
				break;
	...
	function yT() {
		...
		return (
			(t = (() => {
				...
				if (((t = VS), (u = gT()), 0 === (i = mT((r = VS))))) return u;
				for (
					r.prec = i, Y$(), e = [t, VS], o = [u, r, (a = gT())];
					(i = mT(VS)) > 0;
				) {
					for (; o.length > 2 && i <= o[o.length - 2].prec; )
						(a = o.pop()),
							...
							(n = V$(s, u, a)),
							o.push(n);
					((r = Y$()).prec = i), o.push(r), e.push(VS), (n = gT()), o.push(n);
				}
				for (n = o[(l = o.length - 1)], e.pop(); l > 1; )
					e.pop(), (n = V$(o[l - 1].value, o[l - 2], n)), (l -= 2);
				return n;
			})()),
			rT("?") &&
				(Y$(),
	...
	function vT() {
		const t = yT();
		if (rT(",")) throw new Error(M$);
		return t;
	}
	function _T(t) {
		(YS = 0), (GS = (HS = t).length), (VS = null), G$();
		const e = vT();
		if (VS.type !== JS) throw new Error("Unexpect token after expression.");
		return e;
	}
	var xT = {
		NaN: "NaN",
	...
	const kT = Symbol("vega_selection_getter");
	function AT(t) {
		return (
			(t.getter && t.getter[kT]) ||
				((t.getter = l(t.field)), (t.getter[kT] = !0)),
			t.getter
		);
	}
	const MT = "intersect",
	...
	function NT(t, e) {
		for (var n, r, i = e.fields, o = e.values, a = i.length, s = 0; s < a; ++s)
			if (
				(mt((n = AT((r = i[s]))(t))) && (n = S(n)),
				mt(o[s]) && (o[s] = S(o[s])),
				k(o[s]) && mt(o[s][0]) && (o[s] = o[s].map(S)),
				r.type === FT)
			) {
				if (k(o[s]) ? !o[s].includes(n) : n !== o[s]) return !1;
			} else if (r.type === ST) {
			...
			} else if (r.type === TT && !pt(n, o[s], !1, !0)) return !1;
		return !0;
	}
	const OT = ee(CT),
		RT = OT.left,
	...
	var LT = {
		...
		E_intersect: (t, e) => (t.length ? t.filter((t) => e.includes(t)) : e),
		R_union: (t, e) => {
			var n = S(e[0]),
				r = S(e[1]);
			return (
	...
	function XT(t, e, n) {
		return Number.isInteger(t) && Number.isInteger(e)
			? (VT.setYear(2e3), VT.setMonth(t), VT.setDate(e), WT.call(this, VT, n))
			: "";
	}
	const JT = "%",
		ZT = "$";
	...
	function KT(t, e, n, r) {
		if (e[0].type === BS) tB(n, r, e[0].value);
		else for (t in n.scales) tB(n, r, t);
	}
	function tB(t, e, n) {
		const r = JT + n;
		if (!lt(e, r))
	...
	function eB(t, e) {
		...
		if (xt(t)) {
			const n = e.scales[t];
			return n && ((t) => t && !0 === t[ip])(n.value) ? n.value : void 0;
		}
	}
	function nB(t, e, n) {
		(e.__bandwidth = (t) => (t && t.bandwidth ? t.bandwidth() : 0)),
			...
			(n._scale = KT);
		const r = (e) =>
			"_[" + (e.type === BS ? Ct(JT + e.value) : Ct(JT) + "+" + t(e)) + "]";
		return {
	...
	function rB(t, e) {
		return function (n, r, i) {
			if (n) {
				const e = eB(n, (i || this).context);
				return e && e.path[t](r);
			}
			return e(r);
		};
	}
	const iB = rB("area", (t) => ((Tw = new se()), pw(t, Bw), 2 * Tw)),
		oB = rB("bounds", (t) => {
			var e, n, r, i, o, a, s;
			if (
				((kw = ww = -(xw = bw = 1 / 0)), (Fw = []), pw(t, sk), (n = Fw.length))
			) {
				for (Fw.sort(mk), e = 1, o = [(r = Fw[0])]; e < n; ++e)
					yk(r, (i = Fw[e])[0]) || yk(r, i[1])
						? (gk(r[0], i[1]) > gk(r[0], r[1]) && (r[1] = i[1]),
							gk(i[0], r[1]) > gk(r[0], r[1]) && (r[0] = i[0]))
						: o.push((r = i));
				for (a = -1 / 0, e = 0, r = o[(n = o.length - 1)]; e <= n; r = i, ++e)
					(i = o[e]),
						(s = gk(r[1], i[0])) > a && ((a = s), (xw = i[0]), (ww = r[1]));
			}
			return (
				(Fw = Sw = null),
				xw === 1 / 0 || bw === 1 / 0
	...
	function lB(t) {
		const e = af(t);
		return 0.2126 * uB(e.r) + 0.7152 * uB(e.g) + 0.0722 * uB(e.b);
	}
	function cB(t, e) {
		return (
			t === e ||
	...
	const vB = () => ("undefined" != typeof window && window) || null;
	function _B(t, e, n) {
		if (!t) return [];
		const [r, i] = t,
			o = new Vg().set(r[0], r[1], i[0], i[1]);
		return B_(
	...
	const xB = {
			...
			lastindexof: function (t) {
				for (
					...
					n[r - 1] = arguments[r];
				return gB(t).lastIndexOf(...n);
			},
			replace: (t, e, n) => (
				J(n) && s("Function argument passed to replace."),
				String(t).replace(e, n)
			),
			reverse: (t) => pB(t).slice().reverse(),
			slice: function (t) {
				for (
					var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1;
					r < e;
			...
			merge: function () {
				...
				return t.unshift({}), ot(...t);
			},
			pad: Et,
			peek: F,
			pluck: (t, e) => {
				const n = dB[e] || (dB[e] = l(e));
				return k(t) ? t.map(n) : n(t);
			},
			span: Dt,
			inrange: pt,
			truncate: zt,
			...
			monthFormat: function (t) {
				return XT.call(this, t, 1, "%B");
			},
			monthAbbrevFormat: function (t) {
				return XT.call(this, t, 1, "%b");
			},
			dayFormat: function (t) {
				return XT.call(this, 0, 2 + t, "%A");
			},
			...
			utcdayofyear: hr,
			warn: function () {
				return sB(this.context.dataflow, "warn", arguments);
			},
			info: function () {
				return sB(this.context.dataflow, "info", arguments);
			},
			debug: function () {
				return sB(this.context.dataflow, "debug", arguments);
			},
			extent: (t) => at(t),
			inScope: function (t) {
			...
			modify: function (t, e, n, r, i, o) {
				...
				if (
					...
					n && ((c = !0 === n ? p : k(n) || ma(n) ? n : hB(n)), h.remove(c)),
					e && h.insert(e),
					r && ((c = hB(r)), u.value.some(c) ? h.remove(c) : h.insert(r)),
					i)
				)
		...
		AB = {
			...
			fieldvar: "datum",
			globalvar: (t) => `_[${Ct(ZT + t)}]`,
			functions: (t) => {
				const e = bT(t);
				bB.forEach((t) => (e[t] = "event.vega." + t));
				for (const t in xB) e[t] = wB + t;
				return ot(e, nB(t, xB, kB)), e;
			},
			constants: xT,
			visitors: kB,
		},
	...
	function EB(t, e, n) {
		return 1 === arguments.length
			? xB[t]
			: ((xB[t] = e), n && (kB[t] = n), MB && (MB.functions[t] = wB + t), this);
	}
	function DB(t, e) {
		const n = {};
		let r;
		...
		return (
			...
			{
				$expr: ot({ code: i.code }, e.options.ast ? { ast: r } : null),
				$fields: i.fields,
				$params: n,
			}
		);
	...
	EB(
			...
			function (t, e, n, r, i) {
				...
				return (
					u - s
						...
						: (t = (
								t.interpolator
									? ap("sequential")().interpolator(t.interpolator())
									: ap("linear")().interpolate(t.interpolate()).range(t.range())
							).domain([(s = 0), (u = 1)])),
					t.ticks &&
						((a = t.ticks(+r || 15)),
						s !== a[0] && a.unshift(s),
		...
		EB("geoArea", iB, KT),
		EB("geoBounds", oB, KT),
		EB("geoCentroid", aB, KT),
		EB(
			"geoShape",
			function (t, e, n) {
				const r = eB(t, (n || this).context);
				return (t) => (r ? r.path.context(t)(e) : "");
			},
			KT,
		),
		EB(
		...
		EB(
			...
			function (t, e, n) {
				const r = yB(t, this),
					i = r[e],
					o = r[n];
				return i && o ? i.path(o).map(mB) : void 0;
			},
			QT,
		),
		EB(
			...
			function (t, e) {
				const n = yB(t, this)[e];
				return n ? n.ancestors().map(mB) : void 0;
			},
			QT,
		),
		EB(
			...
			function (t, e, n) {
				for (
					...
					if (((r = l[d]), c && f)) {
						...
						if (((s = NT(e, r)), (i[a] = s ? -1 : ++o), s && 1 === c.size))
							return !0;
						if (!s && o === c.get(a).count) return !1;
					} else if (f ^ (s = NT(e, r))) return s;
				return h && f;
			},
			qT,
		),
		EB(
			...
			function (t, e, n) {
				const r = this.context.data[t],
					i = r ? r.values.value : [],
					o = r ? r[zT] && r[zT].value : void 0,
					a = n === MT,
					s = CT(e),
					u = RT(i, s);
				if (u === i.length) return !1;
				if (CT(i[u]) !== s) return !1;
				if (o && a) {
					if (1 === o.size) return !0;
					if (UT(i, s) - u < o.size) return !1;
				}
				return !0;
			},
			qT,
			...
			function (t, e, n, r) {
				for (
					...
					if (((s = (i = y[w]).unit), (o = i.fields), (a = i.values), o && a)) {
						...
						n &&
							(f = _[s] || (_[s] = [])).push(
								V(a).reduce((t, e, n) => ((t[o[n].field] = e), t), {}),
							);
					} else
						(u = DT),
							(l = CT(i)),
							(f = (c = v[u] || (v[u] = {}))[s] || (c[s] = [])).push(l),
							n && (f = _[s] || (_[s] = [])).push({ [DT]: l });
				if (
					((e = e || ET),
					v[DT]
						? (v[DT] = LT[`${DT}_${e}`](...Object.values(v[DT])))
						: Object.keys(v).forEach((t) => {
								v[t] = Object.keys(v[t])
									.map((e) => v[t][e])
									.reduce((n, r) =>
										void 0 === n ? r : LT[`${x[t]}_${e}`](n, r),
									);
							}),
					(y = Object.keys(_)),
					n && y.length)
		...
		EB("vlSelectionTuples", (t, e) =>
			t.map((t) =>
				ot(
					e.fields
						? { values: e.fields.map((e) => AT(e)(t.datum)) }
						: { [DT]: CT(t.datum) },
					e,
				),
			),
	...
	var TB = {
		operator: (t, e) => $B(t, ["_"], e.code),
		parameter: (t, e) => $B(t, ["datum", "_"], e.code),
		event: (t, e) => $B(t, ["event"], e.code),
		handler: (t, e) =>
			$B(
				t,
				["_", "event"],
				...
				(i += ((t, e) => {
					...
					return (
						CB[e] ||
							(t.x2 &&
								(t.x
									? (FB[e] && (n += "if(o.x>o.x2)$=o.x,o.x=o.x2,o.x2=$;"),
										(n += "o.width=o.x2-o.x;"))
									: (n += "o.x=o.x2-(o.width||0);")),
							t.xc && (n += "o.x=o.xc-(o.width||0)/2;"),
							t.y2 &&
								(t.y
									? (FB[e] && (n += "if(o.y>o.y2)$=o.y,o.y=o.y2,o.y2=$;"),
										(n += "o.height=o.y2-o.y;"))
	...
	function BB(t, e, n) {
		if (!t || !A(t)) return t;
		for (let r, i = 0, o = zB.length; i < o; ++i)
			if (((r = zB[i]), lt(t, r.key))) return r.parse(t, e, n);
		return t;
	}
	var zB = [
		{
			key: "$ref",
			parse: (t, e) => e.get(t.$ref) || s("Operator not defined: " + t.$ref),
		},
		{
			key: "$key",
			parse: (t, e) => {
		...
		},
		{
			...
			parse: (t, e) => {
				const n = "c:" + t.$compare + "_" + t.$order,
					r = V(t.$compare).map((t) => (t && t.$tupleid ? ya : t));
				return e.fn[n] || (e.fn[n] = Q(r, t.$order, e.expr.codegen));
			},
		},
		{ key: "$context", parse: (t, e) => e },
		{
			key: "$subflow",
			parse: (t, e) => {
				const n = t.$subflow;
	...
	RB.prototype = UB.prototype = {
		...
		add(t, e) {
			const r = this.dataflow,
				i = t.value;
			if (
				(this.set(t.id, e),
				((t) => "collect" === SB(t))(t.type) &&
					i &&
					(i.$ingest
				...
				let i = this.get(t.parent.$ref);
				i
					? (r.connect(i, [e]), e.targets().add(i))
					: (this.unresolved = this.unresolved || []).push(() => {
							(i = this.get(t.parent.$ref)),
								r.connect(i, [e]),
								e.targets().add(i);
						});
			}
			if (
				(t.signal && (this.signals[t.signal] = e),
				t.scale && (this.scales[t.scale] = e),
				t.data)
			)
				for (const r in t.data) {
					const i = this.data[r] || (this.data[r] = {});
		...
		transform(t, e) {
			this.add(t, this.dataflow.add(this.transforms[SB(e)]));
		},
		stream(t, e) {
			this.set(t.id, e);
		},
		...
		parse: function (t) {
			const n = t.operators || [];
			return (
				t.background && (this.background = t.background),
				t.eventConfig && (this.eventConfig = t.eventConfig),
				t.locale && (this.locale = t.locale),
				n.forEach((t) => this.parseOperator(t)),
				n.forEach((t) => this.parseOperatorParameters(t)),
				(t.streams || []).forEach((t) => this.parseStream(t)),
				(t.updates || []).forEach((t) => this.parseUpdate(t)),
				this.resolve()
			);
		},
		parseOperator: function (t) {
			!((t) => "operator" === SB(t))(t.type) && t.type
				? this.transform(t, t.type)
				: this.operator(t, t.update ? this.operatorExpression(t.update) : null);
		},
		parseOperatorParameters: function (t) {
			if (t.params) {
				const n = this.get(t.id);
				n || s("Invalid operator id: " + t.id),
					this.dataflow.connect(
						n,
						n.parameters(this.parseParameters(t.params), t.react, t.initonly),
					);
			}
		},
		parseParameters: function (t, e) {
			...
			for (const r in t) {
				const i = t[r];
				e[r] = k(i) ? i.map((t) => BB(t, this, e)) : BB(i, this, e);
			}
			return e;
		},
		parseStream: function (t) {
			var e,
				r = null != t.filter ? this.eventExpression(t.filter) : void 0,
				i = null != t.stream ? this.get(t.stream) : void 0;
			t.source
				? (i = this.events(t.source, t.type, r))
				: t.merge &&
					(i = (e = t.merge.map((t) => this.get(t)))[0].merge.apply(
						e[0],
						e.slice(1),
					)),
				t.between &&
					((e = t.between.map((t) => this.get(t))),
					(i = i.between(e[0], e[1]))),
			...
			i || s("Source not defined: " + t.source),
				(e =
					t.target && t.target.$expr
						? this.eventExpression(t.target.$expr)
						: this.get(t.target)),
				o &&
					o.$expr &&
					(o.$params && (a = this.parseParameters(o.$params)),
					(o = this.handlerExpression(o.$expr))),
				this.update(t, i, e, o, a);
		},
		getState: function (t) {
			var n = {};
			if (t.signals) {
				var r = (n.signals = {});
				Object.keys(this.signals).forEach((n) => {
			...
			return (
				this.subcontext &&
					!1 !== t.recurse &&
					(n.subcontext = this.subcontext.map((e) => e.getState(t))),
				n
			);
		},
		setState: function (t) {
			...
			Object.keys(i || {}).forEach((t) => {
				n.update(this.signals[t], i[t], NB);
			}),
				Object.keys(r || {}).forEach((t) => {
					n.pulse(this.data[t].input, n.changeset().remove(p).insert(r[t]));
				}),
				(t.subcontext || []).forEach((t, n) => {
					const r = this.subcontext[n];
					r && r.setState(t);
				});
		},
	};
	...
	function GB(t, e, n) {
		...
		return (
			a &&
				((i = YB(t)),
				((r = av(e.changedTouches ? e.changedTouches[0] : e, a))[0] -= i[0]),
				(r[1] -= i[1])),
			(e.dataflow = t),
			(e.item = n),
			(e.vega = ((t, e, n) => {
	...
	const VB = "view",
		XB = { trap: !1 };
	function JB(t, e, n, r) {
		t._eventListeners.push({ type: n, sources: V(e), handler: r });
	}
	function ZB(t, e, n) {
	...
	function tz(t) {
		return (e, n) => n.vega.view().changeset().encode(n.item, t);
	}
	function ez(t, e, n) {
	...
	function oz(t, e, n, r) {
		...
		r.signal(n.signal, e.value),
			...
			(t.set = (t) => {
				(e.value = t),
					e.dispatchEvent(
						((t) => ("undefined" != typeof Event ? new Event(t) : { type: t }))(
							i,
						),
					);
			});
	...
	function az(t, e, n, r) {
		const i = r.signal(n.signal),
			o = ez("div", { class: nz }),
			a = "radio" === n.input ? o : o.appendChild(ez("label"));
		a.appendChild(ez("span", { class: rz }, n.name || n.signal)),
			e.appendChild(o);
		let s = sz;
		switch (n.input) {
			case "checkbox":
	...
	function lz(t, e, n, r) {
		const i = ez("select", { name: n.signal }),
			o = n.labels || [];
		n.options.forEach((t, e) => {
			const n = { value: t };
			hz(t, r) && (n.selected = !0),
				i.appendChild(ez("option", n, (o[e] || t) + ""));
		}),
			e.appendChild(i),
			...
			(t.set = (t) => {
				for (let e = 0, r = n.options.length; e < r; ++e)
					if (hz(n.options[e], t)) return void (i.selectedIndex = e);
			});
	}
	function cz(t, e, n, r) {
		const i = ez("span", { class: iz }),
			o = n.labels || [];
		e.appendChild(i),
			(t.elements = n.options.map((e, a) => {
				...
				const l = ez("label", {}, (o[a] || e) + "");
				return l.prepend(u), i.appendChild(l), u;
			})),
			(t.set = (e) => {
				const n = t.elements,
					r = n.length;
				for (let t = 0; t < r; ++t) hz(n[t].value, e) && (n[t].checked = !0);
			});
	}
	function fz(t, e, n, r) {
	...
	function dz(t, e, n, r, i, o) {
		return (e = e || new r(t.loader()))
			.initialize(n, WB(t), HB(t), YB(t), i, o)
	...
	function yz(t) {
		return A(t)
			...
			: ((t) => ({ top: t, bottom: t, left: t, right: t }))(mz(t));
	}
	async function vz(t, e, n, r) {
		const i = T_(e),
			o = i && i.headless;
		return (
			o || s("Unrecognized renderer type: " + e),
			await t.runAsync(),
			dz(t, null, null, o, n, r).renderAsync(t._scenegraph.root)
		);
	}
	var _z = "width",
		xz = "height",
	...
	function kz(t, e) {
		var n = t.autosize(),
			r = t.padding();
		return e - (n && n.contains === bz ? r.left + r.right : 0);
	}
	function Az(t, e) {
		var n = t.autosize(),
			r = t.padding();
		return e - (n && n.contains === bz ? r.top + r.bottom : 0);
	}
	function Mz(t, e) {
		return e.modified && k(e.input.value) && !t.startsWith("_:vega:_");
	}
	function Ez(t, e) {
	...
	function Cz(t) {
		return "[" + t.map(Fz).join(", ") + "]";
	}
	function Fz(t) {
		return k(t) ? "[…]" : A(t) && !mt(t) ? "{…}" : t;
	}
	function Sz(t, e) {
		if (
			((e = e || {}),
			Va.call(this),
			e.loader && this.loader(e.loader),
			e.logger && this.logger(e.logger),
			null != e.logLevel && this.logLevel(e.logLevel),
			e.locale || t.locale)
		) {
			const r = ot({}, t.locale, e.locale);
			this.locale(Ro(r.number, r.time));
		}
		(this._el = null),
			(this._elBind = null),
			(this._renderType = e.renderer || S_.Canvas),
			(this._scenegraph = new Ky());
		const r = this._scenegraph.root;
		(this._renderer = null),
			(this._tooltip = e.tooltip || Dz),
			(this._redraw = !0),
			(this._handler = new Sv().scene(r)),
		...
		const i = ((t, e, n) => OB(t, Za, xB, n).parse(e))(this, t, e.expr);
		(this._runtime = i),
			(this._signals = i.signals),
			(this._bind = (t.bindings || []).map((t) => ({
				state: null,
				param: ot({}, t),
			}))),
			i.root && i.root.set(r),
			(r.source = i.data.root.input),
			this.pulse(i.data.root.input, this.changeset().insert(r.items)),
			(this._width = this.width()),
			(this._height = this.height()),
			(this._viewWidth = kz(this, this._width)),
			(this._viewHeight = Az(this, this._height)),
			(this._origin = [0, 0]),
			(this._resize = 0),
			(this._autosize = 1),
			((t) => {
				...
				(t._resizeWidth = t.add(
					null,
					(e) => {
						(t._width = e.size), (t._viewWidth = kz(t, e.size)), o();
					},
					{ size: n },
				)),
					(t._resizeHeight = t.add(
						null,
						(e) => {
							(t._height = e.size), (t._viewHeight = Az(t, e.size)), o();
						},
						{ size: r },
					));
			...
			((t) => {
				const e =
					t._signals.cursor ||
					(t._signals.cursor = t.add({ user: qB, item: null }));
				t.on(t.events("view", "pointermove"), e, (t, n) => {
					const r = e.value,
						i = r ? (xt(r) ? r : r.user) : qB,
			...
			e.hover && this.hover(),
			e.container && this.initialize(e.container, e.bind),
			e.watchPixelRatio && this._watchPixelRatio();
	}
	function $z(t, e) {
	...
	function Bz(t, e, n, r) {
		...
		return (
			i ||
				((i = pz(t, () => r(e, n.value))), (i.handler = r), t.on(n, null, i)),
			t
		);
	}
	function zz(t, e, n) {
	...
	dt(Sz, Va, {
		...
		description(t) {
			if (arguments.length) {
				...
				return e !== this._desc && LB(this._el, (this._desc = e)), this;
			}
			return this._desc;
		},
		container() {
		...
		padding(t) {
			return arguments.length
				? this.signal("padding", yz(t))
				: yz(this.signal("padding"));
		},
		autosize(t) {
			return arguments.length
		...
		renderer(t) {
			return arguments.length
				? (T_(t) || s("Unrecognized renderer type: " + t),
					t !== this._renderType &&
		...
		resize() {
			return (this._autosize = 1), this.touch($z(this, "autosize"));
		},
		_resetRenderer() {
			this._renderer &&
		...
		_resizeView: function (t, e, n, r, i, o) {
			this.runAfter(
				(a) => {
					...
					(a._autosize = 0),
						a.width() !== n &&
							((s = 1), a.signal(_z, n, wz), a._resizeWidth.skip(!0)),
						a.height() !== r &&
							((s = 1), a.signal(xz, r, wz), a._resizeHeight.skip(!0)),
		...
		addEventListener(t, e, n) {
			let r = e;
			return (
				(n && !1 === n.trap) || ((r = pz(this, e)), (r.raw = e)),
		...
		addSignalListener(t, e) {
			return Bz(this, t, $z(this, t), e);
		},
		removeSignalListener(t, e) {
			return zz(this, $z(this, t), e);
		},
		addDataListener(t, e) {
			return Bz(this, t, jB(this, t).values, e);
		},
		removeDataListener(t, e) {
			return zz(this, jB(this, t).values, e);
		},
		globalCursor(t) {
			if (arguments.length) {
				if (this._globalCursor !== !!t) {
					const e = PB(this, null);
					(this._globalCursor = !!t), e && PB(this, e);
				}
				return this;
			}
				...
				a = (n, r) => {
					this.runAsync(null, () => {
						t === VB &&
							...
							n.preventDefault(),
							o.receive(GB(this, n, r));
					});
				};
			if ("timer" === t) ZB(this, "timer", e) && this.timer(a, e);
			else if (t === VB) ZB(this, "view", e) && this.addEventListener(e, a, XB);
			else if (
				("window" === t
					? ZB(this, "window", e) &&
				...
				JB(this, r, e, a);
			} else this.warn("Can not resolve event source: " + t);
			return o;
		},
		finalize: function () {
			var t,
		...
		hover: function (t, e) {
			return (
				...
				this.on(this.events("view", "pointerover", QB), KB, tz(t)),
				this.on(this.events("view", "pointerout", QB), KB, tz(e)),
				this
			);
		},
		data: function (t, e) {
			return arguments.length < 2
				? jB(this, t).values.value
				: IB.call(this, t, Ma().remove(p).insert(e));
		},
		change: IB,
		insert: function (t, e) {
			return IB.call(this, t, Ma().insert(e));
		},
		remove: function (t, e) {
			return IB.call(this, t, Ma().remove(e));
		},
		scale: function (t) {
		...
		initialize: function (t, e) {
			const r = this._renderType,
				i = this._eventConfig.bind,
				o = T_(r);
			(t = this._el = t ? gz(this, t, !0) : null),
				((t) => {
					const e = t.container();
					e &&
				...
				o || this.error("Unrecognized renderer type: " + r);
			const a = o.handler || Sv,
				s = t ? o.renderer : o.headless;
			return (
				(this._renderer = s ? dz(this, this._renderer, t, s) : null),
				(this._handler = ((t, e, n, r) => {
					const i = new r(t.loader(), pz(t, t.tooltip()))
				...
				})(this, this._handler, t, a)),
				(this._redraw = !0),
				t &&
					"none" !== i &&
					((e = e
						? (this._elBind = gz(this, e, !0))
						: t.appendChild(ez("form", { class: "vega-bindings" }))),
					this._bind.forEach((t) => {
						t.param.element &&
							"container" !== i &&
							(t.element = gz(this, t.param.element, !!t.param.input));
					}),
					this._bind.forEach((t) => {
						!((t, e, n) => {
							if (!e) return;
							...
							i ||
								...
								r.debounce && (i.update = it(r.debounce, i.update))),
								(null == r.input && r.element ? oz : az)(i, e, r, t),
								i.active ||
		...
		toCanvas: async function (t, e) {
			return (await vz(this, S_.Canvas, t, e)).canvas();
		},
		toSVG: async function (t) {
			return (await vz(this, S_.SVG, t)).svg();
		},
		getState: function (t) {
			return this._runtime.getState(
				t || { data: Mz, signals: Ez, recurse: !0 },
			);
		},
		setState: function (t) {
			return (
	...
	let Yz, Gz;
	function Vz(t, e, n) {
		return (Yz = e || Nz), (Gz = n || Hz), Jz(t.trim()).map(Zz);
	}
	...
	function Zz(t) {
		return "[" === t[0]
			...
			: ((t) => {
					...
					if (((l = Xz(t, l, Oz)), l === u)) n.push(t.substring(s, u).trim());
					else if (
					...
					for (; l < u; ) {
						if (((l = Xz(t, l, Rz)), l === u))
							throw "Unmatched left bracket: " + t;
						if ((i.push(t.substring(s, l).trim()), l < u - 1 && t[++l] !== Oz))
							throw "Expected left bracket: " + t;
						s = ++l;
					}
					if (!(u = n.length) || Wz.test(n[u - 1]))
	...
	function Qz(t) {
		return A(t) ? t : { type: t || "pad" };
	}
	const Kz = (t) => +t || 0,
		tN = (t) => ({ top: t, bottom: t, left: t, right: t });
	function eN(t) {
		return A(t)
			? t.signal
				? t
	...
	const nN = (t) => (A(t) && !k(t) ? ot({}, t) : { value: t });
	function rN(t, e, n, r) {
		if (null != n) {
			return (
				(A(n) && !k(n)) || (k(n) && n.length && A(n[0]))
					? (t.update[e] = n)
					: (t[r || "enter"][e] = { value: n }),
				1
			);
	...
	function iN(t, e, n) {
		for (const n in e) rN(t, n, e[n]);
		for (const e in n) rN(t, e, n[e], "update");
	}
	function oN(t, e, n) {
		for (const r in e) (n && lt(n, r)) || (t[r] = ot(t[r] || {}, e[r]));
		return t;
	}
	function aN(t, e) {
	...
	const DN = (t) => (xt(t) ? Ct(t) : t.signal ? `(${t.signal})` : $N(t));
	function CN(t) {
		if (null != t.gradient)
			return ((t) => {
				...
				for (; e.length && null == F(e); ) e.pop();
				return e.unshift(DN(t.gradient)), `gradient(${e.join(",")})`;
			})(t);
		let e = t.signal
			? `(${t.signal})`
			: t.color
		...
		return (
			...
			void 0 === e && (e = null),
			null != t.exponent && (e = `pow(${e},${SN(t.exponent)})`),
			null != t.mult && (e += `*${SN(t.mult)}`),
			null != t.offset && (e += `+${SN(t.offset)}`),
			t.round && (e = `round(${e})`),
			e
		);
	}
	const FN = (t, e, n, r) => `(${t}(${[e, n, r].map(CN).join(",")})+'')`;
	function SN(t) {
		return A(t) ? "(" + CN(t) + ")" : t;
	}
	function $N(t) {
		return TN(A(t) ? t : { datum: t });
	}
	function TN(t) {
		let e, n, r;
		...
		return (
			t.signal || (r = xt(r) ? u(r).map(Ct).join("][") : TN(r)),
			e + "[" + r + "]"
		);
	}
	function BN(t, e, n, r, i, o) {
		...
		((o = o || {}).encoders = { $encode: a }),
			(t = ((t, e, n, r, i) => {
				...
				"text" !== e || null == i[u] || aN(u, t) || EN(o, u, i[u]),
				("legend" == n || String(n).startsWith("axis")) && (n = null),
				(c = n === uN ? i.group : n === sN ? ot({}, i.mark, i[e]) : null),
				c))
					(l =
						aN(u, t) ||
						(("fill" === u || "stroke" === u) &&
							(aN("fill", t) || aN("stroke", t)))),
						l || EN(o, u, c[u]);
				for (u in (V(r).forEach((e) => {
					const n = i.style && i.style[e];
					for (const e in n) aN(e, t) || EN(o, e, n[e]);
				}),
				(t = ot({}, t)),
				o))
					(c = o[u]), c.signal ? ((s = s || {})[u] = c) : (a[u] = c);
				return (t.enter = ot(a, t.enter)), s && (t.update = ot(s, t.update)), t;
			})(t, e, n, r, i.config));
		for (const n in t) a[n] = zN(t[n], e, o, i);
		return o;
	}
	function zN(t, e, n, r) {
		const i = {},
	...
	function NN(t, e, n, r) {
		const i = DB(t, e);
		return i.$fields.forEach((t) => (r[t] = 1)), ot(n, i.$params), i.$expr;
	}
	const ON = "outer",
		RN = ["value", "update", "init", "react", "bind"];
	function UN(t, e) {
	...
	function LN(t, e) {
		const n = t.name;
		if (t.push === ON)
			e.signals[n] || UN("No prior signal definition", n),
				RN.forEach((e) => {
					void 0 !== t[e] && UN("Invalid property ", e);
				});
		else {
	...
	function PN(t, e, n, r) {
		return new qN(t, e, n, r);
	}
	function jN(t, e) {
		return PN("operator", t, e);
	}
	function IN(t) {
		const e = { $ref: t.id };
	...
	function rO(t, e) {
		const n = aO({ merge: t.merge.map((t) => nO(t, e)) }, t, e);
		return e.addStream(n).id;
	}
	function iO(t, e) {
		const n = aO({ stream: nO(t.stream, e) }, t, e);
		return e.addStream(n).id;
	}
	function oO(t, e) {
		let n;
		t.type === eO
			? ((n = e.event(eO, t.throttle)),
				(t = { between: t.between, filter: t.filter }))
			: (n = e.event(((t) => (t === XN ? JN : t || JN))(t.source), t.type));
		const r = aO({ stream: n }, t, e);
	...
	function aO(t, e, n) {
		...
		return (
			...
			e.source === XN && r.push("inScope(event.item)"),
			r.length && (t.filter = DB("(" + r.join(")&&(") + ")", n).$expr),
	...
	const sO = { code: "_.$value", ast: { type: "Identifier", value: "value" } };
	function uO(t, e, n) {
		const r = t.encode,
			i = { target: n };
		let o = t.events,
		...
		o || s("Signal update missing events specification."),
			xt(o) && (o = Vz(o, e.isSubscope() ? XN : JN)),
			(o = V(o).filter((t) => (t.signal || t.scale ? (u.push(t), 0) : 1))),
			u.length > 1 && (u = [lO(u)]),
			...
			(i.update = xt(a)
				...
				: null != a.expr
					...
					: null != a.value
						? a.value
						: null != a.signal
							? { $expr: sO, $params: { $value: e.signalRef(a.signal) } }
	...
	const cO = (t) => (e, n, r) => PN(t, n, e || void 0, r),
		fO = cO("aggregate"),
		hO = cO("axisticks"),
		dO = cO("bound"),
		pO = cO("collect"),
		...
		UO = cO("values");
	let LO = 0;
	const qO = { min: "min", max: "max", count: "sum" };
	function PO(t, e) {
		const n = e.getScale(t.name).params;
		let r;
		for (r in ((n.domain = HO(t.domain, t, e)),
		null != t.range && (n.range = KO(t, e, n)),
		null != t.interpolate &&
			((t, e) => {
				(e.interpolate = jO(t.type || t)),
					null != t.gamma && (e.interpolateGamma = jO(t.gamma));
			})(t.interpolate, n),
		null != t.nice &&
			(n.nice = ((t, e) =>
				t.signal
					? e.signalRef(t.signal)
					: A(t)
						? { interval: jO(t.interval), step: jO(t.step) }
						: jO(t))(t.nice, e)),
		null != t.bins &&
			(n.bins = ((t, e) => (t.signal || k(t) ? IO(t, e) : e.objectProperty(t)))(
				t.bins,
				e,
			)),
		t))
			lt(n, r) || "name" === r || (n[r] = jO(t[r], e));
	}
	function jO(t, e) {
		return A(t)
			? t.signal
	...
	function IO(t, e) {
		return t.signal ? e.signalRef(t.signal) : t.map((t) => jO(t, e));
	}
	function WO(t) {
	...
	function GO(t, e, n) {
		...
		return (
			r || WO(t.data),
			cp(e.type)
				? r.valuesRef(n, t.field, JO(t.sort, !1))
				: pp(e.type)
	...
	function VO(t, e, n) {
		...
		return (cp(e.type) ? XO : pp(e.type) ? ZO : QO)(t, n, i);
	}
	function XO(t, e, n) {
		const r = JO(t.sort, !0);
		let i, o;
		const a = n.map((t) => {
				...
				return n || WO(t.data), n.countsRef(e, t.field, r);
			}),
			s = { groupby: HN, pulse: a };
		r &&
			((i = r.op || "count"),
			(o = r.field ? VN(i, r.field) : "count"),
			(s.ops = [qO[i]]),
			(s.fields = [e.fieldRef(o)]),
			(s.as = [o])),
			(i = e.add(fO(s)));
		const u = e.add(pO({ pulse: IN(i) }));
		return (
			(o = e.add(UO({ field: HN, sort: e.sortRef(r), pulse: IN(u) }))), IN(o)
		);
	}
	function JO(t, e) {
		return (
	...
	function ZO(t, e, n) {
		const r = n.map((t) => {
			const n = e.getData(t.data);
			return n || WO(t.data), n.domainRef(e, t.field);
		});
		return IN(e.add(EO({ values: r })));
	}
	function QO(t, e, n) {
		const r = n.map((t) => {
			const n = e.getData(t.data);
			return n || WO(t.data), n.extentRef(e, t.field);
		});
		return IN(e.add(MO({ extents: r })));
	}
	function KO(t, e, n) {
		...
		if (xt(i)) {
			if (r && lt(r, i)) return KO((t = ot({}, t, { range: r[i] })), e, n);
			"width" === i
				? (i = [0, { signal: "width" }])
				: "height" === i
					? (i = cp(t.type)
			...
			if (i.scheme)
				return (
					(n.scheme = k(i.scheme) ? IO(i.scheme, e) : jO(i.scheme, e)),
					i.extent && (n.schemeExtent = IO(i.extent, e)),
					void (i.count && (n.schemeCount = jO(i.count, e)))
				);
			if (i.step) return void (n.rangeStep = jO(i.step, e));
			if (cp(t.type) && !k(i)) return HO(i, t, e);
			k(i) || s("Unsupported range type: " + Ct(i));
		}
		return i.map((t) => (k(t) ? IO : jO)(t, e));
	}
	function tR(t, e, n) {
		return k(t)
			? t.map((t) => tR(t, e, n))
	...
	const eR = "top",
		...
		AR = { name: 1, style: 1, interactive: 1 },
		MR = { value: 0 },
		ER = { value: 1 },
		DR = "group",
		CR = "rect",
		...
		$R = "text";
	function TR(t) {
		return (t.type = DR), (t.interactive = t.interactive || !1), t;
	}
	function BR(t, e) {
		const n = (n, r) => KN(t[n], KN(e[n], r));
		return (
			(n.isVertical = (n) =>
				aR ===
				KN(
			...
			(n.gradientLength = () =>
				KN(t.gradientLength, e.gradientLength || e.gradientWidth)),
			(n.gradientThickness = () =>
				KN(t.gradientThickness, e.gradientThickness || e.gradientHeight)),
			(n.entryColumns = () => KN(t.columns, KN(e.columns, +n.isVertical(!0)))),
			n
		);
	}
	function zR(t, e) {
	...
	function NR(t, e, n) {
		return `item.anchor === '${sR}' ? ${t} : item.anchor === '${uR}' ? ${e} : ${n}`;
	}
	const OR = NR(Ct(nR), Ct(rR), Ct(oR));
	function RR(t, e) {
		return e
			? t
				? A(t)
					? Object.assign({}, t, { offset: RR(t.offset, e) })
					: { value: t, offset: e }
				: e
			: t;
	}
	...
	function LR(t, e, n, r) {
		...
		o
			...
			: ((l = [0, 0]), (c = [1, 0]), (f = s), (h = a));
		const d = {
			enter: (u = { opacity: MR, x: MR, y: MR, width: nN(f), height: nN(h) }),
			update: ot({}, u, {
				opacity: ER,
	...
	function qR(t, e, n, r, i) {
		...
		const p = { opacity: MR, fill: { scale: e, field: pR } };
		(p[l] = { signal: d + "datum." + hR, mult: u }),
			(p[c] = MR),
			(p[f] = { signal: d + "datum." + dR, mult: u }),
			(p[h] = nN(s));
		const g = {
			enter: p,
			update: ot({}, p, { opacity: ER }),
			exit: { opacity: MR },
		};
		return (
			iN(
			...
			UR({ type: CR, role: yN, key: pR, from: i, encode: g }, r)
		);
	}
	const PR = `datum.${hR}<=0?"${nR}":datum.${hR}>=1?"${rR}":"${oR}"`,
		jR = `datum.${hR}<=0?"${iR}":datum.${hR}>=1?"${eR}":"middle"`;
	function IR(t, e, n, r) {
		const i = BR(t, e),
			o = i.isVertical(),
			a = nN(i.gradientThickness()),
			s = i.gradientLength();
		let u,
			l,
			c,
		...
		const p = {
			enter: (u = { opacity: MR }),
			update: (l = { opacity: ER, text: { field: cR } }),
			exit: { opacity: MR },
		};
		return (
			iN(p, {
				...
				limit: KN(t.labelLimit, e.gradientLabelLimit),
			}),
			o
				? ((u.align = { value: "left" }),
					(u.baseline = l.baseline = { signal: jR }),
					(c = "y"),
					(f = "x"),
					(d = "1-"))
				: ((u.align = l.align = { signal: PR }),
					(u.baseline = { value: "top" }),
					(c = "x"),
					(f = "y")),
			(u[c] = l[c] = { signal: d + "datum." + hR, mult: s }),
			(u[f] = l[f] = a),
			(a.offset = KN(t.labelOffset, e.gradientLabelOffset) || 0),
			(h = h
				? { separation: i("labelSeparation"), method: h, order: "datum." + lR }
				: void 0),
			UR(
				{
					type: $R,
	...
	function WR(t, e, n, r, i) {
		...
		(d.mult = 0.5),
			(m = {
				...
				update: (v = { opacity: ER, x: y.x, y: y.y }),
				exit: { opacity: MR },
			});
		let b = null,
			w = null;
		t.fill || ((b = e.symbolBaseFillColor), (w = e.symbolBaseStrokeColor)),
			...
			kR.forEach((e) => {
				t[e] && (v[e] = y[e] = { scale: t[e], field: pR });
			});
		const k = UR(
				{
					type: SR,
		...
		(A.offset = o("labelOffset")),
			(m = {
				enter: (y = { opacity: MR, x: { signal: h, offset: A }, y: d }),
				update: (v = { opacity: ER, text: { field: cR }, x: y.x, y: y.y }),
				exit: { opacity: MR },
			}),
			iN(m, {
				align: o("labelAlign"),
		...
		const M = UR(
			{ type: $R, role: xN, style: gR, key: pR, from: f, encode: m },
			n.labels,
		);
		return (
			(m = {
			...
			TR({
				role: lN,
				from: (r = { facet: { data: r, name: "value", groupby: lR } }),
				encode: oN(m, a, AR),
				marks: [k, M],
				name: u,
				interactive: s,
	...
	const HR = 'item.orient === "left"',
		YR = 'item.orient === "right"',
		GR = `(${HR} || ${YR})`,
		VR = `datum.vgrad && ${GR}`,
		XR = NR('"top"', '"bottom"', '"middle"'),
		JR = `datum.vgrad && ${YR} ? (${NR('"right"', '"left"', '"center"')}) : (${GR} && !(datum.vgrad && ${HR})) ? "left" : ${OR}`,
		ZR = `item._anchor || (${GR} ? "middle" : "start")`,
		QR = `${VR} ? (${HR} ? -90 : 90) : 0`,
		KR = `${GR} ? (datum.vgrad ? (${YR} ? "bottom" : "top") : ${XR}) : "top"`;
	function tU(t, e) {
		let n;
		return (
			A(t) &&
				(t.signal
					...
					: t.path
						...
						: t.sphere &&
							(n = "geoShape(" + eU(t.sphere) + ', {type: "Sphere"})')),
			n ? e.signalRef(n) : !!t
		);
	}
	function eU(t) {
		return A(t) && t.signal ? t.signal : Ct(t);
	}
	function nU(t) {
		const e = t.role || "";
	...
	function oU(t, e) {
		...
		const r = PN(n.type.toLowerCase(), null, aU(n, t, e));
		return (
	...
	function lU(t, e, n) {
		...
		const o = ot(aU(i, e, n), i.key);
		return IN(n.add(CO(o)));
	}
	const cU = (t) => t && t.expr,
		fU = (t) => t && t.field,
		hU = (t) => "data" === t,
	...
	function xU(t, e, n, r, i, o, a) {
		const s = e[n] || (e[n] = {}),
			u = ((t) =>
				A(t) ? (t.order === GN ? "-" : "+") + VN(t.op, t.field) : "")(o);
		let l,
			c,
			f = vU(i);
		if (
			...
			const n = o
				? { field: HN, pulse: e.countsRef(t, i, o) }
				: { field: t.fieldRef(i), pulse: IN(e.output) };
			u && (n.sort = t.sortRef(o)),
				(c = t.add(PN(r, void 0, n))),
				a && (e.index[i] = c),
				(l = IN(c)),
				null != f && (s[f] = l);
		}
	...
	function wU(t, e) {
					...
					t
						? (r = t.facet) &&
							...
							null != r.field
								? (a = u = mU(r, n))
								: (t.data
										? (u = IN(n.getData(t.data).aggregate))
										: ((o = oU(
												ot(
													{ type: "aggregate", groupby: V(r.groupby) },
													r.aggregate,
												),
												n,
											)),
											(o.params.key = n.keyRef(r.groupby)),
											(o.params.pulse = mU(r, n)),
											(a = u = IN(n.add(o)))),
		...
		u = e.add(
			mO({
				key: m.key || (t.key ? WN(t.key) : void 0),
				pulse: m.pulse,
				clean: !r,
			}),
		);
		const y = IN(u);
		(u = l = e.add(pO({ pulse: y }))),
			(u = e.add(
				AO({
					markdef: rU(t),
					interactive: iU(t.interactive, e),
					clip: tU(t.clip, e),
					context: { $context: !0 },
					groups: e.lookup(),
		...
		const v = IN(u);
		(u = c =
			e.add(yO(BN(t.encode, t.type, n, t.style, e, { mod: !1, pulse: v })))),
			...
			t.sort && (u = e.add(OO({ sort: e.compareRef(t.sort), pulse: IN(u) })));
		const _ = IN(u);
		(i || p) &&
			((p = e.add(
				RO({
			...
			(h = IN(p)));
		const x = e.add(dO({ mark: v, pulse: h || _ }));
		(d = IN(x)),
			r &&
				...
				i
					? ((t, e, n) => {
							...
							r.name || s("Facet must have a name: " + Ct(r)),
								...
								r.field
									? (a = e.add(FO({ field: e.fieldRef(r.field), pulse: o })))
									: r.groupby
										? (a = e.add(
												_O({
													key: e.keyRef(r.groupby),
													group: IN(e.proxy(n.parent)),
													pulse: o,
												}),
											))
							...
							const u = e.fork(),
								l = u.add(pO()),
								c = u.add(NO({ pulse: IN(l) }));
							u.addData(i, new yU(u, l, l, c)),
								u.addSignal("parent", null),
								(a.params.subflow = { $subflow: u.parse(t).toRuntime() });
						})(t, e, m)
					: g
						? ((t, e, n) => {
								const r = e.add(FO({ pulse: n.pulse })),
									i = e.fork();
								i.add(NO()),
			...
			o &&
				(d = ((t, e, n) => {
					const r = t.method,
						...
						o = t.separation,
						a = {
							separation: ZN(o) ? n.signalRef(o.signal) : o,
							method: ZN(r) ? n.signalRef(r.signal) : r,
							pulse: e,
						};
					t.order && (a.sort = n.compareRef({ field: t.order }));
					if (i) {
						const t = i.tolerance;
						(a.boundTolerance = ZN(t) ? n.signalRef(t.signal) : +t),
							(a.boundScale = n.scaleRef(i.scale)),
							(a.boundOrient = i.orient);
					}
					return IN(n.add(DO(a)));
				})(o, d, e));
		const b = e.add(BO({ pulse: d })),
			w = e.add(NO({ pulse: IN(b) }, void 0, e.parent()));
		null != t.name &&
			((f = t.name),
			e.addData(f, new yU(e, l, b, w)),
			t.on &&
				t.on.forEach((t) => {
	...
	function kU(t, e) {
		...
		let f,
			...
			d,
			p = 0;
		kR.forEach((e) => (t[e] ? ((c[e] = t[e]), (p = p || t[e])) : 0)),
			p || s("Missing valid scale for legend.");
		const g = ((t, e) => {
				let n = t.type || _R;
				t.type ||
					1 !== ((t) => kR.reduce((e, n) => e + (t[n] ? 1 : 0), 0))(t) ||
					(!t.fill && !t.stroke) ||
					(n = lp(e) ? xR : fp(e) ? bR : _R);
				return n !== xR ? n : fp(e) ? bR : xR;
			})(t, e.scaleType(p)),
			m = {
				title: null != t.title,
				scales: c,
		...
		return (
			g === xR
				? ((d = [LR(t, p, n, r.gradient), IR(t, n, r.labels, v)]),
					(h.count =
						h.count ||
						e.signalRef(`max(2,2*floor((${tO(i.gradientLength())})/100))`)))
				: g === bR
					? (d = [qR(t, p, n, r.gradient, v), IR(t, n, r.labels, v)])
					: ((f = ((t, e) => {
							const n = BR(t, e);
							return {
								align: n("gridAlign"),
						...
						(d = [WR(t, n, r, v, tO(f.columns))]),
						(h.size = ((t, e, n) => {
							const r = tO(MU("size", t, n)),
								i = tO(MU("strokeWidth", t, n)),
								o = tO(
									((t, e, n) =>
										zR("fontSize", t) ||
										((t, e, n) => {
											...
											return r && r[t];
										})("fontSize", e, n))(n[1].encode, e, gR),
								);
							return DB(`max(ceil(sqrt(${r})+${i}),${o})`, e);
						})(t, e, d[0].marks))),
			(d = [
				TR({
					role: vN,
				...
				d.push(
					((t, e, n, r) => {
						...
						return (
							...
							UR({ type: $R, role: wN, style: mR, from: r, encode: o }, n)
						);
					})(t, n, r.title, y),
				),
			wU(
	...
	function MU(t, e, n) {
		return e[t] ? `scale("${e[t]}",datum)` : zR(t, n[0].encode);
	}
	(yU.fromEntries = (t, e) => {
		const n = e.length,
			r = e[n - 1],
		...
		for (o && "load" === o.type && (o = e[1]), t.add(e[0]); s < n; ++s)
			(e[s].params.pulse = IN(e[s - 1])),
				t.add(e[s]),
				"aggregate" === e[s].type && (a = e[s]);
		return new yU(t, o, i, r, a);
	}),
		(yU.prototype = {
			countsRef(t, e, n) {
				const i = this.counts || (this.counts = {}),
					o = vU(e);
				let a, s, u;
				return (
					null != o && ((t = this.scope), (a = i[o])),
					a
						? n && n.field && _U(t, a.agg.params, n)
						: ((u = { groupby: t.fieldRef(e, "key"), pulse: IN(this.output) }),
							n && n.field && _U(t, u, n),
							(s = t.add(fO(u))),
							(a = t.add(pO({ pulse: IN(s) }))),
							(a = { agg: s, ref: IN(a) }),
							null != o && (i[o] = a)),
					a.ref
				);
			...
			extentRef(t, e) {
				return xU(t, this, "extent", "extent", e, !1);
			},
			domainRef(t, e) {
				return xU(t, this, "domain", "values", e, !1);
			},
			valuesRef(t, e, n) {
				return xU(t, this, "vals", "values", e, n || !0);
			},
			lookupRef(t, e) {
				return xU(t, this, "lookup", "tupleindex", e, !1);
			},
			indataRef(t, e) {
				return xU(t, this, "indata", "tupleindex", e, !0, !0);
			},
		});
	const EU = `item.orient==="${nR}"?-90:item.orient==="${rR}"?90:0`;
	function DU(t, e) {
		const n = BR((t = xt(t) ? { text: t } : t), e.config.title),
			r = t.encode || {},
			i = r.group || {},
			o = i.name || void 0,
			a = i.interactive,
			...
			u.push(
				((t, e, n, r) => {
					...
					return (
						...
						UR({ type: $R, role: AN, style: yR, from: r, encode: a }, n)
					);
				})(
					t,
					n,
				...
				u.push(
					((t, e, n, r) => {
						...
						return (
							...
							UR({ type: $R, role: MN, style: vR, from: r, encode: a }, n)
						);
					})(t, n, r.subtitle, l),
				),
			wU(
			...
			e.addDataPipeline(
				...
				((t, e, n) => {
					...
					let i,
						...
						f = !1;
					t.values
						? ZN(t.values) || QN(t.format)
							? (r.push($U(e, t)), r.push((l = SU())))
							: r.push((l = SU({ $ingest: t.values, $format: t.format })))
						: t.url
							? QN(t.url) || QN(t.format)
								? (r.push($U(e, t)), r.push((l = SU())))
								: r.push((l = SU({ $request: t.url, $format: t.format })))
							: t.source &&
								((l = i = V(t.source).map((t) => IN(e.getData(t).output))),
								r.push(null));
					for (o = 0, a = n.length; o < a; ++o)
						(s = n[o]),
							(u = s.metadata),
							l || u.source || r.push((l = SU())),
							r.push(s),
							u.generates && (f = !0),
							u.modifies && !f && (c = !0),
	...
	const TU = (t) => t === iR || t === eR,
		BU = (t, e, n) =>
			ZN(t) ? qU(t.signal, e, n) : t === nR || t === eR ? e : n,
		zU = (t, e, n) => (ZN(t) ? UU(t.signal, e, n) : TU(t) ? e : n),
		NU = (t, e, n) => (ZN(t) ? LU(t.signal, e, n) : TU(t) ? n : e),
		OU = (t, e, n) =>
			ZN(t) ? PU(t.signal, e, n) : t === eR ? { value: e } : { value: n },
		RU = (t, e, n) =>
			ZN(t) ? jU(t.signal, e, n) : t === rR ? { value: e } : { value: n },
		UU = (t, e, n) => IU(`${t} === '${eR}' || ${t} === '${iR}'`, e, n),
		LU = (t, e, n) => IU(`${t} !== '${eR}' && ${t} !== '${iR}'`, e, n),
		qU = (t, e, n) => HU(`${t} === '${nR}' || ${t} === '${eR}'`, e, n),
		PU = (t, e, n) => HU(`${t} === '${eR}'`, e, n),
		jU = (t, e, n) => HU(`${t} === '${rR}'`, e, n),
		IU = (t, e, n) => (
			(e = null != e ? nN(e) : e),
			(n = null != n ? nN(n) : n),
			WU(e) && WU(n)
				...
				: [ot({ test: t }, e)].concat(n || [])
		),
		WU = (t) => null == t || 1 === Object.keys(t).length,
		HU = (t, e, n) => ({ signal: `${t} ? (${GU(e)}) : (${GU(n)})` }),
		YU = (t, e, n, r, i) => ({
			signal:
				(null != r ? `${t} === '${nR}' ? (${GU(r)}) : ` : "") +
				(null != n ? `${t} === '${iR}' ? (${GU(n)}) : ` : "") +
		...
		GU = (t) => (ZN(t) ? t.signal : null == t ? null : Ct(t)),
		VU = (t, e) =>
			0 === e
				? 0
				: ZN(t)
	...
	function KU(t, e, n, r, i) {
		const o = BR(t, e),
			...
			l = ((t, e) => {
				if (1 === e);
					...
					t = ZN(e) ? { signal: `(${e.signal}) * (${t || 0})` } : e * (t || 0);
				return t;
			})(t.offset, u);
		let c, f, h;
		const d = {
		...
		return (
			...
			(f.x = zU(a, p)),
			(f.y = NU(a, p)),
			UR({ type: FR, role: hN, key: pR, from: r, encode: d }, n)
		);
	}
	...
	function eL(t, e, n, r) {
		...
		const l = {
				enter: (s = {
					opacity: MR,
					anchor: nN(i("titleAnchor", null)),
					align: { signal: OR },
				}),
				update: (u = ot({}, s, { opacity: ER, text: nN(t.title) })),
				exit: { opacity: MR },
			},
			c = { signal: `lerp(range("${t.scale}"), ${NR(0, 1, 0.5)})` };
		return (
			(u.x = zU(o, c)),
			(u.y = NU(o, c)),
			(s.angle = zU(o, MR, VU(a, 90))),
			(s.baseline = zU(o, OU(o, iR, eR), { value: iR })),
			(u.angle = s.angle),
			...
			((t, e, n, r) => {
				const i = (t, e) =>
						null != t
							? ((n.update[e] = XU(nN(t), n.update[e])), !1)
							: !aN(e, r),
					o = i(t("titleX"), "x"),
					a = i(t("titleY"), "y");
				n.enter.auto = a === o ? nN(a) : zU(e, nN(a), nN(o));
			})(i, o, l, n),
			(l.update.align = XU(l.update.align, s.align)),
			(l.update.angle = XU(l.update.angle, s.angle)),
			(l.update.baseline = XU(l.update.baseline, s.baseline)),
			UR({ type: $R, role: gN, style: mR, from: r, encode: l }, n)
		);
	}
	function nL(t, e) {
		const n = ((t, e) => {
				var n,
					...
					l = t.orient;
				if (ZN(l)) {
					const t = ZU([o.axisX, o.axisY]),
						e = ZU([o.axisTop, o.axisBottom, o.axisLeft, o.axisRight]);
					for (i of ((n = {}), t))
						n[i] = zU(l, JU(i, o.axisX, s, a), JU(i, o.axisY, s, a));
					for (i of ((r = {}), e))
						r[i] = YU(
							l.signal,
							JU(i, o.axisTop, s, a),
							JU(i, o.axisBottom, s, a),
							JU(i, o.axisLeft, s, a),
							JU(i, o.axisRight, s, a),
						);
				} else
					(n = l === eR || l === iR ? o.axisX : o.axisY),
						(r = o["axis" + l[0].toUpperCase() + l.slice(1)]);
				return n || r || u ? ot({}, s, n, r, u) : s;
			})(t, e),
			r = t.encode || {},
			i = r.axis || {},
			o = i.name || void 0,
		...
		let p;
		return (
			c.grid && d.push(KU(t, n, r.grid, h, l)),
			c.ticks &&
				((p = u("tickSize")),
				d.push(
					((t, e, n, r, i, o) => {
						...
						return (
							...
							(f.x2 = l.x2 = NU(s, d)),
							(c.y = NU(s, p)),
							UR({ type: FR, role: pN, key: pR, from: r, encode: h }, n)
						);
					})(t, n, r.ticks, h, p, l),
				)),
			c.labels &&
				...
				d.push(
					((t, e, n, r, i, o) => {
						...
						const m = nN(i);
						(m.mult = l),
							(m.offset = nN(a("labelPadding") || 0)),
							(m.offset.mult = l);
						const y = {
								scale: u,
								field: pR,
								band: 0.5,
								offset: RR(o.offset, a("labelOffset")),
							},
							v = zU(
								s,
								g
									? tL(u, c, '"left"', '"right"', '"center"')
									: { value: "center" },
								RU(s, "left", "right"),
							),
							_ = zU(
								...
								OU(s, "bottom", "top"),
								g
									? tL(u, c, '"top"', '"bottom"', '"middle"')
									: { value: "middle" },
							),
							x = tL(u, c, `-(${f})`, f, 0);
						g = g && f;
						const b = { opacity: MR, x: zU(s, y, m), y: NU(s, y, m) },
							w = {
								enter: b,
								update: (p = {
									opacity: ER,
						...
						return (
							(A =
								A || k
									...
									: void 0),
							p.align !== v && (p.align = XU(p.align, v)),
							p.baseline !== _ && (p.baseline = XU(p.baseline, _)),
							UR(
								{
									type: $R,
									role: dN,
				...
				d.push(
					((t, e, n, r) => {
						...
						return (
							...
							(a.y = s.y = NU(o, l, MR)),
							(a.y2 = s.y2 = NU(o, c)),
							UR({ type: FR, role: fN, from: r, encode: u }, n)
						);
					})(t, n, r.domain, f),
				),
			c.title && d.push(eL(t, n, r.title, f)),
			wU(
				TR({
					role: cN,
					from: f,
					encode: oN(rL(u, t), i, AR),
					marks: d,
					aria: u("aria"),
	...
	function iL(t, e, n) {
		const r = V(t.signals),
			i = V(t.scales);
		return (
			n || r.forEach((t) => LN(t, e)),
			V(t.projections).forEach((t) =>
				((t, e) => {
					const n = e.config.projection || {},
						r = {};
					for (const n in t) "name" !== n && (r[n] = tR(t[n], n, e));
					for (const t in n) null == r[t] && (r[t] = tR(n[t], t, e));
			...
			i.forEach((t) =>
				((t, e) => {
					...
					sp(n) || s("Unrecognized scale type: " + Ct(n)),
						e.addScale(t.name, { type: n, domain: void 0 });
				})(t, e),
			),
			V(t.data).forEach((t) => FU(t, e)),
			i.forEach((t) => PO(t, e)),
			(n || r).forEach((t) =>
				((t, e) => {
					...
					t.init &&
						...
						r && ((r = DB(r, e)), (n.update = r.$expr), (n.params = r.$params)),
						t.on && t.on.forEach((t) => uO(t, e, n.id));
				})(t, e),
			),
			V(t.axes).forEach((t) => nL(t, e)),
			V(t.marks).forEach((t) => wU(t, e)),
			V(t.legends).forEach((t) => kU(t, e)),
			t.title && DU(t.title, e),
			e.parseLambdas(),
			e
		);
	}
	...
	function aL(t, e) {
		const n = e.config,
			r = IN((e.root = e.add(jN()))),
			i = ((t, e) => {
				const n = (n) => KN(t[n], e[n]),
					r = [
						sL("background", n("background")),
						sL("autosize", Qz(n("autosize"))),
						sL("padding", eN(n("padding"))),
						sL("width", n("width") || 0),
						sL("height", n("height") || 0),
					],
					i = r.reduce((t, e) => ((t[e.name] = e), t), {}),
					o = {};
				return (
					V(t.signals).forEach((t) => {
						lt(i, t.name) ? (t = ot(i[t.name], t)) : r.push(t), (o[t.name] = t);
					}),
					V(e.signals).forEach((t) => {
		...
		i.forEach((t) => LN(t, e)),
			...
			(e.locale = n.locale);
		const o = e.add(pO()),
			a = e.add(yO(BN(oL(t.encode), DR, uN, t.style, e, { pulse: IN(o) }))),
			s = e.add(
				RO({
					layout: e.objectProperty(t.layout),
					legends: e.legends,
		...
		e.operators.pop(),
			e.pushState(IN(a), IN(s), null),
			iL(t, e, i),
			e.operators.push(s);
		let u = e.add(dO({ mark: r, pulse: IN(s) }));
		return (
			(u = e.add(BO({ pulse: IN(u) }))),
			(u = e.add(NO({ pulse: IN(u) }))),
			e.addData("root", new yU(e, o, o, u)),
			e
		);
	}
	function sL(t, e) {
	...
	(uL.prototype = lL.prototype =
		{
			...
			proxy(t) {
				const e = t instanceof qN ? IN(t) : t;
				return this.add($O({ value: e }));
			},
			addStream(t) {
			...
			pushState(t, e, n) {
				this._encode.push(IN(this.add(NO({ pulse: t })))),
					this._parent.push(e),
					this._lookup.push(n ? IN(this.proxy(n)) : null),
			...
			parent() {
				return F(this._parent);
			},
			encode() {
				return F(this._encode);
			},
			lookup() {
				return F(this._lookup);
			},
			markpath() {
			...
			compareRef(t) {
				...
				const n = (t) =>
					...
					r = V(t.field).map(n),
					i = V(t.order).map(n);
				return e ? IN(this.add(gO({ fields: r, orders: i }))) : YN(r, i);
			},
			keyRef(t, e) {
				let n = !1;
				const r = this.signals;
				return (
					(t = V(t).map((t) => (ZN(t) ? ((n = !0), IN(r[t.signal])) : t))),
					n
						? IN(this.add(bO({ fields: t, flat: e })))
						: ((t, e) => {
								const n = { $key: t };
								return e && (n.$flat = !0), n;
							})(t, e)
			...
			sortRef(t) {
				if (!t) return t;
				const e = VN(t.op, t.field),
					n = t.order || "ascending";
				return n.signal
					? IN(this.add(gO({ fields: e, orders: this.signalRef(n.signal) })))
					: YN(e, n);
			},
			event(t, e) {
				const n = t + ":" + e;
			...
			addSignal(t, e) {
				...
				const n = e instanceof qN ? e : this.add(jN(e));
			...
			signalRef(t) {
				return this.signals[t]
					? IN(this.signals[t])
					: (lt(this.lambdas, t) || (this.lambdas[t] = this.add(jN(null))),
						IN(this.lambdas[t]));
			},
			parseLambdas() {
			...
			objectProperty(t) {
				return t && A(t) ? this.signalRef(t.signal || cL(t)) : t;
			},
			exprRef(t, e) {
				const n = { expr: DB(t, this) };
				return e && (n.expr.$name = e), IN(this.add(vO(n)));
			},
			addBinding(t, e) {
				this.bindings || s("Nested signals do not support binding: " + Ct(t)),
					this.bindings.push(ot({ signal: t }, e));
			},
			addScaleProj(t, e) {
			...
			addDataPipeline(t, e) {
				return (
					lt(this.data, t) && s("Duplicate data set name: " + Ct(t)),
					this.addData(t, yU.fromEntries(this, e))
				);
			},
		}),
		ot(Za, yl, ab, Ub, SE, TD, bF, ZC, EF, uS, kS, TS),
		(t.Bounds = Vg),
		(t.CanvasHandler = Sv),
		(t.CanvasRenderer = Rv),
		(t.DATE = Yn),
		...
		(t.inrange = pt),
		(t.interpolate = xp),
		(t.interpolateColors = yp),
		(t.interpolateRange = mp),
		(t.intersect = B_),
		(t.intersectBoxLine = Fm),
		(t.intersectPath = Mm),
		(t.intersectPoint = Em),
		(t.intersectRule = Cm),
		(t.isArray = k),
		...
		(t.panSymlog = q),
		(t.parse = (t, e, n) => (
			A(t) || s("Input Vega specification must be an object."),
			aL(
				t,
				new uL(
					(e = E(
		...
		(t.randomKDE = gs),
		(t.randomLCG = (t) => () =>
			(t = (1103515245 * t + 12345) % 2147483647) / 2147483647),
		...
		(t.scheme = Ap),
		(t.serializeXML = r_),
		(t.setHybridRendererOptions = (t) => {
			(A_.svgMarkTypes = t.svgMarkTypes ?? ["text"]),
				(A_.svgOnTop = t.svgOnTop ?? !0),
				(A_.debug = t.debug ?? !1);
		}),
		(t.setRandom = (e) => {
			t.random = e;
